...
#[status_script( agent = "murabito", status = FIGHTER_STATUS_KIND_SPECIAL_LW, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_PRE )]
unsafe fn status_murabito_SpecialLw_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
#[status_script( agent = "murabito", status = FIGHTER_MURABITO_STATUS_KIND_SPECIAL_LW_PLANT, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_PRE )]
unsafe fn status_murabito_SpecialLwPlant_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
#[status_script( agent = "murabito", status = FIGHTER_MURABITO_STATUS_KIND_SPECIAL_LW_PLANT, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_MAIN )]
unsafe fn status_murabito_SpecialLwPlant_Main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn murabito_SpecialLwPlant_function(fighter: &mut L2CFighterCommon) -> bool {
...
pub fn install() {
    install_status_scripts!(
        status_murabito_SpecialLw_Pre,
        status_murabito_SpecialLwPlant_Pre,
        status_murabito_SpecialLwPlant_Main,
    );
}