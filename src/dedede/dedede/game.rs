...
//AppealHiR2
unsafe extern "C" fn game_dedede_AppealHiR2(fighter: &mut L2CAgentBase) {
    let rand_effect = [Hash40::new("collision_attr_bind"), Hash40::new("collision_attr_bury"), Hash40::new("collision_attr_paralyze"), Hash40::new("collision_attr_sleep"), Hash40::new("collision_attr_saving")];
    let rng = sv_math::rand(hash40("dedede"), rand_effect.len() as i32);
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 50.0, /*Angle*/ 361, /*KBG*/ 30, /*FKB*/ 0, /*BKB*/ 10, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(0.0), /*Hitlag*/ 0.5, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 60, /*Trip*/ 0.0, /*Rehit*/ 60, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ rand_effect[rng as usize], /*SFXLevel*/ *ATTACK_SOUND_LEVEL_LL, /*SFXType*/ *COLLISION_SOUND_ATTR_DEDEDE, /*Type*/ *ATTACK_REGION_BODY);
...
pub fn install() {
    Agent::new("dedede")
    .game_acmd("game_jumpaerialf3", game_dedede_JumpAerialF3, Low)
    .game_acmd("game_jumpaerialf4", game_dedede_JumpAerialF4, Low)
    .game_acmd("game_jumpaerialf5", game_dedede_JumpAerialF5, Low)
    .game_acmd("game_jumpaerialf6", game_dedede_JumpAerialF6, Low)
    .game_acmd("game_jumpaerialf7", game_dedede_JumpAerialF7, Low)
    .game_acmd("game_jumpaerialf8", game_dedede_JumpAerialF8, Low)
    .game_acmd("game_jumpaerialf9", game_dedede_JumpAerialF9, Low)
    .game_acmd("game_squat", game_dedede_Squat, Low)
    .game_acmd("game_attack11", game_dedede_Attack11, Low)
    .game_acmd("game_attack12", game_dedede_Attack12, Low)
    .game_acmd("game_attack100", game_dedede_Attack100, Low)
    .game_acmd("game_attack100sub", game_dedede_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_dedede_Attack100End, Low)
    .game_acmd("game_attackdash", game_dedede_AttackDash, Low)
    .game_acmd("game_attacks3", game_dedede_AttackS3, Low)
    .game_acmd("game_attackhi3", game_dedede_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_dedede_AttackLw3, Low)
    .game_acmd("game_attacks4", game_dedede_AttackS4, Low)
    .game_acmd("game_attackhi4", game_dedede_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_dedede_AttackLw4, Low)
    .game_acmd("game_attackairn", game_dedede_AttackAirN, Low)
    .game_acmd("game_attackairf", game_dedede_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_dedede_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_dedede_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_dedede_AttackAirLw, Low)
    .game_acmd("game_catch", game_dedede_Catch, Low)
    .game_acmd("game_catchdash", game_dedede_CatchDash, Low)
    .game_acmd("game_catchturn", game_dedede_CatchTurn, Low)
    .game_acmd("game_catchattack", game_dedede_CatchAttack, Low)
    .game_acmd("game_throwf", game_dedede_ThrowF, Low)
    .game_acmd("game_throwb", game_dedede_ThrowB, Low)
    .game_acmd("game_throwhi", game_dedede_ThrowHi, Low)
    .game_acmd("game_throwlw", game_dedede_ThrowLw, Low)
    .game_acmd("game_downattackd", game_dedede_DownAttackD, Low)
    .game_acmd("game_downattacku", game_dedede_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_dedede_CliffAttack, Low)
    .game_acmd("game_slipattack", game_dedede_SlipAttack, Low)
    .game_acmd("game_specialnstart", game_dedede_SpecialNStart, Low)
    .game_acmd("game_specialnloop", game_dedede_SpecialNLoop, Low)
    .game_acmd("game_specialnspit", game_dedede_SpecialNSpit, Low)
    .game_acmd("game_specialnswallow", game_dedede_SpecialNSwallow, Low)
    .game_acmd("game_specialairnstart", game_dedede_SpecialAirNStart, Low)
    .game_acmd("game_specialairnloop", game_dedede_SpecialAirNLoop, Low)
    .game_acmd("game_specialairnspit", game_dedede_SpecialAirNSpit, Low)
    .game_acmd("game_specialairnswallow", game_dedede_SpecialAirNSwallow, Low)
    .game_acmd("game_specialsstart", game_dedede_SpecialSStart, Low)
    .game_acmd("game_specialsstartsub", game_dedede_SpecialSStartSub, Low)
    .game_acmd("game_specialsmiss", game_dedede_SpecialSMiss, Low)
    .game_acmd("game_specialairsstart", game_dedede_SpecialAirSStart, Low)
    .game_acmd("game_specialairsmiss", game_dedede_SpecialAirSMiss, Low)
    .game_acmd("game_specialhijump", game_dedede_SpecialHiJump, Low)
    .game_acmd("game_specialhilandingl", game_dedede_SpecialHiLandingL, Low)
    .game_acmd("game_specialhilandingr", game_dedede_SpecialHiLandingR, Low)
    .game_acmd("game_specialairhiturnl", game_dedede_SpecialAirHiTurnL, Low)
    .game_acmd("game_specialairhiturnr", game_dedede_SpecialAirHiTurnR, Low)
    .game_acmd("game_speciallw", game_dedede_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_dedede_SpecialAirLw, Low)
    .game_acmd("game_speciallwmax", game_dedede_SpecialLwMax, Low)
    .game_acmd("game_specialairlwmax", game_dedede_SpecialAirLwMax, Low)
    .game_acmd("game_appealsr", game_dedede_AppealSR, Low)
    .game_acmd("game_appealsl", game_dedede_AppealSL, Low)
    .game_acmd("game_appealhir", game_dedede_AppealHiR, Low)
    .game_acmd("game_appealhir2", game_dedede_AppealHiR2, Low)
    .game_acmd("game_appealhil", game_dedede_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_dedede_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_dedede_AppealLwL, Low)
    .game_acmd("game_finalend", game_dedede_FinalEnd, Low)
    .game_acmd("game_finalairend", game_dedede_FinalAirEnd, Low)
    .install();
}