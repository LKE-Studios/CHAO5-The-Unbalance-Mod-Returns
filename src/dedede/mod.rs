...
unsafe fn dedede_neutralbloop(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, /*ID*/ 0, /*Bone*/ Hash40::new("top"), /*Size*/ 15.0, /*X*/ 0.0, /*Y*/ 9.0, /*Z*/ 5.0, /*X2*/ Some(0.0), /*Y2*/ Some(9.0), /*Z2*/ Some(70.0), *FIGHTER_STATUS_KIND_SWALLOWED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA);
    ...
    if WorkModule::get_int64(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_KIND) == *FIGHTER_KIND_KIRBY as u64 {
        if macros::is_excute(fighter) {
            damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
            WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_DEDEDE_STATUS_SPECIAL_N_FLAG_INHALE);
            macros::CATCH(fighter, /*ID*/ 0, /*Bone*/ Hash40::new("top"), /*Size*/ 15.0, /*X*/ 0.0, /*Y*/ 5.5, /*Z*/ 5.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.5), /*Z2*/ Some(70.0), *FIGHTER_STATUS_KIND_SWALLOWED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA);
