...
pub fn install() {
    Agent::new("rockman")
    .game_acmd("game_attack11", game_rockman_Attack11)
    .game_acmd("game_attackdash", game_rockman_AttackDash)
    .game_acmd("game_attacks3", game_rockman_AttackS3)
    .game_acmd("game_attackhi3", game_rockman_AttackHi3)
    .game_acmd("game_attacklw3", game_rockman_AttackLw3)
    .game_acmd("game_attacks4", game_rockman_AttackS4)
    .game_acmd("game_attackhi4", game_rockman_AttackHi4)
    .game_acmd("game_attacklw4", game_rockman_AttackLw4)
    .game_acmd("game_attackairn", game_rockman_AttackAirN)
    .game_acmd("game_attackairf", game_rockman_AttackAirF)    
    .game_acmd("game_attackairb", game_rockman_AttackAirB)
    .game_acmd("game_attackairhi", game_rockman_AttackAirHi)
    .game_acmd("game_attackairlw", game_rockman_AttackAirLw)
    .game_acmd("game_catch", game_rockman_Catch)
    .game_acmd("game_catchdash", game_rockman_CatchDash)
    .game_acmd("game_catchturn", game_rockman_CatchTurn)
    .game_acmd("game_catchattack", game_rockman_CatchAttack)
    .game_acmd("game_throwf", game_rockman_ThrowF)
    .game_acmd("game_throwb", game_rockman_ThrowB)
    .game_acmd("game_throwhi", game_rockman_ThrowHi)
    .game_acmd("game_throwlw", game_rockman_ThrowLw)
    .game_acmd("game_downattackd", game_rockman_DownAttackD)
    .game_acmd("game_downattacku", game_rockman_DownAttackU)
    .game_acmd("game_cliffattack", game_rockman_CliffAttack)
    .game_acmd("game_slipattack", game_rockman_SlipAttack)
    .game_acmd("game_specialhi", game_rockman_SpecialHi)
    .game_acmd("game_specialairhi", game_rockman_SpecialAirHi)
    .game_acmd("game_speciallw", game_rockman_SpecialLw)
    .game_acmd("game_specialairlw", game_rockman_SpecialAirLw)
    .game_acmd("game_appealsr", game_rockman_AppealSR)
    .game_acmd("game_appealsl", game_rockman_AppealSL)
    .game_acmd("game_appealhir", game_rockman_AppealHiR)
    .game_acmd("game_appealhil", game_rockman_AppealHiL)
    .game_acmd("game_appeallwr", game_rockman_AppealLwR)
    .game_acmd("game_appeallwl", game_rockman_AppealLwL)
    .game_acmd("game_finalend", game_rockman_FinalEnd)
    .game_acmd("game_finalairend", game_rockman_FinalAirEnd)
    .install();
}
