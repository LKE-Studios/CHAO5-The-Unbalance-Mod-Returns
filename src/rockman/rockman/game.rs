...
//Attack11
unsafe extern "C" fn game_rockman_Attack11(fighter: &mut L2CAgentBase) {
...
//AttackDash
unsafe extern "C" fn game_rockman_AttackDash(fighter: &mut L2CAgentBase) { 
...
//AttackS3
unsafe extern "C" fn game_rockman_AttackS3(fighter: &mut L2CAgentBase) {
...
//AttackHi3
unsafe extern "C" fn game_rockman_AttackHi3(fighter: &mut L2CAgentBase) {
...
//AttackLw3
unsafe extern "C" fn game_rockman_AttackLw3(fighter: &mut L2CAgentBase) {
...
//AttackS4
unsafe extern "C" fn game_rockman_AttackS4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
...
//AttackHi4
unsafe extern "C" fn game_rockman_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackLw4
unsafe extern "C" fn game_rockman_AttackLw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackAirN
unsafe extern "C" fn game_rockman_AttackAirN(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.66);
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
...
//AttackAirF 
unsafe extern "C" fn game_rockman_AttackAirF(fighter: &mut L2CAgentBase) {
...
//AttackAirB
unsafe extern "C" fn game_rockman_AttackAirB(fighter: &mut L2CAgentBase) {
...
//AttackAirHi
unsafe extern "C" fn game_rockman_AttackAirHi(fighter: &mut L2CAgentBase) {   
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
//AttackAirLw
unsafe extern "C" fn game_rockman_AttackAirLw(fighter: &mut L2CAgentBase) { 
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
//Catch
unsafe extern "C" fn game_rockman_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//CatchDash
unsafe extern "C" fn game_rockman_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchTurn
unsafe extern "C" fn game_rockman_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchAttack
unsafe extern "C" fn game_rockman_CatchAttack(fighter: &mut L2CAgentBase) {
...
//ThrowF
unsafe extern "C" fn game_rockman_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_rockman_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_rockman_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_rockman_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_rockman_CliffAttack(fighter: &mut L2CAgentBase) {
...
//SlipAttack
unsafe extern "C" fn game_rockman_SlipAttack(fighter: &mut L2CAgentBase) {
...
//DownAttackD
unsafe extern "C" fn game_rockman_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_rockman_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 15.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
    }
...
//SpecialHi
unsafe extern "C" fn game_rockman_SpecialHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
...
//SpecialAirHi
unsafe extern "C" fn game_rockman_SpecialAirHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialLw
unsafe extern "C" fn game_rockman_SpecialLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialAirLw
unsafe extern "C" fn game_rockman_SpecialAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        shield!(fighter, MA_MSC_CMD_REFLECTOR, COLLISION_KIND_REFLECTOR, 0, Hash40::new("top"), 10, 0, 0.0, 0.0, 0, 0.0, 10.0, 1.5, 1.0, 200, false, 1.0, *FIGHTER_REFLECTOR_GROUP_HOMERUNBAT);
...
//AppealHiR
unsafe extern "C" fn game_rockman_AppealHiR(fighter: &mut L2CAgentBase) { 
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_rockman_AppealHiL(fighter: &mut L2CAgentBase) { 
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BEAMSWORD), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_rockman_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_rockman_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BOMBHEI), 0, 0, false, false);
    }
}
...
//AppealLwR
unsafe extern "C" fn game_rockman_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_rockman_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 30.0, /*Angle*/ 90, /*KBG*/ 70, /*FKB*/ 0, /*BKB*/ 35, /*Size*/ 11.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_B, /*SetWeight*/ false, /*ShieldDamage*/ 1.0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_FIRE, /*Type*/ *ATTACK_REGION_BODY);
    }
}
...
//FinalEnd
unsafe extern "C" fn game_rockman_FinalEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_rockman_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_ROCKMAN_FINAL, /*ID*/ 0, /*Damage*/ 180.0, /*Angle*/ 45, /*KBG*/ 130, /*FKB*/ 0, /*BKB*/ 80, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*Unk*/ 1.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_paralyze"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_LL, /*SFXType*/ *COLLISION_SOUND_ATTR_ELEC, /*Type*/ *ATTACK_REGION_NONE);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_ROCKMAN_STATUS_WORK_ID_FLAG_FINAL_ABS_SET);
    }
...
pub fn install() {
    Agent::new("rockman")
    .game_acmd("game_attack11", game_rockman_Attack11, Low)
    .game_acmd("game_attackdash", game_rockman_AttackDash, Low)
    .game_acmd("game_attacks3", game_rockman_AttackS3, Low)
    .game_acmd("game_attackhi3", game_rockman_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_rockman_AttackLw3, Low)
    .game_acmd("game_attacks4", game_rockman_AttackS4, Low)
    .game_acmd("game_attackhi4", game_rockman_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_rockman_AttackLw4, Low)
    .game_acmd("game_attackairn", game_rockman_AttackAirN, Low)
    .game_acmd("game_attackairf", game_rockman_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_rockman_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_rockman_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_rockman_AttackAirLw, Low)
    .game_acmd("game_catch", game_rockman_Catch, Low)
    .game_acmd("game_catchdash", game_rockman_CatchDash, Low)
    .game_acmd("game_catchturn", game_rockman_CatchTurn, Low)
    .game_acmd("game_catchattack", game_rockman_CatchAttack, Low)
    .game_acmd("game_throwf", game_rockman_ThrowF, Low)
    .game_acmd("game_throwb", game_rockman_ThrowB, Low)
    .game_acmd("game_throwhi", game_rockman_ThrowHi, Low)
    .game_acmd("game_throwlw", game_rockman_ThrowLw, Low)
    .game_acmd("game_downattackd", game_rockman_DownAttackD, Low)
    .game_acmd("game_downattacku", game_rockman_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_rockman_CliffAttack, Low)
    .game_acmd("game_slipattack", game_rockman_SlipAttack, Low)
    .game_acmd("game_specialhi", game_rockman_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_rockman_SpecialAirHi, Low)
    .game_acmd("game_speciallw", game_rockman_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_rockman_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_rockman_AppealSR, Low)
    .game_acmd("game_appealsl", game_rockman_AppealSL, Low)
    .game_acmd("game_appealhir", game_rockman_AppealHiR, Low)
    .game_acmd("game_appealhil", game_rockman_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_rockman_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_rockman_AppealLwL, Low)
    .game_acmd("game_finalend", game_rockman_FinalEnd, Low)
    .game_acmd("game_finalairend", game_rockman_FinalAirEnd, Low)
    .install();
}
