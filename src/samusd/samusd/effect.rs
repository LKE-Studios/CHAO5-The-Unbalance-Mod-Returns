...
pub fn install() {
    Agent::new("samusd")
    .effect_acmd("effect_entryr", effect_samusd_EntryR)
    .effect_acmd("effect_entryl", effect_samusd_EntryL)
    .effect_acmd("effect_attackdash", effect_samusd_AttackDash)
    .effect_acmd("effect_attacks3hi", effect_samusd_AttackS3Hi)
    .effect_acmd("effect_attacks3", effect_samusd_AttackS3)
    .effect_acmd("effect_attacks3lw", effect_samusd_AttackS3Lw)
    .effect_acmd("effect_attackhi3", effect_samusd_AttackHi3)
    .effect_acmd("effect_attacklw3", effect_samusd_AttackLw3)
    .effect_acmd("effect_attackairn", effect_samusd_AttackAirN)
    .effect_acmd("effect_attackairf", effect_samusd_AttackAirF)
    .effect_acmd("effect_attackairb", effect_samusd_AttackAirB)
    .effect_acmd("effect_attackairhi", effect_samusd_AttackAirHi)
    .effect_acmd("effect_attackairlw", effect_samusd_AttackAirLw)
    .install();
}