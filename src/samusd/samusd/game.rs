...
pub fn install() {
    Agent::new("samusd")
    .game_acmd("game_attack11", game_samusd_Attack11)
    .game_acmd("game_attack12", game_samusd_Attack12)
    .game_acmd("game_attackdash", game_samusd_AttackDash)
    .game_acmd("game_attacks3hi", game_samusd_AttackS3Hi)
    .game_acmd("game_attacks3", game_samusd_AttackS3)
    .game_acmd("game_attacks3lw", game_samusd_AttackS3Lw)
    .game_acmd("game_attackhi3", game_samusd_AttackHi3)
    .game_acmd("game_attacklw3", game_samusd_AttackLw3)
    .game_acmd("game_attacks4hi", game_samusd_AttackS4Hi)
    .game_acmd("game_attacks4", game_samusd_AttackS4)
    .game_acmd("game_attacks4lw", game_samusd_AttackS4Lw)
    .game_acmd("game_attackhi4", game_samusd_AttackHi4)
    .game_acmd("game_attacklw4", game_samusd_AttackLw4)
    .game_acmd("game_attackairn", game_samusd_AttackAirN)
    .game_acmd("game_attackairf", game_samusd_AttackAirF)    
    .game_acmd("game_attackairb", game_samusd_AttackAirB)
    .game_acmd("game_attackairhi", game_samusd_AttackAirHi)
    .game_acmd("game_attackairlw", game_samusd_AttackAirLw)
    .game_acmd("game_catchattack", game_samusd_CatchAttack)
    .game_acmd("game_throwf", game_samusd_ThrowF)
    .game_acmd("game_throwb", game_samusd_ThrowB)
    .game_acmd("game_throwhi", game_samusd_ThrowHi)
    .game_acmd("game_throwlw", game_samusd_ThrowLw)
    .game_acmd("game_downattackd", game_samusd_DownAttackD)
    .game_acmd("game_downattacku", game_samusd_DownAttackU)
    .game_acmd("game_cliffattack", game_samusd_CliffAttack)
    .game_acmd("game_slipattack", game_samusd_SlipAttack)
    .game_acmd("game_specialhi", game_samusd_SpecialHi)
    .game_acmd("game_specialairhi", game_samusd_SpecialAirHi)
    .game_acmd("game_appealsr", game_samusd_AppealSR)
    .game_acmd("game_appealsl", game_samusd_AppealSL)
    .game_acmd("game_appealhir", game_samusd_AppealHiR)
    .game_acmd("game_appealhil", game_samusd_AppealHiL)
    .game_acmd("game_appeallwr", game_samusd_AppealLwR)
    .game_acmd("game_appeallwl", game_samusd_AppealLwL)
    .install();
}
