...
pub fn install() {
    Agent::new("captain")
    .game_acmd("game_attack11", game_captain_Attack11, Low)
    .game_acmd("game_attack12", game_captain_Attack12, Low)
    .game_acmd("game_attack13", game_captain_Attack13, Low)
    .game_acmd("game_attack100", game_captain_Attack100, Low)
    .game_acmd("game_attack100sub", game_captain_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_captain_Attack100End, Low)
    .game_acmd("game_attackdash", game_captain_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_captain_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_captain_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_captain_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_captain_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_captain_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_captain_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_captain_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_captain_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_captain_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_captain_AttackLw4, Low)
    .game_acmd("game_attackairn", game_captain_AttackAirN, Low)
    .game_acmd("game_attackairf", game_captain_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_captain_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_captain_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_captain_AttackAirLw, Low)
    .game_acmd("game_catch", game_captain_Catch, Low)
    .game_acmd("game_catchdash", game_captain_CatchDash, Low)
    .game_acmd("game_catchturn", game_captain_CatchTurn, Low)
    .game_acmd("game_catchattack", game_captain_CatchAttack, Low)
    .game_acmd("game_throwf", game_captain_ThrowF, Low)
    .game_acmd("game_throwb", game_captain_ThrowB, Low)
    .game_acmd("game_throwhi", game_captain_ThrowHi, Low)
    .game_acmd("game_throwlw", game_captain_ThrowLw, Low)
    .game_acmd("game_downattackd", game_captain_DownAttackD, Low)
    .game_acmd("game_downattacku", game_captain_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_captain_CliffAttack, Low)
    .game_acmd("game_slipattack", game_captain_SlipAttack, Low)
    .game_acmd("game_specialn", game_captain_SpecialN, Low)
    .game_acmd("game_specialnturn", game_captain_SpecialNTurn, Low)
    .game_acmd("game_specialairn", game_captain_SpecialAirN, Low)
    .game_acmd("game_specialairnturn", game_captain_SpecialAirNTurn, Low)
    .game_acmd("game_specialsstart", game_captain_SpecialSStart, Low)
    .game_acmd("game_specialsend", game_captain_SpecialSEnd, Low)
    .game_acmd("game_specialairsstart", game_captain_SpecialAirSStart, Low)
    .game_acmd("game_specialairsend", game_captain_SpecialAirSEnd, Low)
    .game_acmd("game_specialhithrow", game_captain_SpecialHiThrow, Low)
    .game_acmd("game_speciallw", game_captain_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_captain_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_captain_AppealSR, Low)
    .game_acmd("game_appealsl", game_captain_AppealSL, Low)
    .game_acmd("game_appealhir", game_captain_AppealHiR, Low)
    .game_acmd("game_appealhil", game_captain_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_captain_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_captain_AppealLwL, Low)
    .game_acmd("game_finalend", game_captain_FinalEnd, Low)
    .game_acmd("game_finalairend", game_captain_FinalAirEnd, Low)
    .install();
}