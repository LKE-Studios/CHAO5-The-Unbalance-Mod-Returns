...
unsafe extern "C" fn game_metaknight_AppealSR(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 50.0, /*Angle*/ 361, /*KBG*/ 60, /*FKB*/ 0, /*BKB*/ 20, /*Size*/ 8.0, /*X*/ 0.0, /*Y*/ 4.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(0.0), /*Hitlag*/ 1.7, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_saving"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
        ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("haver"), /*Damage*/ 50.0, /*Angle*/ 361, /*KBG*/ 60, /*FKB*/ 0, /*BKB*/ 20, /*Size*/ 9.5, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(18.0), /*Z2*/ Some(0.0), /*Hitlag*/ 1.7, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_saving"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
        AttackModule::set_attack_level(fighter.module_accessor, /*ID*/ 0, *FIGHTER_RYU_SAVING_LV_3 as u8);
        AttackModule::set_attack_level(fighter.module_accessor, /*ID*/ 1, *FIGHTER_RYU_SAVING_LV_3 as u8);
    }
...
unsafe extern "C" fn game_metaknight_AppealSL(fighter: &mut L2CAgentBase) {
    ...
    frame(fighter.lua_state_agent, 32.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 50.0, /*Angle*/ 361, /*KBG*/ 60, /*FKB*/ 0, /*BKB*/ 20, /*Size*/ 8.0, /*X*/ 0.0, /*Y*/ 4.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(0.0), /*Hitlag*/ 1.7, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_saving"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_BODY);
        ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("haver"), /*Damage*/ 50.0, /*Angle*/ 361, /*KBG*/ 60, /*FKB*/ 0, /*BKB*/ 20, /*Size*/ 9.5, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(18.0), /*Z2*/ Some(0.0), /*Hitlag*/ 1.7, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_saving"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_BODY);
        AttackModule::set_attack_level(fighter.module_accessor, /*ID*/ 0, *FIGHTER_RYU_SAVING_LV_3 as u8);
        AttackModule::set_attack_level(fighter.module_accessor, /*ID*/ 1, *FIGHTER_RYU_SAVING_LV_3 as u8);
    }
...
pub fn install() {
    ...
    .game_acmd("game_dash", game_metaknight_Dash)
    .game_acmd("game_run", game_metaknight_Run)
    .game_acmd("game_shieldbreakfly", game_metaknight_ShieldBreakFly)
    .game_acmd("game_glidewing", game_metaknight_GlideWing)
    .game_acmd("game_glidedirection", game_metaknight_GlideDirection)
    .game_acmd("game_glideattack", game_metaknight_GlideAttack)
    .game_acmd("game_attack100start", game_metaknight_Attack100Start)
    .game_acmd("game_attack100", game_metaknight_Attack100)
    .game_acmd("game_attack100sub", game_metaknight_Attack100Sub)
    .game_acmd("game_attack100end", game_metaknight_Attack100End)
    .game_acmd("game_attackdash", game_metaknight_AttackDash)
    .game_acmd("game_attacks3", game_metaknight_AttackS3)
    .game_acmd("game_attacks3s2", game_metaknight_AttackS3S2)
    .game_acmd("game_attacks3s3", game_metaknight_AttackS3S3)
    .game_acmd("game_attackhi3", game_metaknight_AttackHi3)
    .game_acmd("game_attacklw3", game_metaknight_AttackLw3)
    .game_acmd("game_attacks4", game_metaknight_AttackS4)
    .game_acmd("game_attackhi4", game_metaknight_AttackHi4)
    .game_acmd("game_attacklw4", game_metaknight_AttackLw4)
    .game_acmd("game_attackairn", game_metaknight_AttackAirN)
    .game_acmd("game_attackairf", game_metaknight_AttackAirF)    
    .game_acmd("game_attackairb", game_metaknight_AttackAirB)
    .game_acmd("game_attackairhi", game_metaknight_AttackAirHi)
    .game_acmd("game_attackairlw", game_metaknight_AttackAirLw)
    .game_acmd("game_catch", game_metaknight_Catch)
    .game_acmd("game_catchdash", game_metaknight_CatchDash)
    .game_acmd("game_catchturn", game_metaknight_CatchTurn)
    .game_acmd("game_catchattack", game_metaknight_CatchAttack)
    .game_acmd("game_throwf", game_metaknight_ThrowF)
    .game_acmd("game_throwb", game_metaknight_ThrowB)
    .game_acmd("game_throwhi", game_metaknight_ThrowHi)
    .game_acmd("game_throwlw", game_metaknight_ThrowLw)
    .game_acmd("game_downattackd", game_metaknight_DownAttackD)
    .game_acmd("game_downattacku", game_metaknight_DownAttackU)
    .game_acmd("game_cliffattack", game_metaknight_CliffAttack)
    .game_acmd("game_slipattack", game_metaknight_SlipAttack)
    .game_acmd("game_specialnstart", game_metaknight_SpecialNStart)
    .game_acmd("game_specialnspin", game_metaknight_SpecialNSpin)
    .game_acmd("game_specialnend", game_metaknight_SpecialNEnd)
    .game_acmd("game_specialairnstart", game_metaknight_SpecialAirNStart)
    .game_acmd("game_specialairnend", game_metaknight_SpecialAirNEnd)  
    .game_acmd("game_specialsstart", game_metaknight_SpecialSStart)  
    .game_acmd("game_specialsdrill", game_metaknight_SpecialSDrill)
    .game_acmd("game_specialsend", game_metaknight_SpecialSEnd)
    .game_acmd("game_specialairsstart", game_metaknight_SpecialAirSStart)  
    .game_acmd("game_specialairsend", game_metaknight_SpecialAirSEnd)
    .game_acmd("game_specialairsfinish", game_metaknight_SpecialAirSFinish)
    .game_acmd("game_specialhi", game_metaknight_SpecialHi)
    .game_acmd("game_specialairhistart", game_metaknight_SpecialAirHiStart)
    .game_acmd("game_specialhiloop", game_metaknight_SpecialHiLoop)
    .game_acmd("game_speciallwstart", game_metaknight_SpecialLwStart)
    .game_acmd("game_specialairlwstart", game_metaknight_SpecialAirLwStart)
    .game_acmd("game_speciallw", game_metaknight_SpecialLw)
    .game_acmd("game_speciallwb", game_metaknight_SpecialLwB)
    .game_acmd("game_speciallwf", game_metaknight_SpecialLwF)
    .game_acmd("game_speciallwsubb", game_metaknight_SpecialLwSubB)
    .game_acmd("game_speciallwsubf", game_metaknight_SpecialLwSubF)
    .game_acmd("game_speciallwend", game_metaknight_SpecialLwEnd)
    .game_acmd("game_specialairlw", game_metaknight_SpecialAirLw)
    .game_acmd("game_specialairlwb", game_metaknight_SpecialAirLwB)
    .game_acmd("game_specialairlwf", game_metaknight_SpecialAirLwF)
    ...
    .game_acmd("game_appealhil", game_metaknight_AppealHiL)
    .game_acmd("game_appeallwr", game_metaknight_AppealLwR)
    .game_acmd("game_appeallwl", game_metaknight_AppealLwL)
    .game_acmd("game_final", game_metaknight_Final)
    .game_acmd("game_finalfinish", game_metaknight_FinalFinish)
    .install();
}