...
pub fn install() {
    Agent::new("pikmin")
    .game_acmd("game_attack11", game_pikmin_Attack11)
    .game_acmd("game_attack12", game_pikmin_Attack12)
    .game_acmd("game_attackdash", game_pikmin_AttackDash)
    .game_acmd("game_attacks3", game_pikmin_AttackS3)
    .game_acmd("game_attackhi3", game_pikmin_AttackHi3)
    .game_acmd("game_attacklw3", game_pikmin_AttackLw3)
    .game_acmd("game_attacks4", game_pikmin_AttackS4)
    .game_acmd("game_attackhi4", game_pikmin_AttackHi4)
    .game_acmd("game_attacklw4", game_pikmin_AttackLw4)
    .game_acmd("game_attackairn", game_pikmin_AttackAirN)
    .game_acmd("game_attackairf", game_pikmin_AttackAirF)    
    .game_acmd("game_attackairb", game_pikmin_AttackAirB)
    .game_acmd("game_attackairhi", game_pikmin_AttackAirHi)
    .game_acmd("game_attackairlw", game_pikmin_AttackAirLw)
    .game_acmd("game_catchattack", game_pikmin_CatchAttack)
    .game_acmd("game_throwf", game_pikmin_ThrowF)
    .game_acmd("game_throwb", game_pikmin_ThrowB)
    .game_acmd("game_throwhi", game_pikmin_ThrowHi)
    .game_acmd("game_throwlw", game_pikmin_ThrowLw)
    .game_acmd("game_downattackd", game_pikmin_DownAttackD)
    .game_acmd("game_downattacku", game_pikmin_DownAttackU)
    .game_acmd("game_cliffattack", game_pikmin_CliffAttack)
    .game_acmd("game_slipattack", game_pikmin_SlipAttack)
    .game_acmd("game_specialairhi", game_pikmin_SpecialAirHi)
    .game_acmd("game_speciallw", game_pikmin_SpecialLw)
    .game_acmd("game_specialairlw", game_pikmin_SpecialAirLw)
    .game_acmd("game_appealsr", game_pikmin_AppealSR)
    .game_acmd("game_appealsl", game_pikmin_AppealSL)
    .game_acmd("game_appealhir", game_pikmin_AppealHiR)
    .game_acmd("game_appealhil", game_pikmin_AppealHiL)
    .game_acmd("game_appeallwr", game_pikmin_AppealLwR)
    .game_acmd("game_appeallwl", game_pikmin_AppealLwL)
    .install();
}