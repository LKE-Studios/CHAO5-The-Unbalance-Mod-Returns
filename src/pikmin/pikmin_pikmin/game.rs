...
pub fn install() {
    ...
    .game_acmd("game_attacks4sjump", game_pikmin_pikmin_AttackS4SJump)
    .game_acmd("game_attacks4sjump_b", game_pikmin_pikmin_AttackS4SJump_B)
    .game_acmd("game_attacks4sjump_v", game_pikmin_pikmin_AttackS4SJump_V)
    .game_acmd("game_attacks4sjump_w", game_pikmin_pikmin_AttackS4SJump_W)
    .game_acmd("game_attacks4sjump_y", game_pikmin_pikmin_AttackS4SJump_Y)
    .game_acmd("game_attackhi4", game_pikmin_pikmin_AttackHi4)
    .game_acmd("game_attackhi4_b", game_pikmin_pikmin_AttackHi4_B)
    .game_acmd("game_attackhi4_v", game_pikmin_pikmin_AttackHi4_V)
    .game_acmd("game_attackhi4_w", game_pikmin_pikmin_AttackHi4_W)
    .game_acmd("game_attackhi4_y", game_pikmin_pikmin_AttackHi4_Y)
    .game_acmd("game_attacklw4", game_pikmin_pikmin_AttackLw4)
    .game_acmd("game_attacklw4_b", game_pikmin_pikmin_AttackLw4_B)
    .game_acmd("game_attacklw4_v", game_pikmin_pikmin_AttackLw4_V)
    .game_acmd("game_attacklw4_w", game_pikmin_pikmin_AttackLw4_W)
    .game_acmd("game_attacklw4_y", game_pikmin_pikmin_AttackLw4_Y)
    .game_acmd("game_attackairf", game_pikmin_pikmin_AttackAirF)
    .game_acmd("game_attackairf_b", game_pikmin_pikmin_AttackAirF_B)
    .game_acmd("game_attackairf_v", game_pikmin_pikmin_AttackAirF_V)
    .game_acmd("game_attackairf_w", game_pikmin_pikmin_AttackAirF_W)
    .game_acmd("game_attackairf_y", game_pikmin_pikmin_AttackAirF_Y)
    .game_acmd("game_attackairb", game_pikmin_pikmin_AttackAirB)
    .game_acmd("game_attackairb_b", game_pikmin_pikmin_AttackAirB_B)
    .game_acmd("game_attackairb_v", game_pikmin_pikmin_AttackAirB_V)
    .game_acmd("game_attackairb_w", game_pikmin_pikmin_AttackAirB_W)
    .game_acmd("game_attackairb_y", game_pikmin_pikmin_AttackAirB_Y)
    .game_acmd("game_attackairhi", game_pikmin_pikmin_AttackAirHi)
    .game_acmd("game_attackairhi_b", game_pikmin_pikmin_AttackAirHi_B)
    .game_acmd("game_attackairhi_v", game_pikmin_pikmin_AttackAirHi_V)
    .game_acmd("game_attackairhi_w", game_pikmin_pikmin_AttackAirHi_W)
    .game_acmd("game_attackairhi_y", game_pikmin_pikmin_AttackAirHi_Y)
    .game_acmd("game_attackairlw", game_pikmin_pikmin_AttackAirLw)
    .game_acmd("game_attackairlw_b", game_pikmin_pikmin_AttackAirLw_B)
    .game_acmd("game_attackairlw_v", game_pikmin_pikmin_AttackAirLw_V)
    .game_acmd("game_attackairlw_w", game_pikmin_pikmin_AttackAirLw_W)
    .game_acmd("game_attackairlw_y", game_pikmin_pikmin_AttackAirLw_Y)
    .game_acmd("game_throwf", game_pikmin_pikmin_ThrowF)
    .game_acmd("game_throwf_b", game_pikmin_pikmin_ThrowF_B)
    .game_acmd("game_throwf_v", game_pikmin_pikmin_ThrowF_V)
    .game_acmd("game_throwf_w", game_pikmin_pikmin_ThrowF_W)
    .game_acmd("game_throwf_y", game_pikmin_pikmin_ThrowF_Y)
    .game_acmd("game_throwb", game_pikmin_pikmin_ThrowB)
    .game_acmd("game_throwb_b", game_pikmin_pikmin_ThrowB_B)
    .game_acmd("game_throwb_v", game_pikmin_pikmin_ThrowB_V)
    .game_acmd("game_throwb_w", game_pikmin_pikmin_ThrowB_W)
    .game_acmd("game_throwb_y", game_pikmin_pikmin_ThrowB_Y)
    .game_acmd("game_throwhi", game_pikmin_pikmin_ThrowHi)
    .game_acmd("game_throwhi_b", game_pikmin_pikmin_ThrowHi_B)
    .game_acmd("game_throwhi_v", game_pikmin_pikmin_ThrowHi_V)
    .game_acmd("game_throwhi_w", game_pikmin_pikmin_ThrowHi_W)
    .game_acmd("game_throwhi_y", game_pikmin_pikmin_ThrowHi_Y)
    .game_acmd("game_throwlw", game_pikmin_pikmin_ThrowLw)
    .game_acmd("game_throwlw_b", game_pikmin_pikmin_ThrowHi_B)
    .game_acmd("game_throwlw_v", game_pikmin_pikmin_ThrowHi_V)
    .game_acmd("game_throwlw_w", game_pikmin_pikmin_ThrowHi_W)
    .game_acmd("game_throwlw_y", game_pikmin_pikmin_ThrowHi_Y)
    .game_acmd("game_spsthrown", game_pikmin_pikmin_SpSThrown)
    .game_acmd("game_spsthrown_b", game_pikmin_pikmin_SpSThrown_B)
    .game_acmd("game_spsthrown_v", game_pikmin_pikmin_SpSThrown_V)
    .game_acmd("game_spsthrown_w", game_pikmin_pikmin_SpSThrown_W)
    .game_acmd("game_spsthrown_y", game_pikmin_pikmin_SpSThrown_Y)
    .game_acmd("game_spsgrabattack", game_pikmin_pikmin_SpSGrabAttack)
    .game_acmd("game_spsgrabattack_b", game_pikmin_pikmin_SpSGrabAttack_B)
    .game_acmd("game_spsgrabattack_w", game_pikmin_pikmin_SpSGrabAttack_W)
    .game_acmd("game_spsgrabattack_y", game_pikmin_pikmin_SpSGrabAttack_Y)
    .install();
}