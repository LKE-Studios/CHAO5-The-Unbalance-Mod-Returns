...
pub fn install() {
    Agent::new("richter")
    .game_acmd("game_attack11", game_richter_Attack11)
    .game_acmd("game_attack12", game_richter_Attack12)
    .game_acmd("game_attack100", game_richter_Attack100)
    .game_acmd("game_attack100sub", game_richter_Attack100Sub)
    .game_acmd("game_attack100end", game_richter_Attack100End)
    .game_acmd("game_attackdash", game_richter_AttackDash)
    .game_acmd("game_attacks3", game_richter_AttackS3)
    .game_acmd("game_attackhi3", game_richter_AttackHi3)
    .game_acmd("game_attacklw3", game_richter_AttackLw3)
    .game_acmd("game_attacklw32", game_richter_AttackLw32)
    .game_acmd("game_attacks4hi", game_richter_AttackS4Hi)
    .game_acmd("game_attacks4", game_richter_AttackS4)
    .game_acmd("game_attacks4lw", game_richter_AttackS4Lw)
    .game_acmd("game_attackhi4", game_richter_AttackHi4)
    .game_acmd("game_attacklw4", game_richter_AttackLw4)
    .game_acmd("game_attackairn", game_richter_AttackAirN)
    .game_acmd("game_attackairfhi", game_richter_AttackAirFHi) 
    .game_acmd("game_attackairf", game_richter_AttackAirF) 
    .game_acmd("game_attackairflw", game_richter_AttackAirFLw) 
    .game_acmd("game_attackairbhi", game_richter_AttackAirBHi)   
    .game_acmd("game_attackairb", game_richter_AttackAirB)
    .game_acmd("game_attackairblw", game_richter_AttackAirBLw)
    .game_acmd("game_attackairhi", game_richter_AttackAirHi)
    .game_acmd("game_attackairlw", game_richter_AttackAirLw)
    .game_acmd("game_catch", game_richter_Catch)
    .game_acmd("game_catchdash", game_richter_CatchDash)
    .game_acmd("game_catchturn", game_richter_CatchTurn)
    .game_acmd("game_catchattack", game_richter_CatchAttack)
    .game_acmd("game_throwf", game_richter_ThrowF)
    .game_acmd("game_throwb", game_richter_ThrowB)
    .game_acmd("game_throwhi", game_richter_ThrowHi)
    .game_acmd("game_throwlw", game_richter_ThrowLw)
    .game_acmd("game_downattackd", game_richter_DownAttackD)
    .game_acmd("game_downattacku", game_richter_DownAttackU)
    .game_acmd("game_cliffattack", game_richter_CliffAttack)
    .game_acmd("game_slipattack", game_richter_SlipAttack)
    .game_acmd("game_specialn", game_richter_SpecialN)  
    .game_acmd("game_specialairn", game_richter_SpecialAirN)
    .game_acmd("game_specials1", game_richter_SpecialS1)  
    .game_acmd("game_specials2", game_richter_SpecialS2)  
    .game_acmd("game_specialairs1", game_richter_SpecialAirS1)
    .game_acmd("game_specialairs2", game_richter_SpecialAirS2)
    .game_acmd("game_specialhi", game_richter_SpecialHi)
    .game_acmd("game_specialairhi", game_richter_SpecialAirHi)
    .game_acmd("game_speciallw", game_richter_SpecialLw)
    .game_acmd("game_specialairlw", game_richter_SpecialAirLw)
    .game_acmd("game_appealsr", game_richter_AppealSR)
    .game_acmd("game_appealsl", game_richter_AppealSL)
    .game_acmd("game_appealhir", game_richter_AppealHiR)
    .game_acmd("game_appealhil", game_richter_AppealHiL)
    .game_acmd("game_appeallwr", game_richter_AppealLwR)
    .game_acmd("game_appeallwl", game_richter_AppealLwL)
    .game_acmd("game_finalend", game_richter_FinalEnd)
    .game_acmd("game_finalairend", game_richter_FinalAirEnd)
    .install();
}
