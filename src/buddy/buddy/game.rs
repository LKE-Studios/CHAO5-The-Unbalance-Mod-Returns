...
pub fn install() {
    Agent::new("buddy")
    .game_acmd("game_jumpaerialf2", game_buddy_JumpAerialF2)
    .game_acmd("game_jumpaerialf3", game_buddy_JumpAerialF3)
    .game_acmd("game_jumpaerialf4", game_buddy_JumpAerialF4)
    .game_acmd("game_jumpaerialf5", game_buddy_JumpAerialF5)
    .game_acmd("game_glidedirection", game_buddy_GlideDirection)
    .game_acmd("game_glideattack", game_buddy_GlideAttack)
    .game_acmd("game_attack11", game_buddy_Attack11)
    .game_acmd("game_attack12", game_buddy_Attack12)
    .game_acmd("game_attack13", game_buddy_Attack13)
    .game_acmd("game_attack100", game_buddy_Attack100)
    .game_acmd("game_attack100sub", game_buddy_Attack100Sub)
    .game_acmd("game_attack100end", game_buddy_Attack100End)
    .game_acmd("game_attackdash", game_buddy_AttackDash)
    .game_acmd("game_attacks3hi", game_buddy_AttackS3Hi)
    .game_acmd("game_attacks3", game_buddy_AttackS3)
    .game_acmd("game_attacks3lw", game_buddy_AttackS3Lw)
    .game_acmd("game_attackhi3", game_buddy_AttackHi3)
    .game_acmd("game_attacklw3", game_buddy_AttackLw3)
    .game_acmd("game_attacks4", game_buddy_AttackS4)
    .game_acmd("game_attackhi4", game_buddy_AttackHi4)
    .game_acmd("game_attacklw4", game_buddy_AttackLw4)
    .game_acmd("game_attackairn", game_buddy_AttackAirN)
    .game_acmd("game_attackairf", game_buddy_AttackAirF)    
    .game_acmd("game_attackairb", game_buddy_AttackAirB)
    .game_acmd("game_attackairhi", game_buddy_AttackAirHi)
    .game_acmd("game_attackairlw", game_buddy_AttackAirLw)
    .game_acmd("game_landingairlw", game_buddy_LandingAirLw)
    .game_acmd("game_catch", game_buddy_Catch)
    .game_acmd("game_catchdash", game_buddy_CatchDash)
    .game_acmd("game_catchturn", game_buddy_CatchTurn)
    .game_acmd("game_catchattack", game_buddy_CatchAttack)
    .game_acmd("game_throwf", game_buddy_ThrowF)
    .game_acmd("game_throwb", game_buddy_ThrowB)
    .game_acmd("game_throwhi", game_buddy_ThrowHi)
    .game_acmd("game_throwlw", game_buddy_ThrowLw)
    .game_acmd("game_downattackd", game_buddy_DownAttackD)
    .game_acmd("game_downattacku", game_buddy_DownAttackU)
    .game_acmd("game_cliffattack", game_buddy_CliffAttack)
    .game_acmd("game_slipattack", game_buddy_SlipAttack)
    .game_acmd("game_specialnfire", game_buddy_SpecialNFire)
    .game_acmd("game_specialnfire2", game_buddy_SpecialNFire2)
    .game_acmd("game_specialnupperfire", game_buddy_SpecialNUpperFire)
    .game_acmd("game_specialairnfire2", game_buddy_SpecialAirNFire2)
    .game_acmd("game_specialairnfire3", game_buddy_SpecialAirNFire3)
    .game_acmd("game_specialairsstart", game_buddy_SpecialAirSStart)
    .game_acmd("game_specialsstart", game_buddy_SpecialSStart)
    .game_acmd("game_specialsdash", game_buddy_SpecialSDash)
    .game_acmd("game_specialairsdash", game_buddy_SpecialAirSDash)
    .game_acmd("game_specialsend", game_buddy_SpecialSEnd)
    .game_acmd("game_specialairsend", game_buddy_SpecialAirSEnd)
    .game_acmd("game_specialhistart", game_buddy_SpecialHiStart)
    .game_acmd("game_specialhi", game_buddy_SpecialHi)
    .game_acmd("game_speciallw", game_buddy_SpecialLw)
    .game_acmd("game_specialairlw", game_buddy_SpecialAirLw)
    .game_acmd("game_appealsr", game_buddy_AppealSR)
    .game_acmd("game_appealsl", game_buddy_AppealSL)
    .game_acmd("game_appealhir", game_buddy_AppealHiR)
    .game_acmd("game_appealhil", game_buddy_AppealHiL)
    .game_acmd("game_appeallwr", game_buddy_AppealLwR)
    .game_acmd("game_appeallwl", game_buddy_AppealLwL)
    .game_acmd("game_finalend", game_buddy_FinalEnd)
    .game_acmd("game_finalairend", game_buddy_FinalAirEnd)
    .install();
}
