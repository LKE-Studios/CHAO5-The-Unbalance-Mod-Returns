...
//Missile
unsafe extern "C" fn game_buddy_bullet_Missile(fighter: &mut L2CAgentBase) {
...
//Bakyun
unsafe extern "C" fn game_buddy_bullet_Bakyun(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//BakyunW1
unsafe extern "C" fn game_buddy_bullet_BakyunW1(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//BakyunW2
unsafe extern "C" fn game_buddy_bullet_BakyunW2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    ...
    .game_acmd("game_bakyunw1", game_buddy_bullet_Missile)
    .game_acmd("game_bakyunw1", game_buddy_bullet_Bakyun)
