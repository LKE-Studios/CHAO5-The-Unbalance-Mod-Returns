...
unsafe extern "C" fn status_waluigi_TurnDash_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    Agent::new("dolly")
    .status(Pre, *FIGHTER_STATUS_KIND_TURN_DASH, status_waluigi_TurnDash_Pre)
    .install();
}
