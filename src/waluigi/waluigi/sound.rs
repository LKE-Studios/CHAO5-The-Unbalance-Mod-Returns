...
pub fn install() {
    Agent::new("dolly")
    .sound_acmd("sound_attack11_waluigi", sound_waluigi_Attack11, Low)
    .sound_acmd("sound_attack12_waluigi", sound_waluigi_Attack12, Low)
    .sound_acmd("sound_attack13_waluigi", sound_waluigi_Attack13, Low)
    .sound_acmd("sound_attackdash_waluigi", sound_waluigi_AttackDash, Low)
    .sound_acmd("sound_attacks3_waluigi", sound_waluigi_AttackS3, Low)
    .sound_acmd("sound_attackhi3_waluigi", sound_waluigi_AttackHi3, Low)
    .sound_acmd("sound_attacklw3_waluigi", sound_waluigi_AttackLw3, Low)
    .sound_acmd("sound_attacks4_waluigi", sound_waluigi_AttackS4, Low)
    .sound_acmd("sound_attackhi4_waluigi", sound_waluigi_AttackHi4, Low)
    .sound_acmd("sound_attacklw4_waluigi", sound_waluigi_AttackLw4, Low)
    .sound_acmd("sound_attackairn_waluigi", sound_waluigi_AttackAirN, Low)
    .sound_acmd("sound_attackairf_waluigi", sound_waluigi_AttackAirF, Low)
    .sound_acmd("sound_attackairb_waluigi", sound_waluigi_AttackAirB, Low)
    .sound_acmd("sound_attackairhi_waluigi", sound_waluigi_AttackAirHi, Low)
    .sound_acmd("sound_attackairlw_waluigi", sound_waluigi_AttackAirLw, Low)
    .sound_acmd("sound_catchattack_waluigi", sound_waluigi_CatchAttack, Low)
    .sound_acmd("sound_throwf_waluigi", sound_waluigi_ThrowF, Low)
    .sound_acmd("sound_throwb_waluigi", sound_waluigi_ThrowB, Low)
    .sound_acmd("sound_throwhi_waluigi", sound_waluigi_ThrowHi, Low)
    .sound_acmd("sound_throwlw_waluigi", sound_waluigi_ThrowLw, Low)
    .sound_acmd("sound_downattacku_waluigi", sound_waluigi_DownAttackU, Low)
    .sound_acmd("sound_downattackd_waluigi", sound_waluigi_DownAttackD, Low)
    .sound_acmd("sound_specialn_waluigi", sound_waluigi_SpecialN, Low)
    .sound_acmd("sound_specialairn_waluigi", sound_waluigi_SpecialAirN, Low)
    .sound_acmd("sound_specialsbstart_waluigi", sound_waluigi_SpecialSBStart, Low)
    .sound_acmd("sound_specialsbattackw_waluigi", sound_waluigi_SpecialSBAttackW, Low)
    .sound_acmd("sound_specialsbattack_waluigi", sound_waluigi_SpecialSBAttack, Low)
    .sound_acmd("sound_specialairsfend_waluigi", sound_waluigi_SpecialAirSFEnd, Low)
    .sound_acmd("sound_specialairsfend2", sound_waluigi_SpecialAirSFEnd2, Low)
    .sound_acmd("sound_specialsfattack_waluigi", sound_waluigi_SpecialSFAttack, Low)
    .sound_acmd("sound_specialsfstart_waluigi", sound_waluigi_SpecialSFStart, Low)
    .sound_acmd("sound_specialairsfstart_waluigi", sound_waluigi_SpecialAirSFStart, Low)
    .sound_acmd("sound_specialhi1_waluigi", sound_waluigi_SpecialHi1, Low)
    .sound_acmd("sound_specialairhi1_waluigi", sound_waluigi_SpecialAirHi1, Low)
    .sound_acmd("sound_speciallwstart_waluigi", sound_waluigi_SpecialLwStart, Low)
    .sound_acmd("sound_specialairlwstart_waluigi", sound_waluigi_SpecialAirLwStart, Low)
    .sound_acmd("sound_specialairlw_waluigi", sound_waluigi_SpecialAirLw, Low)
    .sound_acmd("sound_speciallwshield", sound_waluigi_SpecialLwShield, Low)
    .sound_acmd("sound_speciallwattack1", sound_waluigi_SpecialLwAttack1, Low)
    .sound_acmd("sound_speciallwattack2", sound_waluigi_SpecialLwAttack2, Low)
    .sound_acmd("sound_speciallwattack3", sound_waluigi_SpecialLwAttack3, Low)
    .sound_acmd("sound_speciallwattackspecial1", sound_waluigi_SpecialLwAttackSpecial1, Low)
    .sound_acmd("sound_speciallwattackspecial2", sound_waluigi_SpecialLwAttackSpecial2, Low)
    .sound_acmd("sound_speciallwjump", sound_waluigi_SpecialLwJump, Low)
    .sound_acmd("sound_speciallwattackair", sound_waluigi_SpecialLwAttackAir, Low)
    .sound_acmd("sound_speciallwspecialair", sound_waluigi_SpecialLwSpecialAir, Low)
    .sound_acmd("sound_speciallwspecial", sound_waluigi_SpecialLwSpecial, Low)
    .sound_acmd("sound_speciallwjumpair", sound_waluigi_SpecialLwJumpAir, Low)
    .sound_acmd("sound_superspecial_waluigi", sound_waluigi_SuperSpecial, Low)
    .sound_acmd("sound_superspecial2_waluigi", sound_waluigi_SuperSpecial2, Low)
