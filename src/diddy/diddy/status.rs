...
unsafe extern "C" fn status_diddy_SpecialLwLaugh(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    fighter.sub_shift_status_main(L2CValue::Ptr(diddy_SpecialLwLaugh_Main_Sub as *const () as _))
}

pub unsafe extern "C" fn diddy_SpecialLwLaugh_Main_Sub(fighter: &mut L2CFighterCommon) -> L2CValue {
