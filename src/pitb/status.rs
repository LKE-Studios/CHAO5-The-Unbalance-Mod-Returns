...
pub unsafe fn glide_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    ANGLE[ENTRY_ID] = 0.0;
    macros::SET_SPEED_EX(fighter, 1.9, -0.357, *KINETIC_ENERGY_RESERVE_ATTRIBUTE_MAIN);
    L2CValue::I32(0)
}
...
#[status_script(agent = "pitb", status = FIGHTER_STATUS_KIND_GLIDE_ATTACK, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_END)]
