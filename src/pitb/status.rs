...
static DOWN_H_SPEED : f32 = 2.868; //Sorta Emulates how Brawl handled gaining additional forward speed
static Y_ACCEL_ADD : f32 = 0.03715; //Ascent/Descent Speed Multiplier
static X_DECEL_MUL_UP : f32 = -0.022450237;
static X_ACCEL_MUL_DOWN : f32 = -0.02; 
static X_DECEL_MUL_DOWN : f32 = 0.0351308; 
static ANGLE_SPEED_MAX : f32 = 6.5; //Max Angular Speed
static mut UP_ANGLE_ACCEL_MIN : [f32; 8] = [0.6; 8]; //Min Upward angular acceleration 
static UP_ANGLE_ACCEL_MAX : f32 = 0.91; //Max Upward angular acceleration
static mut DOWN_ANGLE_ACCEL_MIN : [f32; 8] = [0.44; 8]; //Min Downward angular acceleration 
...
unsafe extern "C" fn glide_core(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if speed_x * PostureModule::lr(fighter.module_accessor) < 0.8 {
