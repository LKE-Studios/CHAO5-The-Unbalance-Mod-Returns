...
pub fn install() {
    Agent::new("pitb")
    .game_acmd("game_jumpaerialf4", game_pitb_JumpAerialF4)
    .game_acmd("game_jumpaerialf5", game_pitb_JumpAerialF5)
    .game_acmd("game_jumpaerialf6", game_pitb_JumpAerialF6)
    .game_acmd("game_jumpaerialf7", game_pitb_JumpAerialF7)
    .game_acmd("game_glidestart", game_pitb_GlideStart)
    .game_acmd("game_glidedirection", game_pitb_GlideDirection)
    .game_acmd("game_glideattack", game_pitb_GlideAttack)
    .game_acmd("game_attack11", game_pitb_Attack11)
    .game_acmd("game_attack12", game_pitb_Attack12)
    .game_acmd("game_attack13", game_pitb_Attack13)
    .game_acmd("game_attack100", game_pitb_Attack100)
    .game_acmd("game_attack100sub", game_pitb_Attack100Sub)
    .game_acmd("game_attack100end", game_pitb_Attack100End)
    .game_acmd("game_attackdash", game_pitb_AttackDash)
    .game_acmd("game_attacks3", game_pitb_AttackS3)
    .game_acmd("game_attackhi3", game_pitb_AttackHi3)
    .game_acmd("game_attacklw3", game_pitb_AttackLw3)
    .game_acmd("game_attacks4", game_pitb_AttackS4)
    .game_acmd("game_attackhi4", game_pitb_AttackHi4)
    .game_acmd("game_attacklw4", game_pitb_AttackLw4)
    .game_acmd("game_attackairn", game_pitb_AttackAirN)
    .game_acmd("game_attackairf", game_pitb_AttackAirF)    
    .game_acmd("game_attackairb", game_pitb_AttackAirB)
    .game_acmd("game_attackairhi", game_pitb_AttackAirHi)
    .game_acmd("game_attackairlw", game_pitb_AttackAirLw)
    .game_acmd("game_catch", game_pitb_Catch)
    .game_acmd("game_catchdash", game_pitb_CatchDash)
    .game_acmd("game_catchturn", game_pitb_CatchTurn)
    .game_acmd("game_catchattack", game_pitb_CatchAttack)
    .game_acmd("game_throwf", game_pitb_ThrowF)
    .game_acmd("game_throwb", game_pitb_ThrowB)
    .game_acmd("game_throwhi", game_pitb_ThrowHi)
    .game_acmd("game_throwlw", game_pitb_ThrowLw)
    .game_acmd("game_downattackd", game_pitb_DownAttackD)
    .game_acmd("game_downattacku", game_pitb_DownAttackU)
    .game_acmd("game_cliffattack", game_pitb_CliffAttack)
    .game_acmd("game_slipattack", game_pitb_SlipAttack)
    .game_acmd("game_specialsstart", game_pitb_SpecialSStart)  
    .game_acmd("game_specialsend", game_pitb_SpecialSEnd)
    .game_acmd("game_specialairsstart", game_pitb_SpecialAirSStart)  
    .game_acmd("game_specialairsend", game_pitb_SpecialAirSEnd)
    .game_acmd("game_specialhi", game_pitb_SpecialHi)
    .game_acmd("game_speciallwhold", game_pitb_SpecialLwHold)
    .game_acmd("game_specialairlwhold", game_pitb_SpecialAirLwHold)
    .game_acmd("game_appealsr", game_pitb_AppealSR)
    .game_acmd("game_appealsl", game_pitb_AppealSL)
    .game_acmd("game_appealhir", game_pitb_AppealHiR)
    .game_acmd("game_appealhil", game_pitb_AppealHiL)
    .game_acmd("game_appeallwr", game_pitb_AppealLwR)
    .game_acmd("game_appeallwl", game_pitb_AppealLwL)
    .game_acmd("game_final", game_pitb_Final)
    .game_acmd("game_finalair", game_pitb_FinalAir)
    .game_acmd("game_finalcom", game_pitb_FinalCom)
    .install();
}
