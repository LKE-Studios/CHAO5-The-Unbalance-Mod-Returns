...
pub fn install() {
    Agent::new("gaogaen")
    .game_acmd("game_attack11", game_gaogaen_Attack11)
    .game_acmd("game_attack12", game_gaogaen_Attack12)
    .game_acmd("game_attack13", game_gaogaen_Attack13)
    .game_acmd("game_attackdash", game_gaogaen_AttackDash)
    .game_acmd("game_attacks3", game_gaogaen_AttackS3)
    .game_acmd("game_attackhi3", game_gaogaen_AttackHi3)
    .game_acmd("game_attacklw3", game_gaogaen_AttackLw3)
    .game_acmd("game_attacks4", game_gaogaen_AttackS4)
    .game_acmd("game_attackhi4", game_gaogaen_AttackHi4)
    .game_acmd("game_attacklw4", game_gaogaen_AttackLw4)
    .game_acmd("game_attackairn", game_gaogaen_AttackAirN)
    .game_acmd("game_attackairf", game_gaogaen_AttackAirF)    
    .game_acmd("game_attackairb", game_gaogaen_AttackAirB)
    .game_acmd("game_attackairhi", game_gaogaen_AttackAirHi)
    .game_acmd("game_attackairlw", game_gaogaen_AttackAirLw)
    .game_acmd("game_catch", game_gaogaen_Catch)
    .game_acmd("game_catchdash", game_gaogaen_CatchDash)
    .game_acmd("game_catchturn", game_gaogaen_CatchTurn)
    .game_acmd("game_catchattack", game_gaogaen_CatchAttack)
    .game_acmd("game_throwf", game_gaogaen_ThrowF)
    .game_acmd("game_throwb", game_gaogaen_ThrowB)
    .game_acmd("game_throwhi", game_gaogaen_ThrowHi)
    .game_acmd("game_throwlw", game_gaogaen_ThrowLw)
    .game_acmd("game_downattackd", game_gaogaen_DownAttackD)
    .game_acmd("game_downattacku", game_gaogaen_DownAttackU)
    .game_acmd("game_cliffattack", game_gaogaen_CliffAttack)
    .game_acmd("game_slipattack", game_gaogaen_SlipAttack)
    .game_acmd("game_specialn", game_gaogaen_SpecialN)
    .game_acmd("game_specialairn", game_gaogaen_SpecialAirN)
    .game_acmd("game_specialsstart", game_gaogaen_SpecialSStart)
    .game_acmd("game_specialslariat", game_gaogaen_SpecialSLariat)
    .game_acmd("game_specialsfailure", game_gaogaen_SpecialSFailure)
    .game_acmd("game_specialsshoulder", game_gaogaen_SpecialSShoulder)
    .game_acmd("game_specialairsstart", game_gaogaen_SpecialAirSStart)
    .game_acmd("game_specialairslariat", game_gaogaen_SpecialAirSLariat)
    .game_acmd("game_specialairsfailure", game_gaogaen_SpecialAirSFailure)
    .game_acmd("game_specialhistart", game_gaogaen_SpecialHiStart)
    .game_acmd("game_specialhibound", game_gaogaen_SpecialHiBound)
    .game_acmd("game_specialairhistart", game_gaogaen_SpecialAirHiStart)
    .game_acmd("game_specialairhifall", game_gaogaen_SpecialAirHiFall)
    .game_acmd("game_specialairhifall2", game_gaogaen_SpecialAirHiFall2)
    .game_acmd("game_speciallw", game_gaogaen_SpecialLw)
    .game_acmd("game_speciallwturn", game_gaogaen_SpecialLwTurn)
    .game_acmd("game_specialairlw", game_gaogaen_SpecialAirLw)
    .game_acmd("game_specialairlwturn", game_gaogaen_SpecialAirLwTurn)
    .game_acmd("game_appealsr", game_gaogaen_AppealSR)
    .game_acmd("game_appealsl", game_gaogaen_AppealSL)
    .game_acmd("game_appealhir", game_gaogaen_AppealHiR)
    .game_acmd("game_appealhil", game_gaogaen_AppealHiL)
    .game_acmd("game_appeallwr", game_gaogaen_AppealLwR)
    .game_acmd("game_appeallwl", game_gaogaen_AppealLwL)
    .game_acmd("game_finalend", game_gaogaen_FinalEnd)
    .game_acmd("game_finalairend", game_gaogaen_FinalAirEnd)
    .install();
}
