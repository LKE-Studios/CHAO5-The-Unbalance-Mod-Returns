...
//Attack11
unsafe extern "C" fn game_gaogaen_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_gaogaen_Attack12(fighter: &mut L2CAgentBase) {
...
//Attack13
unsafe extern "C" fn game_gaogaen_Attack13(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackDash
unsafe extern "C" fn game_gaogaen_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3Hi
unsafe extern "C" fn game_gaogaen_AttackS3Hi(fighter: &mut L2CAgentBase) {
...
//AttackS3
unsafe extern "C" fn game_gaogaen_AttackS3(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.7);
    frame(fighter.lua_state_agent, 12.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackS3Lw
unsafe extern "C" fn game_gaogaen_AttackS3Lw(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.7);
    frame(fighter.lua_state_agent, 12.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackHi3
unsafe extern "C" fn game_gaogaen_AttackHi3(fighter: &mut L2CAgentBase) {
...
//AttackLw3
unsafe extern "C" fn game_gaogaen_AttackLw3(fighter: &mut L2CAgentBase) {
...
//AttackS4
unsafe extern "C" fn game_gaogaen_AttackS4(fighter: &mut L2CAgentBase) {
...
//AttackHi4
unsafe extern "C" fn game_gaogaen_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackLw4
unsafe extern "C" fn game_gaogaen_AttackLw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        JostleModule::set_status(fighter.module_accessor, false);
    }
...
//AttackAirN
unsafe extern "C" fn game_gaogaen_AttackAirN(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackAirF 
unsafe extern "C" fn game_gaogaen_AttackAirF(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirB
unsafe extern "C" fn game_gaogaen_AttackAirB(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirHi
unsafe extern "C" fn game_gaogaen_AttackAirHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirLw
unsafe extern "C" fn game_gaogaen_AttackAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        JostleModule::set_status(fighter.module_accessor, false);
    }
...
//Catch
unsafe extern "C" fn game_gaogaen_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 6.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//CatchDash
unsafe extern "C" fn game_gaogaen_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 6.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//CatchTurn
unsafe extern "C" fn game_gaogaen_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 6.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//CatchAttack
unsafe extern "C" fn game_gaogaen_CatchAttack(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//ThrowF
unsafe extern "C" fn game_gaogaen_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_gaogaen_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_gaogaen_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
    ...
    frame(fighter.lua_state_agent, 25.0);
    if is_excute(fighter) {
        FT_CATCH_STOP(fighter, 14.0, 1.0);
...
//ThrowLw
unsafe extern "C" fn game_gaogaen_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_gaogaen_CliffAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 24.0);
    if is_excute(fighter) {
...
//SlipAttack
unsafe extern "C" fn game_gaogaen_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_gaogaen_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 18.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_gaogaen_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 18.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 18.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 15.5, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_PUNCH, /*Type*/ *ATTACK_REGION_PUNCH);
    }
...
//SpecialN
unsafe extern "C" fn game_gaogaen_SpecialN(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirN
unsafe extern "C" fn game_gaogaen_SpecialAirN(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialSStart
unsafe extern "C" fn game_gaogaen_SpecialSStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//SpecialSFailure
unsafe extern "C" fn game_gaogaen_SpecialSFailure(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialSLariat
unsafe extern "C" fn game_gaogaen_SpecialSLariat(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialSShoulder
unsafe extern "C" fn game_gaogaen_SpecialSShoulder(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialAirSStart
unsafe extern "C" fn game_gaogaen_SpecialAirSStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_GAOGAEN_STATUS_SPECIAL_S_FLAG_MOVE_START);
    }
...
//SpecialAirSFailure
unsafe extern "C" fn game_gaogaen_SpecialAirSFailure(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 0.0, /*Angle*/ 30, /*KBG*/ 50, /*FKB*/ 0, /*BKB*/ 30, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_B, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        AttackModule::set_force_reaction(fighter.module_accessor, 0, true, true);
...
//SpecialAirSLariat
unsafe extern "C" fn game_gaogaen_SpecialAirSLariat(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 10.0, /*Angle*/ 145, /*KBG*/ 200, /*FKB*/ 0, /*BKB*/ 20, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_B, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_death"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        AttackModule::set_force_reaction(fighter.module_accessor, 0, true, true);
...
//SpecialAirSShoulder
unsafe extern "C" fn game_gaogaen_SpecialAirSShoulder(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 17.5, /*Angle*/ 105, /*KBG*/ 96, /*FKB*/ 0, /*BKB*/ 70, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_B, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        AttackModule::set_force_reaction(fighter.module_accessor, 0, true, true);
...
//SpecialHiStart
unsafe extern "C" fn game_gaogaen_SpecialHiStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialHiBound
unsafe extern "C" fn game_gaogaen_SpecialHiBound(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//SpecialAirHiStart
unsafe extern "C" fn game_gaogaen_SpecialAirHiStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialAirHiFall
unsafe extern "C" fn game_gaogaen_SpecialAirHiFall(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        notify_event_msc_cmd!(fighter, Hash40::new_raw(0x2127e37c07), *GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES);
...
//SpecialAirHiFall2
unsafe extern "C" fn game_gaogaen_SpecialAirHiFall2(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        notify_event_msc_cmd!(fighter, Hash40::new_raw(0x2127e37c07), *GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES);
...
//SpecialLw
unsafe extern "C" fn game_gaogaen_SpecialLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//SpecialLwTurn
unsafe extern "C" fn game_gaogaen_SpecialLwTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
    }
...
//SpecialAirLw
unsafe extern "C" fn game_gaogaen_SpecialAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
    }
...
//SpecialAirLwTurn
unsafe extern "C" fn game_gaogaen_SpecialAirLwTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
    }
...
//AppealHiR
unsafe extern "C" fn game_gaogaen_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_gaogaen_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_USAGIHAT), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_gaogaen_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_gaogaen_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_ROCKETBELT), 0, 0, false, false);
    }
}
...
//AppealLwR
unsafe extern "C" fn game_gaogaen_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_gaogaen_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_CHEWING), 0, 0, false, false);
    }
}
...
//Final
unsafe extern "C" fn game_gaogaen_FinalEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_gaogaen_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_GAOGAEN_FINAL, /*ID*/ 0, /*Damage*/ 200.0, /*Angle*/ 361, /*KBG*/ 30, /*FKB*/ 0, /*BKB*/ 5, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_GAOGAEN_STATUS_WORK_ID_FLAG_FINAL_ABS_SET);
    }
...
pub fn install() {
    Agent::new("gaogaen")
    .game_acmd("game_attack11", game_gaogaen_Attack11, Low)
    .game_acmd("game_attack12", game_gaogaen_Attack12, Low)
    .game_acmd("game_attack13", game_gaogaen_Attack13, Low)
    .game_acmd("game_attackdash", game_gaogaen_AttackDash, Low)
    .game_acmd("game_attacks3", game_gaogaen_AttackS3, Low)
    .game_acmd("game_attackhi3", game_gaogaen_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_gaogaen_AttackLw3, Low)
    .game_acmd("game_attacks4", game_gaogaen_AttackS4, Low)
    .game_acmd("game_attackhi4", game_gaogaen_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_gaogaen_AttackLw4, Low)
    .game_acmd("game_attackairn", game_gaogaen_AttackAirN, Low)
    .game_acmd("game_attackairf", game_gaogaen_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_gaogaen_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_gaogaen_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_gaogaen_AttackAirLw, Low)
    .game_acmd("game_catch", game_gaogaen_Catch, Low)
    .game_acmd("game_catchdash", game_gaogaen_CatchDash, Low)
    .game_acmd("game_catchturn", game_gaogaen_CatchTurn, Low)
    .game_acmd("game_catchattack", game_gaogaen_CatchAttack, Low)
    .game_acmd("game_throwf", game_gaogaen_ThrowF, Low)
    .game_acmd("game_throwb", game_gaogaen_ThrowB, Low)
    .game_acmd("game_throwhi", game_gaogaen_ThrowHi, Low)
    .game_acmd("game_throwlw", game_gaogaen_ThrowLw, Low)
    .game_acmd("game_downattackd", game_gaogaen_DownAttackD, Low)
    .game_acmd("game_downattacku", game_gaogaen_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_gaogaen_CliffAttack, Low)
    .game_acmd("game_slipattack", game_gaogaen_SlipAttack, Low)
    .game_acmd("game_specialn", game_gaogaen_SpecialN, Low)
    .game_acmd("game_specialairn", game_gaogaen_SpecialAirN, Low)
    .game_acmd("game_specialsstart", game_gaogaen_SpecialSStart, Low)
    .game_acmd("game_specialslariat", game_gaogaen_SpecialSLariat, Low)
    .game_acmd("game_specialsfailure", game_gaogaen_SpecialSFailure, Low)
    .game_acmd("game_specialsshoulder", game_gaogaen_SpecialSShoulder, Low)
    .game_acmd("game_specialairsstart", game_gaogaen_SpecialAirSStart, Low)
    .game_acmd("game_specialairslariat", game_gaogaen_SpecialAirSLariat, Low)
    .game_acmd("game_specialairsfailure", game_gaogaen_SpecialAirSFailure, Low)
    .game_acmd("game_specialhistart", game_gaogaen_SpecialHiStart, Low)
    .game_acmd("game_specialhibound", game_gaogaen_SpecialHiBound, Low)
    .game_acmd("game_specialairhistart", game_gaogaen_SpecialAirHiStart, Low)
    .game_acmd("game_specialairhifall", game_gaogaen_SpecialAirHiFall, Low)
    .game_acmd("game_specialairhifall2", game_gaogaen_SpecialAirHiFall2, Low)
    .game_acmd("game_speciallw", game_gaogaen_SpecialLw, Low)
    .game_acmd("game_speciallwturn", game_gaogaen_SpecialLwTurn, Low)
    .game_acmd("game_specialairlw", game_gaogaen_SpecialAirLw, Low)
    .game_acmd("game_specialairlwturn", game_gaogaen_SpecialAirLwTurn, Low)
    .game_acmd("game_appealsr", game_gaogaen_AppealSR, Low)
    .game_acmd("game_appealsl", game_gaogaen_AppealSL, Low)
    .game_acmd("game_appealhir", game_gaogaen_AppealHiR, Low)
    .game_acmd("game_appealhil", game_gaogaen_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_gaogaen_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_gaogaen_AppealLwL, Low)
    .game_acmd("game_finalend", game_gaogaen_FinalEnd, Low)
    .game_acmd("game_finalairend", game_gaogaen_FinalAirEnd, Low)
    .install();
}
