...
pub fn install() {
    Agent::new("pzenigame")
    .game_acmd("game_attack11", game_pzenigame_Attack11, Low)
    .game_acmd("game_attack12", game_pzenigame_Attack12, Low)
    .game_acmd("game_attack13", game_pzenigame_Attack13, Low)
    .game_acmd("game_attackdash", game_pzenigame_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_pzenigame_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_pzenigame_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_pzenigame_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_pzenigame_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_pzenigame_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_pzenigame_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_pzenigame_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_pzenigame_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_pzenigame_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_pzenigame_AttackLw4, Low)
    .game_acmd("game_attackairn", game_pzenigame_AttackAirN, Low)
    .game_acmd("game_attackairf", game_pzenigame_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_pzenigame_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_pzenigame_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_pzenigame_AttackAirLw, Low)
    .game_acmd("game_catch", game_pzenigame_Catch, Low)
    .game_acmd("game_catchdash", game_pzenigame_CatchDash, Low)
    .game_acmd("game_catchturn", game_pzenigame_CatchTurn, Low)
    .game_acmd("game_catchattack", game_pzenigame_CatchAttack, Low)
    .game_acmd("game_throwf", game_pzenigame_ThrowF, Low)
    .game_acmd("game_throwb", game_pzenigame_ThrowB, Low)
    .game_acmd("game_throwhi", game_pzenigame_ThrowHi, Low)
    .game_acmd("game_throwlw", game_pzenigame_ThrowLw, Low)
    .game_acmd("game_downattackd", game_pzenigame_DownAttackD, Low)
    .game_acmd("game_downattacku", game_pzenigame_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_pzenigame_CliffAttack, Low)
    .game_acmd("game_slipattack", game_pzenigame_SlipAttack, Low)
    .game_acmd("game_specials", game_pzenigame_SpecialS, Low)
    .game_acmd("game_specialairs", game_pzenigame_SpecialAirS, Low)
    .game_acmd("game_specialhi", game_pzenigame_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_pzenigame_SpecialAirHi, Low)
    .game_acmd("game_specialz", game_pzenigame_SpecialZ, Low)
    .game_acmd("game_specialairz", game_pzenigame_SpecialAirZ, Low)
    .game_acmd("game_appealsr", game_pzenigame_AppealSR, Low)
    .game_acmd("game_appealsl", game_pzenigame_AppealSL, Low)
    .game_acmd("game_appealhir", game_pzenigame_AppealHiR, Low)
    .game_acmd("game_appealhil", game_pzenigame_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_pzenigame_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_pzenigame_AppealLwL, Low)
    .game_acmd("game_final", game_pzenigame_Final, Low)
    .game_acmd("game_finalair", game_pzenigame_FinalAir, Low)
    .install();
}
