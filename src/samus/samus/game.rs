...
pub fn install() {
    Agent::new("samus")
    .game_acmd("game_attack11", game_samus_Attack11, Low)
    .game_acmd("game_attack12", game_samus_Attack12, Low)
    .game_acmd("game_attackdash", game_samus_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_samus_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_samus_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_samus_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_samus_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_samus_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_samus_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_samus_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_samus_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_samus_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_samus_AttackLw4, Low)
    .game_acmd("game_attackairn", game_samus_AttackAirN, Low)
    .game_acmd("game_attackairf", game_samus_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_samus_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_samus_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_samus_AttackAirLw, Low)
    .game_acmd("game_catchattack", game_samus_CatchAttack, Low)
    .game_acmd("game_throwf", game_samus_ThrowF, Low)
    .game_acmd("game_throwb", game_samus_ThrowB, Low)
    .game_acmd("game_throwhi", game_samus_ThrowHi, Low)
    .game_acmd("game_throwlw", game_samus_ThrowLw, Low)
    .game_acmd("game_downattackd", game_samus_DownAttackD, Low)
    .game_acmd("game_downattacku", game_samus_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_samus_CliffAttack, Low)
    .game_acmd("game_slipattack", game_samus_SlipAttack, Low)
    .game_acmd("game_specialhi", game_samus_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_samus_SpecialAirHi, Low)
    .game_acmd("game_appealsr", game_samus_AppealSR, Low)
    .game_acmd("game_appealsl", game_samus_AppealSL, Low)
    .game_acmd("game_appealhir", game_samus_AppealHiR, Low)
    .game_acmd("game_appealhil", game_samus_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_samus_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_samus_AppealLwL, Low)
    .install();
}
