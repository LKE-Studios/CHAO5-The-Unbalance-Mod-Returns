...
unsafe fn kirby_neutralbloop(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, /*ID*/ 0, /*Bone*/ Hash40::new("top"), /*Size*/ 20.3, /*X*/ 0.0, /*Y*/ 6.4, /*Z*/ 180.2, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, *FIGHTER_STATUS_KIND_SWALLOWED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_A);
        macros::CATCH(fighter, /*ID*/ 1, /*Bone*/ Hash40::new("top"), /*Size*/ 20.8, /*X*/ 0.0, /*Y*/ 6.4, /*Z*/ 180.2, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, *FIGHTER_STATUS_KIND_SWALLOWED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA);
