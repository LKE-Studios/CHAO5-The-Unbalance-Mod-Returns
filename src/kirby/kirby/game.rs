...
pub fn install() {
    Agent::new("kirby")
    .game_acmd("game_attack11", game_kirby_Attack11, Low)
    .game_acmd("game_attack12", game_kirby_Attack12, Low)
    .game_acmd("game_attack100", game_kirby_Attack100, Low)
    .game_acmd("game_attack100sub", game_kirby_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_kirby_Attack100End, Low)
    .game_acmd("game_attackdash", game_kirby_AttackDash, Low)
    .game_acmd("game_attacks3", game_kirby_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_kirby_AttackS3Lw, Low)
    .game_acmd("game_attacks3hi", game_kirby_AttackS3Hi, Low)
    .game_acmd("game_attackhi3", game_kirby_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_kirby_AttackLw3, Low)
    .game_acmd("game_attacks4", game_kirby_AttackS4, Low)
    .game_acmd("game_attackhi4", game_kirby_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_kirby_AttackLw4, Low)
    .game_acmd("game_attackairn", game_kirby_AttackAirN, Low)
    .game_acmd("game_attackairf", game_kirby_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_kirby_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_kirby_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_kirby_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_kirby_LandingAirLw, Low)
    .game_acmd("game_catch", game_kirby_Catch, Low)
    .game_acmd("game_catchdash", game_kirby_CatchDash, Low)
    .game_acmd("game_catchturn", game_kirby_CatchTurn, Low)
    .game_acmd("game_catchattack", game_kirby_CatchAttack, Low)
    .game_acmd("game_throwf", game_kirby_ThrowF, Low)
    .game_acmd("game_throwb", game_kirby_ThrowB, Low)
    .game_acmd("game_throwhi", game_kirby_ThrowHi, Low)
    .game_acmd("game_throwlw", game_kirby_ThrowLw, Low)
    .game_acmd("game_downattackd", game_kirby_DownAttackD, Low)
    .game_acmd("game_downattacku", game_kirby_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_kirby_CliffAttack, Low)
    .game_acmd("game_slipattack", game_kirby_SlipAttack, Low)
    .game_acmd("game_specialnstart", game_kirby_SpecialNStart, Low)
    .game_acmd("game_specialnloop", game_kirby_SpecialNLoop, Low)
    .game_acmd("game_specialnspit", game_kirby_SpecialNSpit, Low)
    .game_acmd("game_specialairnstart", game_kirby_SpecialAirNStart, Low)
    .game_acmd("game_specialairnloop", game_kirby_SpecialAirNLoop, Low)
    .game_acmd("game_specialairnspit", game_kirby_SpecialAirNSpit, Low)
    .game_acmd("game_buddyspecialairnfire", game_kirby_BuddySpecialAirNFire, Low)
    .game_acmd("game_buddyspecialairnfire2", game_kirby_BuddySpecialAirNFire2, Low)
    .game_acmd("game_buddyspecialairnfire3", game_kirby_BuddySpecialAirNFire3, Low)
    .game_acmd("game_buddyspecialnsupperfire", game_kirby_BuddySpecialNUpperFire, Low)  
    .game_acmd("game_specials", game_kirby_SpecialS, Low)  
    .game_acmd("game_specialss", game_kirby_SpecialSS, Low)
    .game_acmd("game_specialsmax", game_kirby_SpecialSMax, Low)
    .game_acmd("game_specialairs", game_kirby_SpecialAirS, Low)  
    .game_acmd("game_specialairss", game_kirby_SpecialAirSS, Low)
    ...
    .game_acmd("game_speciallwtoground", game_kirby_SpecialLwToGround, Low)
    .game_acmd("game_speciallwtoair", game_kirby_SpecialLwToAir, Low)
    .game_acmd("game_specialairlw", game_kirby_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_kirby_AppealSR, Low)
    .game_acmd("game_appealsl", game_kirby_AppealSL, Low)
    .game_acmd("game_appealhir", game_kirby_AppealHiR, Low)
    .game_acmd("game_appealhil", game_kirby_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_kirby_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_kirby_AppealLwL, Low)
    .game_acmd("game_final", game_kirby_FinalAttack, Low)
    .game_acmd("game_finalfinish", game_kirby_FinalAirAttack, Low)
    .install();
}
