...
//Attack11
unsafe extern "C" fn game_kirby_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack100Sub 
unsafe extern "C" fn game_kirby_Attack100Sub(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 3.5, /*Angle*/ 361, /*KBG*/ 35, /*FKB*/ 0, /*BKB*/ 7, /*Size*/ 5.5, /*X*/ 0.0, /*Y*/ 5.5, /*Z*/ 15.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.5), /*Z2*/ Some(17.0), /*Hitlag*/ 0.5, /*SDI*/ 0.4, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_PUNCH, /*Type*/ *ATTACK_REGION_PUNCH);
        ATK_SET_SHIELD_SETOFF_MUL(fighter, /*ID*/ 0, /*ShieldstunMul*/ 7);
    }
...
//Attack100End
unsafe extern "C" fn game_kirby_Attack100End(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
...
//Attack12 
unsafe extern "C" fn game_kirby_Attack12(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
...
//AttackDash
unsafe extern "C" fn game_kirby_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3Hi
unsafe extern "C" fn game_kirby_AttackS3Hi(fighter: &mut L2CAgentBase) {
...
//AttackS3
unsafe extern "C" fn game_kirby_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackS3Lw
unsafe extern "C" fn game_kirby_AttackS3Lw(fighter: &mut L2CAgentBase) {
        frame(fighter.lua_state_agent, 5.0);
        if is_excute(fighter) {
...
//AttackHi3
unsafe extern "C" fn game_kirby_AttackHi3(fighter: &mut L2CAgentBase) {
...
//AttackLw3
unsafe extern "C" fn game_kirby_AttackLw3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackS4Hi
unsafe extern "C" fn game_kirby_AttackS4Hi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackS4
unsafe extern "C" fn game_kirby_AttackS4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackS4Lw
unsafe extern "C" fn game_kirby_AttackS4Lw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackHi4
unsafe extern "C" fn game_kirby_AttackHi4(fighter: &mut L2CAgentBase) {
...
//AttackLw4
unsafe extern "C" fn game_kirby_AttackLw4(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.4);
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
...
//AttackAirN
unsafe extern "C" fn game_kirby_AttackAirN(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//AttackAirF 
unsafe extern "C" fn game_kirby_AttackAirF(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
//AttackAirB
unsafe extern "C" fn game_kirby_AttackAirB(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirHi
unsafe extern "C" fn game_kirby_AttackAirHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 9.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackAirLw
unsafe extern "C" fn game_kirby_AttackAirLw(fighter: &mut L2CAgentBase) {
...
//LandingAirLw
unsafe extern "C" fn game_kirby_LandingAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//Catch
unsafe extern "C" fn game_kirby_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//CatchDash
unsafe extern "C" fn game_kirby_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchTurn
unsafe extern "C" fn game_kirby_CatchTurn(fighter: &mut L2CAgentBase) {
        frame(fighter.lua_state_agent, 9.0);
        if is_excute(fighter) {
            GrabModule::set_rebound(fighter.module_accessor, true);
        }
...
//CatchAttack
unsafe extern "C" fn game_kirby_CatchAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    if is_excute(fighter) {
...
//ThrowF
unsafe extern "C" fn game_kirby_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_kirby_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_kirby_ThrowHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_kirby_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_kirby_CliffAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 20.0);
    if is_excute(fighter) {
...
//SlipAttack
unsafe extern "C" fn game_kirby_SlipAttack(fighter: &mut L2CAgentBase) {
...
//DownAttackD
unsafe extern "C" fn game_kirby_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 16.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_kirby_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
...
//SpecialNStart
unsafe extern "C" fn game_kirby_SpecialNStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//SpecialAirNStart
unsafe extern "C" fn game_kirby_SpecialAirNStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 18.0);
...
//SpecialNLoop
unsafe extern "C" fn game_kirby_SpecialNLoop(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_KIRBY_STATUS_SPECIAL_N_FLAG_INHALE);
...
//SpecialAirNLoop
unsafe extern "C" fn game_kirby_SpecialAirNLoop(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_KIRBY_STATUS_SPECIAL_N_FLAG_INHALE);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 0.0, /*Angle*/ 160, /*KBG*/ 100, /*FKB*/ 30, /*BKB*/ 0, /*Size*/ 40.0, /*X*/ 0.0, /*Y*/ 7.0, /*Z*/ 200.5, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(5.0), /*Hitlag*/ 0.0, /*SDI*/ 0.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 10, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ true, /*DisableHitlag*/ true, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_G_d, /*Hitbits*/ *COLLISION_CATEGORY_MASK_NO_STAGE_GIMMICK, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
...
//SpecialNSpit
unsafe extern "C" fn game_kirby_SpecialNSpit(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirNSpit
unsafe extern "C" fn game_kirby_SpecialAirNSpit(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 25.0, /*Angle*/ 361, /*KBG*/ 0, /*FKB*/ 0, /*BKB*/ 0, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, /*ID*/ 0, /*Damage*/ 4.0, /*Angle*/ 361, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 0, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
    }
...
//BuddySpecialAirNFire
unsafe extern "C" fn game_kirby_BuddySpecialAirNFire(fighter: &mut L2CAgentBase) {
...
//BuddySpecialAirNFire2
unsafe extern "C" fn game_kirby_BuddySpecialAirNFire2(fighter: &mut L2CAgentBase) {
    MotionModule::set_rate(fighter.module_accessor, 5.0);
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_BUDDY_STATUS_SPECIAL_N_FLAG_GENERATE_BULLET);
...
//BuddySpecialAirNFire3
unsafe extern "C" fn game_kirby_BuddySpecialAirNFire3(fighter: &mut L2CAgentBase) {
    MotionModule::set_rate(fighter.module_accessor, 5.0);
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_BUDDY_STATUS_SPECIAL_N_FLAG_GENERATE_BULLET);
...
//BuddySpecialNUpperFire
unsafe extern "C" fn game_kirby_BuddySpecialNUpperFire(fighter: &mut L2CAgentBase) {
...
//SpecialS
unsafe extern "C" fn game_kirby_SpecialS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
    frame(fighter.lua_state_agent, 11.0);
...
//SpecialSS
unsafe extern "C" fn game_kirby_SpecialSS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
    frame(fighter.lua_state_agent, 11.0);
...
//SpecialSMax
unsafe extern "C" fn game_kirby_SpecialSMax(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirS
unsafe extern "C" fn game_kirby_SpecialAirS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
    frame(fighter.lua_state_agent, 11.0);
...
//SpecialAirSS
unsafe extern "C" fn game_kirby_SpecialAirSS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
    frame(fighter.lua_state_agent, 11.0);
...
//SpecialAirSMax
unsafe extern "C" fn game_kirby_SpecialAirSMax(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
    frame(fighter.lua_state_agent, 11.0);
...
//SpecialHi2
unsafe extern "C" fn game_kirby_SpecialHi2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialHiH
unsafe extern "C" fn game_kirby_SpecialHiH(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE_RANGE(fighter, 0.0, 23.0, 7.0);
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_FINALCUTTER, false, -1);
        ArticleModule::change_motion(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_FINALCUTTER, Hash40::new("special_hi1"), false, -1.0);
    }
    frame(fighter.lua_state_agent, 22.0);
    FT_MOTION_RATE(fighter, 1.0);
    frame(fighter.lua_state_agent, 23.0);
    if is_excute(fighter) {
        ATTACK(fighter, 0, 0, Hash40::new("haver"), 31.0, 72, 65, 0, 60, 8.5, 0.0, 2.0, -2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_curse_poison"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        ATTACK(fighter, 1, 0, Hash40::new("haver"), 31.0, 72, 65, 0, 60, 8.5, 0.0, 10.0, -1.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_curse_poison"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        AttackModule::set_poison_param(fighter.module_accessor, /*ID*/ 0, /*Frames*/ 480, /*Rehit*/ 30, /* Damage*/ 2.0, /*Unk*/ false);
        AttackModule::set_poison_param(fighter.module_accessor, /*ID*/ 1, /*Frames*/ 480, /*Rehit*/ 30, /* Damage*/ 2.0, /*Unk*/ false);
    }
    frame(fighter.lua_state_agent, 29.0);
    if is_excute(fighter) {
        ATTACK(fighter, 0, 0, Hash40::new("top"), 31.0, 72, 65, 0, 50, 8.5, 0.0, 7.0, 3.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_curse_poison"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        ATTACK(fighter, 1, 0, Hash40::new("top"), 31.0, 72, 65, 0, 50, 8.5, 0.0, 10.0, 6.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_curse_poison"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        AttackModule::set_poison_param(fighter.module_accessor, /*ID*/ 0, /*Frames*/ 480, /*Rehit*/ 30, /* Damage*/ 2.0, /*Unk*/ false);
        AttackModule::set_poison_param(fighter.module_accessor, /*ID*/ 1, /*Frames*/ 480, /*Rehit*/ 30, /* Damage*/ 2.0, /*Unk*/ false);
    }
    frame(fighter.lua_state_agent, 35.0);
...
//SpecialAirHi2
unsafe extern "C" fn game_kirby_SpecialAirHi2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::change_motion(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_FINALCUTTER, Hash40::new("special_hi2"), false, -1.0);
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
    }
...
//SpecialAirHiH
unsafe extern "C" fn game_kirby_SpecialAirHiH(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE_RANGE(fighter, 0.0, 18.0, 6.0);
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_FINALCUTTER, false, -1);
        ArticleModule::change_motion(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_FINALCUTTER, Hash40::new("special_hi1"), false, -1.0);
    }
...
//SpecialLw
unsafe extern "C" fn game_kirby_SpecialLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 0.3);
...
//SpecialLwToGround
unsafe extern "C" fn game_kirby_SpecialLwToGround(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialLwToAir
unsafe extern "C" fn game_kirby_SpecialLwToAir(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
...
//SpecialAirLw
unsafe extern "C" fn game_kirby_SpecialAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 0.3);
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
...
//SpecialAirLwToGround
unsafe extern "C" fn game_kirby_SpecialAirLwToGround(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
        ArticleModule::change_motion(fighter.module_accessor, *FIGHTER_KIRBY_GENERATE_ARTICLE_STONE, Hash40::new("special_lw_to_air"), false, -1.0);
        AttackModule::clear(fighter.module_accessor, /*ID*/ 1, false);
...
//AppealHiR
unsafe extern "C" fn game_kirby_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_kirby_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_STARROD), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_kirby_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_kirby_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_MAXIMTOMATO), 0, 0, false, false);
    }
}
...
//AppealLwR
unsafe extern "C" fn game_kirby_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_kirby_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_WARPSTAR), 0, 0, false, false);
    }
}
...
//FinalAttack
unsafe extern "C" fn game_kirby_FinalAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
...
//FinalAirAttack
unsafe extern "C" fn game_kirby_FinalAirAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        WHOLE_HIT(fighter, *HIT_STATUS_XLU);
        camera!(fighter, *MA_MSC_CMD_CAMERA_CAM_RECT, 40, -10, 20, -10);
...
pub fn install() {
    Agent::new("kirby")
    .game_acmd("game_attack11", game_kirby_Attack11)
    .game_acmd("game_attack12", game_kirby_Attack12)
    .game_acmd("game_attack100", game_kirby_Attack100)
    .game_acmd("game_attack100sub", game_kirby_Attack100Sub)
    .game_acmd("game_attack100end", game_kirby_Attack100End)
    .game_acmd("game_attackdash", game_kirby_AttackDash)
    .game_acmd("game_attacks3", game_kirby_AttackS3)
    .game_acmd("game_attacks3lw", game_kirby_AttackS3Lw)
    .game_acmd("game_attacks3hi", game_kirby_AttackS3Hi)
    .game_acmd("game_attackhi3", game_kirby_AttackHi3)
    .game_acmd("game_attacklw3", game_kirby_AttackLw3)
    .game_acmd("game_attacks4", game_kirby_AttackS4)
    .game_acmd("game_attackhi4", game_kirby_AttackHi4)
    .game_acmd("game_attacklw4", game_kirby_AttackLw4)
    .game_acmd("game_attackairn", game_kirby_AttackAirN)
    .game_acmd("game_attackairf", game_kirby_AttackAirF)    
    .game_acmd("game_attackairb", game_kirby_AttackAirB)
    .game_acmd("game_attackairhi", game_kirby_AttackAirHi)
    .game_acmd("game_attackairlw", game_kirby_AttackAirLw)
    .game_acmd("game_landingairlw", game_kirby_LandingAirLw)
    .game_acmd("game_catch", game_kirby_Catch)
    .game_acmd("game_catchdash", game_kirby_CatchDash)
    .game_acmd("game_catchturn", game_kirby_CatchTurn)
    .game_acmd("game_catchattack", game_kirby_CatchAttack)
    .game_acmd("game_throwf", game_kirby_ThrowF)
    .game_acmd("game_throwb", game_kirby_ThrowB)
    .game_acmd("game_throwhi", game_kirby_ThrowHi)
    .game_acmd("game_throwlw", game_kirby_ThrowLw)
    .game_acmd("game_downattackd", game_kirby_DownAttackD)
    .game_acmd("game_downattacku", game_kirby_DownAttackU)
    .game_acmd("game_cliffattack", game_kirby_CliffAttack)
    .game_acmd("game_slipattack", game_kirby_SlipAttack)
    .game_acmd("game_specialnstart", game_kirby_SpecialNStart)
    .game_acmd("game_specialnloop", game_kirby_SpecialNLoop)
    .game_acmd("game_specialnspit", game_kirby_SpecialNSpit)
    .game_acmd("game_specialairnstart", game_kirby_SpecialAirNStart)
    .game_acmd("game_specialairnloop", game_kirby_SpecialAirNLoop)
    .game_acmd("game_specialairnspit", game_kirby_SpecialAirNSpit)
    .game_acmd("game_buddyspecialairnfire", game_kirby_BuddySpecialAirNFire)
    .game_acmd("game_buddyspecialairnfire2", game_kirby_BuddySpecialAirNFire2)
    .game_acmd("game_buddyspecialairnfire3", game_kirby_BuddySpecialAirNFire3)
    .game_acmd("game_buddyspecialnsupperfire", game_kirby_BuddySpecialNUpperFire)  
    .game_acmd("game_specials", game_kirby_SpecialS)  
    .game_acmd("game_specialss", game_kirby_SpecialSS)
    .game_acmd("game_specialsmax", game_kirby_SpecialSMax)
    .game_acmd("game_specialairs", game_kirby_SpecialAirS)  
    .game_acmd("game_specialairss", game_kirby_SpecialAirSS)
    .game_acmd("game_specialairsmax", game_kirby_SpecialAirSMax)
    .game_acmd("game_specialhi2", game_kirby_SpecialHi2)
    .game_acmd("game_specialairhi2", game_kirby_SpecialAirHi2)
    .game_acmd("game_specialhih", game_kirby_SpecialHiH)
    .game_acmd("game_specialairhih", game_kirby_SpecialAirHiH)
    .game_acmd("game_speciallw", game_kirby_SpecialLw)
    .game_acmd("game_speciallwtoground", game_kirby_SpecialLwToGround)
    .game_acmd("game_speciallwtoair", game_kirby_SpecialLwToAir)
    .game_acmd("game_specialairlw", game_kirby_SpecialAirLw)
    .game_acmd("game_appealsr", game_kirby_AppealSR)
    .game_acmd("game_appealsl", game_kirby_AppealSL)
    .game_acmd("game_appealhir", game_kirby_AppealHiR)
    .game_acmd("game_appealhil", game_kirby_AppealHiL)
    .game_acmd("game_appeallwr", game_kirby_AppealLwR)
    .game_acmd("game_appeallwl", game_kirby_AppealLwL)
    .game_acmd("game_final", game_kirby_FinalAttack)
    .game_acmd("game_finalfinish", game_kirby_FinalAirAttack)
    .install();
}
