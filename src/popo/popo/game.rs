...
pub fn install() {
    Agent::new("popo")
    .game_acmd("game_attack11", game_popo_Attack11)
    .game_acmd("game_attack12", game_popo_Attack12)
    .game_acmd("game_attackdash", game_popo_AttackDash)
    .game_acmd("game_attacks3hi", game_popo_AttackS3Hi) 
    .game_acmd("game_attacks3", game_popo_AttackS3)
    .game_acmd("game_attacks3lw", game_popo_AttackS3Lw)
    .game_acmd("game_attackhi3", game_popo_AttackHi3)
    .game_acmd("game_attacklw3", game_popo_AttackLw3)
    .game_acmd("game_attacks4", game_popo_AttackS4)
    .game_acmd("game_attackhi4", game_popo_AttackHi4)
    .game_acmd("game_attacklw4", game_popo_AttackLw4)
    .game_acmd("game_attackairn", game_popo_AttackAirN)
    .game_acmd("game_attackairf", game_popo_AttackAirF)    
    .game_acmd("game_attackairb", game_popo_AttackAirB)
    .game_acmd("game_attackairhi", game_popo_AttackAirHi)
    .game_acmd("game_attackairlw", game_popo_AttackAirLw)
    .game_acmd("game_catch", game_popo_Catch)
    .game_acmd("game_catchturn", game_popo_CatchTurn)
    .game_acmd("game_catchdash", game_popo_CatchDash)
    .game_acmd("game_catchattack", game_popo_CatchAttack)
    .game_acmd("game_throwf", game_popo_ThrowF)
    .game_acmd("game_throwb", game_popo_ThrowB)
    .game_acmd("game_throwhi", game_popo_ThrowHi)
    .game_acmd("game_throwlw", game_popo_ThrowLw)
    .game_acmd("game_downattackd", game_popo_DownAttackD)
    .game_acmd("game_downattacku", game_popo_DownAttackU)
    .game_acmd("game_cliffattack", game_popo_CliffAttack)
    .game_acmd("game_slipattack", game_popo_SlipAttack)
    .game_acmd("game_specialn", game_popo_SpecialN)
    .game_acmd("game_specialairn", game_popo_SpecialAirN)
    .game_acmd("game_specials1", game_popo_SpecialS1)
    .game_acmd("game_specials2", game_popo_SpecialS2)
    .game_acmd("game_specialsattackbsub", game_popo_SpecialSAttackBSub)
    .game_acmd("game_specialsattackbothsub", game_popo_SpecialSAttackBothSub)
    .game_acmd("game_specialsattackcouplesub", game_popo_SpecialSAttackCoupleSub)
    .game_acmd("game_specialsattackfsub", game_popo_SpecialSAttackFSub)
    .game_acmd("game_specialsattacksinglebsub", game_popo_SpecialSAttackSingleBSub)
    .game_acmd("game_specialsattacksinglefsub", game_popo_SpecialSAttackSingleFSub)
    .game_acmd("game_specialscommoncouplesub", game_popo_SpecialSCommonCoupleSub)
    .game_acmd("game_specialscommonsinglesub", game_popo_SpecialSCommonSingleSub)
    .game_acmd("game_specialairs1", game_popo_SpecialAirS1)
    .game_acmd("game_specialairs2", game_popo_SpecialAirS2)
    .game_acmd("game_specialhithrownana", game_popo_SpecialHiThrowNana)
    .game_acmd("game_speciallw", game_popo_SpecialLw)
    .game_acmd("game_specialairlw", game_popo_SpecialAirLw)   
    .game_acmd("game_appealsr", game_popo_AppealSR)
    .game_acmd("game_appealsl", game_popo_AppealSL)
    .game_acmd("game_appealhir", game_popo_AppealHiR)
    .game_acmd("game_appealhil", game_popo_AppealHiL)
    .game_acmd("game_appeallwr", game_popo_AppealLwR)
    .game_acmd("game_appeallwl", game_popo_AppealLwL)
    .game_acmd("game_attack11_nana", game_popo_Attack11_Nana)
    .game_acmd("game_attack12_nana", game_popo_Attack12_Nana)
    .game_acmd("game_attackdash_nana", game_popo_AttackDash_Nana)
    .game_acmd("game_attacks3hi_nana", game_popo_AttackS3Hi_Nana) 
    .game_acmd("game_attacks3_nana", game_popo_AttackS3_Nana)
    .game_acmd("game_attacks3lw_nana", game_popo_AttackS3Lw_Nana)
    .game_acmd("game_attackhi3_nana", game_popo_AttackHi3_Nana)
    .game_acmd("game_attacklw3_nana", game_popo_AttackLw3_Nana)
    .game_acmd("game_attacks4_nana", game_popo_AttackS4_Nana)
    .game_acmd("game_attackhi4_nana", game_popo_AttackHi4_Nana)
    .game_acmd("game_attacklw4_nana", game_popo_AttackLw4_Nana)
    .game_acmd("game_attackairn_nana", game_popo_AttackAirN_Nana)
    .game_acmd("game_attackairf_nana", game_popo_AttackAirF_Nana)    
    .game_acmd("game_attackairb_nana", game_popo_AttackAirB_Nana)
    .game_acmd("game_attackairhi_nana", game_popo_AttackAirHi_Nana)
    .game_acmd("game_attackairlw_nana", game_popo_AttackAirLw_Nana)
    .game_acmd("game_downattackd_nana", game_popo_DownAttackD_Nana)
    .game_acmd("game_downattacku_nana", game_popo_DownAttackU_Nana)
    .game_acmd("game_cliffattack_nana", game_popo_CliffAttack_Nana)
    .game_acmd("game_slipattack_nana", game_popo_SlipAttack_Nana)
    .game_acmd("game_specialn_nana", game_popo_SpecialN_Nana)
    .game_acmd("game_specialairn_nana", game_popo_SpecialAirN_Nana)
    .game_acmd("game_specials1_nana", game_popo_SpecialS1_Nana)
    .game_acmd("game_specialsattackbsub_nana", game_popo_SpecialSAttackBSub_Nana)
    .game_acmd("game_specialsattackfsub_nana", game_popo_SpecialSAttackFSub_Nana)
    .game_acmd("game_specialsattacksinglebsub_nana", game_popo_SpecialSAttackSingleBSub_Nana)
    .game_acmd("game_specialsattacksinglefsub_nana", game_popo_SpecialSAttackSingleFSub_Nana)
    .game_acmd("game_specialscommonsinglesub_nana", game_popo_SpecialSCommonSingleSub_Nana)
    .game_acmd("game_specialairs1_nana", game_popo_SpecialAirS1_Nana)
    .game_acmd("game_specialhithrownana_nana", game_popo_SpecialHiThrowNana_Nana)
    .game_acmd("game_speciallw_nana", game_popo_SpecialLw_Nana)
    .game_acmd("game_specialairlw_nana", game_popo_SpecialAirLw_Nana)
    .install();
}
