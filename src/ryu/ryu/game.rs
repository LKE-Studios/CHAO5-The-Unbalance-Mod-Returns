...
pub fn install() {
    Agent::new("ryu")
    .game_acmd("game_attack11w", game_ryu_Attack11W, Low)
    .game_acmd("game_attack11s", game_ryu_Attack11S, Low)
    .game_acmd("game_attack11nears", game_ryu_Attack11NearS, Low)
    .game_acmd("game_attack12", game_ryu_Attack12, Low)
    .game_acmd("game_attack13", game_ryu_Attack13, Low)
    .game_acmd("game_attackdash", game_ryu_AttackDash, Low)
    .game_acmd("game_attacks3s", game_ryu_AttackS3S, Low)
    .game_acmd("game_attacks3w", game_ryu_AttackS3W, Low)
    .game_acmd("game_attacknearw", game_ryu_AttackNearW, Low)
    .game_acmd("game_attackhi3w", game_ryu_AttackHi3W, Low)
    .game_acmd("game_attackhi3s", game_ryu_AttackHi3S, Low)
    .game_acmd("game_attacklw3w", game_ryu_AttackLw3W, Low)
    .game_acmd("game_attacklw3s", game_ryu_AttackLw3S, Low)
    .game_acmd("game_attacks4", game_ryu_AttackS4, Low)
    .game_acmd("game_attackhi4", game_ryu_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_ryu_AttackLw4, Low)
    .game_acmd("game_attackairn", game_ryu_AttackAirN, Low)
    .game_acmd("game_attackairf", game_ryu_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_ryu_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_ryu_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_ryu_AttackAirLw, Low)
    .game_acmd("game_catch", game_ryu_Catch, Low)
    .game_acmd("game_catchdash", game_ryu_CatchDash, Low)
    .game_acmd("game_catchturn", game_ryu_CatchTurn, Low)
    .game_acmd("game_catchattack", game_ryu_CatchAttack, Low)
    .game_acmd("game_throwf", game_ryu_ThrowF, Low)
    .game_acmd("game_throwb", game_ryu_ThrowB, Low)
    .game_acmd("game_throwhi", game_ryu_ThrowHi, Low)
    .game_acmd("game_throwlw", game_ryu_ThrowLw, Low)
    .game_acmd("game_downattackd", game_ryu_DownAttackD, Low)
    ...
    .game_acmd("game_specialairs", game_ryu_SpecialAirS, Low)
    .game_acmd("game_specialhi", game_ryu_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_ryu_SpecialAirHi, Low)
    .game_acmd("game_specialhicommand", game_ryu_SpecialHiCommand, Low)
    .game_acmd("game_specialairhicommand", game_ryu_SpecialAirHiCommand, Low)
    .game_acmd("game_speciallw", game_ryu_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_ryu_SpecialAirLw, Low)
    .game_acmd("game_speciallwturn", game_ryu_SpecialLwTurn, Low)
    .game_acmd("game_specialairlwturn", game_ryu_SpecialAirLwTurn, Low)
    .game_acmd("game_appealsr", game_ryu_AppealSR, Low)
    .game_acmd("game_appealsl", game_ryu_AppealSL, Low)
    .game_acmd("game_appealhir", game_ryu_AppealHiR, Low)
    .game_acmd("game_appealhil", game_ryu_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_ryu_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_ryu_AppealLwL, Low)
    .game_acmd("game_finalhit", game_ryu_FinalHit, Low)
    .game_acmd("game_finalairhit", game_ryu_FinalAirHit, Low)
    .install();
}
