...
//DamageFlyHi
unsafe extern "C" fn sound_pit_DamageFlyHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
...
//DamageFlyLw
unsafe extern "C" fn sound_pit_DamageFlyLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        PLAY_FLY_VOICE(fighter, Hash40::new("seq_pit_rnd_futtobi01"), Hash40::new("seq_pit_rnd_futtobi02"));
    }
...
//DamageFlyN
unsafe extern "C" fn sound_pit_DamageFlyN(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        PLAY_FLY_VOICE(fighter, Hash40::new("seq_pit_rnd_futtobi01"), Hash40::new("seq_pit_rnd_futtobi02"));
    }
...
//DamageFlyTop
unsafe extern "C" fn sound_pit_DamageFlyTop(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        PLAY_FLY_VOICE(fighter, Hash40::new("seq_pit_rnd_futtobi01"), Hash40::new("seq_pit_rnd_futtobi02"));
    }
...
//DamageFlyRoll
unsafe extern "C" fn sound_pit_DamageFlyRoll(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        PLAY_FLY_VOICE(fighter, Hash40::new("seq_pit_rnd_futtobi01"), Hash40::new("seq_pit_rnd_futtobi02"));
    }
...
pub fn install() {
    ...
    .sound_acmd("sound_damageflyhi", sound_pit_DamageFlyHi, Low)
    .sound_acmd("sound_damageflylw", sound_pit_DamageFlyLw, Low)
    .sound_acmd("sound_damageflyn", sound_pit_DamageFlyN, Low)
    .sound_acmd("sound_damageflytop", sound_pit_DamageFlyTop, Low)
    .sound_acmd("sound_damageflyroll", sound_pit_DamageFlyRoll, Low)
    .install();
}