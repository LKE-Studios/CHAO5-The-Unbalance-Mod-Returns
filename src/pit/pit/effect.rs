...
pub fn install() {
    Agent::new("pit")
    .effect_acmd("effect_jumpaerialf4", effect_pit_JumpAerialF4, Low)
    .effect_acmd("effect_jumpaerialf5", effect_pit_JumpAerialF5, Low)
    .effect_acmd("effect_jumpaerialf6", effect_pit_JumpAerialF6, Low)
    .effect_acmd("effect_jumpaerialf4", effect_pit_JumpAerialF7, Low)
    .effect_acmd("effect_glidestart", effect_pit_GlideStart, Low)
    .effect_acmd("effect_glidewing", effect_pit_GlideWing, Low)
    .effect_acmd("effect_glideattack", effect_pit_GlideAttack, Low)
    .effect_acmd("effect_glidelanding", effect_pit_GlideLanding, Low)
    .effect_acmd("effect_specialhistart", effect_pit_SpecialHiStart, Low)
    .effect_acmd("effect_specialhifly", effect_pit_SpecialHiFly, Low)
    .effect_acmd("effect_specialhiflyturn", effect_pit_SpecialHiFlyTurn, Low)
    .effect_acmd("effect_specialhiend", effect_pit_SpecialHiEnd, Low)
    .effect_acmd("effect_specialairhistart", effect_pit_SpecialAirHiStart, Low)
    .install();
}