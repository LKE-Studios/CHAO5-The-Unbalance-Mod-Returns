...
pub fn install() {
    Agent::new("pit")
    .game_acmd("game_jumpaerialf4", game_pit_JumpAerialF4, Low)
    .game_acmd("game_jumpaerialf5", game_pit_JumpAerialF5, Low)
    .game_acmd("game_jumpaerialf6", game_pit_JumpAerialF6, Low)
    .game_acmd("game_jumpaerialf7", game_pit_JumpAerialF7, Low)
    .game_acmd("game_glidestart", game_pit_GlideStart, Low)
    .game_acmd("game_glidewing", game_pit_GlideWing, Low)
    .game_acmd("game_glidedirection", game_pit_GlideDirection, Low)
    .game_acmd("game_glideattack", game_pit_GlideAttack, Low)
    .game_acmd("game_attack11", game_pit_Attack11, Low)
    .game_acmd("game_attack12", game_pit_Attack12, Low)
    .game_acmd("game_attack13", game_pit_Attack13, Low)
    .game_acmd("game_attack100", game_pit_Attack100, Low)
    .game_acmd("game_attack100sub", game_pit_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_pit_Attack100End, Low)
    .game_acmd("game_attackdash", game_pit_AttackDash, Low)
    .game_acmd("game_attacks3", game_pit_AttackS3, Low)
    .game_acmd("game_attackhi3", game_pit_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_pit_AttackLw3, Low)
    .game_acmd("game_attacks4", game_pit_AttackS4, Low)
    .game_acmd("game_attackhi4", game_pit_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_pit_AttackLw4, Low)
    .game_acmd("game_attackairn", game_pit_AttackAirN, Low)
    .game_acmd("game_attackairf", game_pit_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_pit_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_pit_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_pit_AttackAirLw, Low)
    .game_acmd("game_catch", game_pit_Catch, Low)
    .game_acmd("game_catchdash", game_pit_CatchDash, Low)
    .game_acmd("game_catchturn", game_pit_CatchTurn, Low)
    .game_acmd("game_catchattack", game_pit_CatchAttack, Low)
    .game_acmd("game_throwf", game_pit_ThrowF, Low)
    .game_acmd("game_throwb", game_pit_ThrowB, Low)
    .game_acmd("game_throwhi", game_pit_ThrowHi, Low)
    .game_acmd("game_throwlw", game_pit_ThrowLw, Low)
    .game_acmd("game_downattackd", game_pit_DownAttackD, Low)
    .game_acmd("game_downattacku", game_pit_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_pit_CliffAttack, Low)
    .game_acmd("game_slipattack", game_pit_SlipAttack, Low)
    .game_acmd("game_specialsstart", game_pit_SpecialSStart, Low)  
    .game_acmd("game_specialsend", game_pit_SpecialSEnd, Low)
    .game_acmd("game_specialairsstart", game_pit_SpecialAirSStart, Low)  
    .game_acmd("game_specialairsend", game_pit_SpecialAirSEnd, Low)
    ...
    .game_acmd("game_appealsr", game_pit_AppealSR, Low)
    .game_acmd("game_appealsl", game_pit_AppealSL, Low)
    .game_acmd("game_appealhir", game_pit_AppealHiR, Low)
    .game_acmd("game_appealhil", game_pit_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_pit_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_pit_AppealLwL, Low)
    .game_acmd("game_finalride", game_pit_FinalRide, Low)
    .install();
}