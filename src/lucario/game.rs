...
#[acmd_script(//Shoot
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn lucario_ball3(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//SpecialS
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn lucario_sideb(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
    ...
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        macros::CATCH(fighter, /*ID*/ 0, /*Bone*/ Hash40::new("top"), /*Size*/ 7.0, /*X*/ 0.0, /*Y*/ 6.0, /*Z*/ 8.0, /*X2*/ Some(0.0), /*Y2*/ Some(6.0), /*Z2*/ Some(1.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA);
        macros::CATCH(fighter, /*ID*/ 1, /*Bone*/ Hash40::new("top"), /*Size*/ 7.5, /*X*/ 0.0, /*Y*/ 6.0, /*Z*/ 10.5, /*X2*/ Some(0.0), /*Y2*/ Some(6.0), /*Z2*/ Some(1.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_G);
    }
    wait(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
        grab!(fighter, MA_MSC_CMD_GRAB_CLEAR_ALL);
...
#[acmd_script(//SpecialAirS
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn lucario_sidebair(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
