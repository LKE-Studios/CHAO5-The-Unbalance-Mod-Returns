...
pub fn install() {
    Agent::new("lucario")
    .game_acmd("game_attack11", game_lucario_Attack11)
    .game_acmd("game_attack12", game_lucario_Attack12)
    .game_acmd("game_attack12", game_lucario_Attack13)
    .game_acmd("game_attackdash", game_lucario_AttackDash)
    .game_acmd("game_attacks3hi", game_lucario_AttackS3Hi)
    .game_acmd("game_attacks3", game_lucario_AttackS3)
    .game_acmd("game_attacks3lw", game_lucario_AttackS3Lw)
    .game_acmd("game_attackhi3", game_lucario_AttackHi3)
    .game_acmd("game_attacklw3", game_lucario_AttackLw3)
    .game_acmd("game_attacks4", game_lucario_AttackS4)
    .game_acmd("game_attackhi4", game_lucario_AttackHi4)
    .game_acmd("game_attacklw4", game_lucario_AttackLw4)
    .game_acmd("game_attackairn", game_lucario_AttackAirN)
    .game_acmd("game_attackairf", game_lucario_AttackAirF)    
    .game_acmd("game_attackairb", game_lucario_AttackAirB)
    .game_acmd("game_attackairhi", game_lucario_AttackAirHi)
    .game_acmd("game_attackairlw", game_lucario_AttackAirLw)
    .game_acmd("game_catch", game_lucario_Catch)
    .game_acmd("game_catchdash", game_lucario_CatchDash)
    .game_acmd("game_catchturn", game_lucario_CatchTurn)
    .game_acmd("game_catchattack", game_lucario_CatchAttack)
    .game_acmd("game_throwf", game_lucario_ThrowF)
    .game_acmd("game_throwb", game_lucario_ThrowB)
    .game_acmd("game_throwhi", game_lucario_ThrowHi)
    .game_acmd("game_throwlw", game_lucario_ThrowLw)
    .game_acmd("game_downattackd", game_lucario_DownAttackD)
    .game_acmd("game_downattacku", game_lucario_DownAttackU)
    .game_acmd("game_cliffattack", game_lucario_CliffAttack)
    .game_acmd("game_slipattack", game_lucario_SlipAttack)
    .game_acmd("game_specials", game_lucario_SpecialS)
    .game_acmd("game_specialairsblow", game_lucario_SpecialAirS)
    .game_acmd("game_specialsthrow", game_lucario_SpecialSThrow)
    .game_acmd("game_specialhi", game_lucario_SpecialHi)
    .game_acmd("game_specialhimove", game_lucario_SpecialHiMove)
    .game_acmd("game_specialhibound", game_lucario_SpecialHiBound)
    .game_acmd("game_specialhiend", game_lucario_SpecialHiEnd)
    .game_acmd("game_specialairhi", game_lucario_SpecialAirHi)
    .game_acmd("game_specialairhiend", game_lucario_SpecialAirHiEnd)
    .game_acmd("game_speciallw", game_lucario_SpecialLw)
    .game_acmd("game_specialairlw", game_lucario_SpecialAirLw)
    .game_acmd("game_specialairappear", game_lucario_SpecialAirAppear)
    .game_acmd("game_appealsr", game_lucario_AppealSR)
    .game_acmd("game_appealsl", game_lucario_AppealSL)
    .game_acmd("game_appealhir", game_lucario_AppealHiR)
    .game_acmd("game_appealhil", game_lucario_AppealHiL)
    .game_acmd("game_appeallwr", game_lucario_AppealLwR)
    .game_acmd("game_appeallwl", game_lucario_AppealLwL)
    .install();
}
