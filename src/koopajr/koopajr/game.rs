...
pub fn install() {
    Agent::new("koopajr")
    .game_acmd("game_attack11", game_koopajr_Attack11)
    .game_acmd("game_attack12", game_koopajr_Attack12)
    .game_acmd("game_attack100", game_koopajr_Attack100)
    .game_acmd("game_attack100subl", game_koopajr_Attack100SubL)
    .game_acmd("game_attack100subr", game_koopajr_Attack100SubR)
    .game_acmd("game_attack100end", game_koopajr_Attack100End)
    .game_acmd("game_attackdash", game_koopajr_AttackDash)
    .game_acmd("game_attacks3hi", game_koopajr_AttackS3Hi)
    .game_acmd("game_attacks3", game_koopajr_AttackS3)
    .game_acmd("game_attacks3lw", game_koopajr_AttackS3Lw)
    .game_acmd("game_attackhi3", game_koopajr_AttackHi3)
    .game_acmd("game_attacklw3", game_koopajr_AttackLw3)
    .game_acmd("game_attacks4hi", game_koopajr_AttackS4Hi)
    .game_acmd("game_attacks4", game_koopajr_AttackS4)
    .game_acmd("game_attacks4lw", game_koopajr_AttackS4Lw)
    .game_acmd("game_attackhi4", game_koopajr_AttackHi4)
    .game_acmd("game_attacklw4", game_koopajr_AttackLw4)
    .game_acmd("game_attackairn", game_koopajr_AttackAirN)
    .game_acmd("game_attackairf", game_koopajr_AttackAirF)    
    .game_acmd("game_attackairb", game_koopajr_AttackAirB)
    .game_acmd("game_attackairhi", game_koopajr_AttackAirHi)
    .game_acmd("game_attackairlw", game_koopajr_AttackAirLw)
    .game_acmd("game_landingairf", game_koopajr_LandingAirF)
    .game_acmd("game_landingairlw", game_koopajr_LandingAirLw)
    .game_acmd("game_catch", game_koopajr_Catch)
    .game_acmd("game_catchdash", game_koopajr_CatchDash)
    .game_acmd("game_catchturn", game_koopajr_CatchTurn)
    .game_acmd("game_catchattack", game_koopajr_CatchAttack)
    .game_acmd("game_throwf", game_koopajr_ThrowF)
    .game_acmd("game_throwb", game_koopajr_ThrowB)
    .game_acmd("game_throwhi", game_koopajr_ThrowHi)
    .game_acmd("game_throwlw", game_koopajr_ThrowLw)
    .game_acmd("game_downattackd", game_koopajr_DownAttackD)
    .game_acmd("game_downattacku", game_koopajr_DownAttackU)
    .game_acmd("game_cliffattack", game_koopajr_CliffAttack)
    .game_acmd("game_cliffattackjr", game_koopajr_CliffAttackJr)
    .game_acmd("game_slipattack", game_koopajr_SlipAttack)
    .game_acmd("game_specials", game_koopajr_SpecialS)
    .game_acmd("game_specialsspin", game_koopajr_SpecialSSpin)
    .game_acmd("game_specialairs", game_koopajr_SpecialAirS)
    .game_acmd("game_specialairsspin", game_koopajr_SpecialAirSSpin)
    .game_acmd("game_specialslanding", game_koopajr_SpecialSLanding)
    .game_acmd("game_specialhijrattack", game_koopajr_SpecialHiJrAttack)
    .game_acmd("game_speciallw", game_koopajr_SpecialLw)
    .game_acmd("game_specialairlw", game_koopajr_SpecialAirLw)
    .game_acmd("game_appealsr", game_koopajr_AppealSR)
    .game_acmd("game_appealsl", game_koopajr_AppealSL)
    .game_acmd("game_appealhir", game_koopajr_AppealHiR)
    .game_acmd("game_appealhil", game_koopajr_AppealHiL)
    .game_acmd("game_appeallwr", game_koopajr_AppealLwR)
    .game_acmd("game_appeallwl", game_koopajr_AppealLwL)
    .install();
}
