...
pub fn install() {
    Agent::new("palutena")
    .game_acmd("game_shieldbreakfly", game_palutena_ShieldBreakFly)
    .game_acmd("game_glidedirection", game_palutena_GlideDirection)
    .game_acmd("game_glideattack", game_palutena_GlideAttack)
    .game_acmd("game_glidelanding", game_palutena_GlideLanding)    
    .game_acmd("game_glideend", game_palutena_GlideEnd)
    .game_acmd("game_attack11", game_palutena_Attack11)
    .game_acmd("game_attack100", game_palutena_Attack100)
    .game_acmd("game_attack100sub", game_palutena_Attack100Sub)
    .game_acmd("game_attack100end", game_palutena_Attack100End)
    .game_acmd("game_attackdash", game_palutena_AttackDash)
    .game_acmd("game_attacks3", game_palutena_AttackS3)
    .game_acmd("game_attackhi3", game_palutena_AttackHi3)
    .game_acmd("game_attacklw3", game_palutena_AttackLw3)
    .game_acmd("game_attacks4", game_palutena_AttackS4)
    .game_acmd("game_attackhi4charge", game_palutena_AttackHi4Charge)
    .game_acmd("game_attackhi4", game_palutena_AttackHi4)
    .game_acmd("game_attacklw4", game_palutena_AttackLw4)
    .game_acmd("game_attackairn", game_palutena_AttackAirN)
    .game_acmd("game_attackairf", game_palutena_AttackAirF)    
    .game_acmd("game_attackairb", game_palutena_AttackAirB)
    .game_acmd("game_attackairhi", game_palutena_AttackAirHi)
    .game_acmd("game_attackairlw", game_palutena_AttackAirLw)
    .game_acmd("game_catch", game_palutena_Catch)
    .game_acmd("game_catchdash", game_palutena_CatchDash)
    .game_acmd("game_catchturn", game_palutena_CatchTurn)
    .game_acmd("game_catchattack", game_palutena_CatchAttack)
    .game_acmd("game_throwf", game_palutena_ThrowF)
    .game_acmd("game_throwb", game_palutena_ThrowB)
    .game_acmd("game_throwhi", game_palutena_ThrowHi)
    .game_acmd("game_throwlw", game_palutena_ThrowLw)
    .game_acmd("game_downattackd", game_palutena_DownAttackD)
    .game_acmd("game_downattacku", game_palutena_DownAttackU)
    .game_acmd("game_cliffattack", game_palutena_CliffAttack)
    .game_acmd("game_slipattack", game_palutena_SlipAttack)
    .game_acmd("game_specialhistart", game_palutena_SpecialHiStart)
    .game_acmd("game_specialairhistart", game_palutena_SpecialAirHiStart)
    .game_acmd("game_speciallw", game_palutena_SpecialLw)
    .game_acmd("game_speciallwattack", game_palutena_SpecialLwAttack)
    .game_acmd("game_specialairlw", game_palutena_SpecialAirLw)
    .game_acmd("game_specialairlwattack", game_palutena_SpecialAirLwAttack)
    .game_acmd("game_appealsr", game_palutena_AppealSR)
    .game_acmd("game_appealsl", game_palutena_AppealSL)
    .game_acmd("game_appealhir", game_palutena_AppealHiR)
    .game_acmd("game_appealhil", game_palutena_AppealHiL)
    .game_acmd("game_appeallwr", game_palutena_AppealLwR)
    .game_acmd("game_appeallwl", game_palutena_AppealLwL)
    .install();
}
