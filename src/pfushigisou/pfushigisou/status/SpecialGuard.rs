...
unsafe extern "C" fn pfushigisou_SpecialGuard_Main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let charge_frame = WorkModule::get_param_float(fighter.module_accessor, hash40("param_special_guard"), hash40("charge_frame"));
    WorkModule::add_float(fighter.module_accessor, 1.0, *FIGHTER_INSTANCE_WORK_ID_FLOAT_CHARGE_FRAME);
