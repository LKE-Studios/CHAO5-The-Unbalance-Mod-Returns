...
pub fn install() {
    ...
    .game_acmd("game_attack11", game_pfushigisou_Attack11)
    .game_acmd("game_attack12", game_pfushigisou_Attack12)
    .game_acmd("game_attack100", game_pfushigisou_Attack100)
    .game_acmd("game_attack100subl", game_pfushigisou_Attack100SubL)
    .game_acmd("game_attack100end", game_pfushigisou_Attack100End)
    .game_acmd("game_attackdash", game_pfushigisou_AttackDash)
    .game_acmd("game_attacks3", game_pfushigisou_AttackS3)
    .game_acmd("game_attackhi3", game_pfushigisou_AttackHi3)
    .game_acmd("game_attacklw3", game_pfushigisou_AttackLw3)
    .game_acmd("game_attacks4hi", game_pfushigisou_AttackS4Hi)
    .game_acmd("game_attacks4", game_pfushigisou_AttackS4)
    .game_acmd("game_attacks4lw", game_pfushigisou_AttackS4Lw)
    .game_acmd("game_attackhi4", game_pfushigisou_AttackHi4)
    .game_acmd("game_attacklw4", game_pfushigisou_AttackLw4)
    .game_acmd("game_attackairn", game_pfushigisou_AttackAirN)
    .game_acmd("game_attackairf", game_pfushigisou_AttackAirF)    
    .game_acmd("game_attackairb", game_pfushigisou_AttackAirB)
    .game_acmd("game_attackairhi", game_pfushigisou_AttackAirHi)
    .game_acmd("game_attackairlw", game_pfushigisou_AttackAirLw)
    .game_acmd("game_catch", game_pfushigisou_Catch)
    .game_acmd("game_catchdash", game_pfushigisou_CatchDash)
    .game_acmd("game_catchturn", game_pfushigisou_CatchTurn)
    .game_acmd("game_catchattack", game_pfushigisou_CatchAttack)
    .game_acmd("game_throwf", game_pfushigisou_ThrowF)
    .game_acmd("game_throwb", game_pfushigisou_ThrowB)
    .game_acmd("game_throwhi", game_pfushigisou_ThrowHi)
    .game_acmd("game_throwlw", game_pfushigisou_ThrowLw)
    .game_acmd("game_downattackd", game_pfushigisou_DownAttackD)
    .game_acmd("game_downattacku", game_pfushigisou_DownAttackU)
    .game_acmd("game_cliffattack", game_pfushigisou_CliffAttack)
    .game_acmd("game_slipattack", game_pfushigisou_SlipAttack)
    .game_acmd("game_specialnstart", game_pfushigisou_SpecialNStart)
    .game_acmd("game_specialn", game_pfushigisou_SpecialN)
    .game_acmd("game_specialairnstart", game_pfushigisou_SpecialAirNStart)
    .game_acmd("game_specials", game_pfushigisou_SpecialS)
    .game_acmd("game_specialairs", game_pfushigisou_SpecialAirS)
    .game_acmd("game_specialhi", game_pfushigisou_SpecialHi)
    .game_acmd("game_specialairhi", game_pfushigisou_SpecialAirHi)
    .game_acmd("game_specialzcharge", game_pfushigisou_SpecialZCharge)
    .game_acmd("game_specialzshoot", game_pfushigisou_SpecialZShoot)
    .game_acmd("game_specialairzcharge", game_pfushigisou_SpecialAirZCharge)
    .game_acmd("game_specialairzshoot", game_pfushigisou_SpecialAirZShoot)
    .game_acmd("game_appealsr", game_pfushigisou_AppealSR)
    .game_acmd("game_appealsl", game_pfushigisou_AppealSL)
    .game_acmd("game_appealhir", game_pfushigisou_AppealHiR)
    .game_acmd("game_appealhil", game_pfushigisou_AppealHiL)
    .game_acmd("game_appeallwr", game_pfushigisou_AppealLwR)
    .game_acmd("game_appeallwl", game_pfushigisou_AppealLwL)
    .game_acmd("game_final", game_pfushigisou_Final)
    .game_acmd("game_finalair", game_pfushigisou_FinalAir)
    .install();
}
