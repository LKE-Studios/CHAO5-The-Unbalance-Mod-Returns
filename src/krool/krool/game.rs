...
pub fn install() {
    Agent::new("krool")
    .game_acmd("game_attack11", game_krool_Attack11, Low)
    .game_acmd("game_attack12", game_krool_Attack12, Low)
    .game_acmd("game_attack13", game_krool_Attack13, Low)
    .game_acmd("game_attackdash", game_krool_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_krool_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_krool_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_krool_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_krool_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_krool_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_krool_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_krool_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_krool_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_krool_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_krool_AttackLw4, Low)
    .game_acmd("game_attackairn", game_krool_AttackAirN, Low)
    .game_acmd("game_attackairf", game_krool_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_krool_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_krool_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_krool_AttackAirLw, Low)
    .game_acmd("game_catch", game_krool_Catch, Low)
    .game_acmd("game_catchdash", game_krool_CatchDash, Low)
    .game_acmd("game_catchturn", game_krool_CatchTurn, Low)
    .game_acmd("game_catchattack", game_krool_CatchAttack, Low)
    .game_acmd("game_throwf", game_krool_ThrowF, Low)
    .game_acmd("game_throwb", game_krool_ThrowB, Low)
    .game_acmd("game_throwhi", game_krool_ThrowHi, Low)
    .game_acmd("game_throwlw", game_krool_ThrowLw, Low)
    .game_acmd("game_downattackd", game_krool_DownAttackD, Low)
    .game_acmd("game_downattacku", game_krool_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_krool_CliffAttack, Low)
    .game_acmd("game_slipattack", game_krool_SlipAttack, Low)    
    .game_acmd("game_specialnfire", game_krool_SpecialNFire, Low)
    .game_acmd("game_specialnloop", game_krool_SpecialNLoop, Low)
    .game_acmd("game_specialnspitb", game_krool_SpecialNSpitB, Low)
    .game_acmd("game_specialnspitbattackabs", game_krool_SpecialNSpitBAttackAbs, Low)
    .game_acmd("game_specialnspitf", game_krool_SpecialNSpitF, Low)
    .game_acmd("game_specialnspithi", game_krool_SpecialNSpitHi, Low)
    .game_acmd("game_specialairnfire", game_krool_SpecialAirNFire, Low)
    .game_acmd("game_specialairnloop", game_krool_SpecialAirNLoop, Low)
    .game_acmd("game_specialairnspitb", game_krool_SpecialAirNSpitB, Low)
    .game_acmd("game_specialairnspitf", game_krool_SpecialAirNSpitF, Low)
    .game_acmd("game_specialairnspithi", game_krool_SpecialAirNSpitHi, Low)
    .game_acmd("game_specialsthrow", game_krool_SpecialSThrow, Low)
    .game_acmd("game_specialairsthrow", game_krool_SpecialAirSThrow, Low)
    .game_acmd("game_specialhi", game_krool_SpecialHi, Low)
    .game_acmd("game_speciallwhit", game_krool_SpecialLwHit, Low)
    .game_acmd("game_specialairlwhit", game_krool_SpecialAirLwHit, Low)
    .game_acmd("game_appealsr", game_krool_AppealSR, Low)
    .game_acmd("game_appealsl", game_krool_AppealSL, Low)
    .game_acmd("game_appealhir", game_krool_AppealHiR, Low)
    .game_acmd("game_appealhil", game_krool_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_krool_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_krool_AppealLwL, Low)
    .game_acmd("game_finalend", game_krool_FinalEnd, Low)
    .game_acmd("game_finalend_com", game_krool_FinalEnd_Com, Low)
    .game_acmd("game_finalairend", game_krool_FinalAirEnd, Low)
    .install();
}
