...
pub fn install() {
    ...
    .game_acmd("game_attackshort", game_tantan_punch2_AttackShort, Low)   
    .game_acmd("game_attacklong", game_tantan_punch2_AttackLong, Low)  
    .game_acmd("game_attacklonghold", game_tantan_punch2_AttackLongHold, Low)   
    .install();
}