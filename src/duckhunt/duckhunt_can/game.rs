...
//Fly
unsafe extern "C" fn game_duckhunt_can_Fly(fighter: &mut L2CAgentBase) {
...
//Max
unsafe extern "C" fn game_duckhunt_can_Max(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//Explode
unsafe extern "C" fn game_duckhunt_can_Explode(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
