...
pub fn install() {
    Agent::new("duckhunt")
    .game_acmd("game_attack11", game_duckhunt_Attack11, Low)
    .game_acmd("game_attack12", game_duckhunt_Attack12, Low)
    .game_acmd("game_attack13", game_duckhunt_Attack13, Low)
    .game_acmd("game_attack100", game_duckhunt_Attack100, Low)
    .game_acmd("game_attack100sub", game_duckhunt_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_duckhunt_Attack100End, Low)
    .game_acmd("game_attackdash", game_duckhunt_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_duckhunt_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_duckhunt_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_duckhunt_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_duckhunt_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_duckhunt_AttackLw3, Low)
    .game_acmd("game_attacks4", game_duckhunt_AttackS4, Low)
    .game_acmd("game_attackhi4", game_duckhunt_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_duckhunt_AttackLw4, Low)
    .game_acmd("game_attackairn", game_duckhunt_AttackAirN, Low)
    .game_acmd("game_attackairf", game_duckhunt_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_duckhunt_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_duckhunt_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_duckhunt_AttackAirLw, Low)
    .game_acmd("game_catch", game_duckhunt_Catch, Low)
    .game_acmd("game_catchdash", game_duckhunt_CatchDash, Low)
    .game_acmd("game_catchturn", game_duckhunt_CatchTurn, Low)
    .game_acmd("game_catchattack", game_duckhunt_CatchAttack, Low)
    .game_acmd("game_throwf", game_duckhunt_ThrowF, Low)
    .game_acmd("game_throwb", game_duckhunt_ThrowB, Low)
    .game_acmd("game_throwhi", game_duckhunt_ThrowHi, Low)
    .game_acmd("game_throwlw", game_duckhunt_ThrowLw, Low)
    .game_acmd("game_downattackd", game_duckhunt_DownAttackD, Low)
    .game_acmd("game_downattacku", game_duckhunt_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_duckhunt_CliffAttack, Low)
    .game_acmd("game_slipattack", game_duckhunt_SlipAttack, Low)
    .game_acmd("game_specialhi", game_duckhunt_SpecialHi, Low)
    .game_acmd("game_speciallw", game_duckhunt_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_duckhunt_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_duckhunt_AppealSR, Low)
    .game_acmd("game_appealsl", game_duckhunt_AppealSL, Low)
    .game_acmd("game_appealhir", game_duckhunt_AppealHiR, Low)
    .game_acmd("game_appealhil", game_duckhunt_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_duckhunt_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_duckhunt_AppealLwL, Low)
    .game_acmd("game_finalend", game_duckhunt_FinalEnd, Low)
    .game_acmd("game_finalend_com", game_duckhunt_FinalEnd_Com, Low)
    .game_acmd("game_finalairend", game_duckhunt_FinalAirEnd, Low)
    .install();
}