...
#[acmd_script(//Attack11
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack11(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//Attack12
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack12(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
...
#[acmd_script(//Attack13
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack13(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//Attack100
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack100(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        if is_excute(fighter) {
...
#[acmd_script(//Attack100Sub
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack100sub(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 4.5, 0.5);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.6, /*Angle*/ 361, /*KBG*/ 15, /*FKB*/ 0, /*BKB*/ 16, /*Size*/ 6.5, /*X*/ 0.0, /*Y*/ 7.5, /*Z*/ 4.5, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.3, /*SDI*/ 0.4, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_HEAD);
        ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.6, /*Angle*/ 361, /*KBG*/ 10, /*FKB*/ 0, /*BKB*/ 12, /*Size*/ 8.5, /*X*/ 0.0, /*Y*/ 7.5, /*Z*/ 14.0, /*X2*/ Some(0.0), /*Y2*/ Some(7.5), /*Z2*/ Some(6.5), /*Hitlag*/ 0.3, /*SDI*/ 0.4, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_HEAD);
...
#[acmd_script(//Attack100End
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attack100end(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackDash
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackdash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackS3Hi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacks3hi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackS3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacks3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackS3Lw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacks3lw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackHi3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackhi3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackLw3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacklw3(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackS4
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacks4(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
#[acmd_script(//AttackHi4
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackhi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script(//AttackLw4
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attacklw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script(//AttackAirN
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackairn(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackAirF 
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackairf(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
#[acmd_script(//AttackAirB
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackairb(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
#[acmd_script(//AttackAirHi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackairhi(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
#[acmd_script(//AttackAirLw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_attackairlw(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
#[acmd_script(//Catch
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
#[acmd_script(//CatchDash
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_catchdash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
#[acmd_script(//CatchTurn
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_catchturn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
#[acmd_script(//CatchAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_catchattack(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
#[acmd_script(//ThrowF
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_throwf(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//ThrowB
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_throwb(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//ThrowHi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_throwhi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//ThrowLw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_throwlw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//CliffAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_cliffattack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 18.0);
    if is_excute(fighter) {
...
#[acmd_script(//SlipAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_slipattack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 18.0);
    if is_excute(fighter) {
...
#[acmd_script(//DownAttackD
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_downattackd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 16.0);
    if is_excute(fighter) {
...
#[acmd_script(//DownAttackU
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_downattacku(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 16.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ -15.2, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(-4.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_HEAD);
    }
...
#[acmd_script(//Fly
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_clay_fly(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//Hit
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_clay_hit(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//ReflectHit
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_clay_reflecthit(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 0.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 4.5, /*Angle*/ 60, /*KBG*/ 100, /*FKB*/ 20, /*BKB*/ 0, /*Size*/ 12.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.5, /*SDI*/ 0.5, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ -1.3, /*Trip*/ 0.0, /*Rehit*/ 7, /*Reflectable*/ true, /*Absorbable*/ true, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_PUNCH, /*Type*/ *ATTACK_REGION_OBJECT);
    }
...
#[acmd_script(//WallHit
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_clay_wallhit(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 0.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 4.5, /*Angle*/ 60, /*KBG*/ 100, /*FKB*/ 20, /*BKB*/ 0, /*Size*/ 12.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.5, /*SDI*/ 0.5, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ -1.3, /*Trip*/ 0.0, /*Rehit*/ 7, /*Reflectable*/ true, /*Absorbable*/ true, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_PUNCH, /*Type*/ *ATTACK_REGION_OBJECT);
    }
...
#[acmd_script(//SpecialHi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_specialhi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//SpecialLw
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_duckhunt_speciallw(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//SpecialAirLw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_specialairlw(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.75);
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        DamageModule::heal(fighter.module_accessor, -10.0, 0);
...
#[acmd_script(//Move
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_gunmanbullet_move(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//AppealHiR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appealhir(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//AppealHiL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appealhil(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_SUPERSCOPE), 0, 0, false, false);
    }
}
...
#[acmd_script(//AppealSR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appealsr(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
...
#[acmd_script(//AppealSL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appealsl(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_RAYGUN), 0, 0, false, false);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 0, /*KBG*/ 1, /*FKB*/ 0, /*BKB*/ 1, /*Size*/ 1000.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 1.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_G, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_slip"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_SLAP, /*Type*/ *ATTACK_REGION_NONE);
...
#[acmd_script(//AppealLwR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appeallwr(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//AppealLwL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_appeallwl(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_REVENGESHOOTER), 0, 0, false, false);
    }
}
...
#[acmd_script(//FinalEnd
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_finalend(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
#[acmd_script(//FinalEnd_Com
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_finalend_com(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_DUCKHUNT_FINAL, /*ID*/ 0, /*Damage*/ 100.0, /*Angle*/ 361, /*KBG*/ 50, /*FKB*/ 0, /*BKB*/ 14, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_DUCKHUNT_FINAL, /*Type*/ *ATTACK_REGION_THROW);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_DUCKHUNT_STATUS_WORK_ID_FLAG_FINAL_ABS_SET);
    }
...
#[acmd_script(//FinalAirEnd
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_duckhunt_finalairend(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_DUCKHUNT_FINAL, /*ID*/ 0, /*Damage*/ 100.0, /*Angle*/ 361, /*KBG*/ 50, /*FKB*/ 0, /*BKB*/ 14, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_fire"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_DUCKHUNT_FINAL, /*Type*/ *ATTACK_REGION_THROW);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_DUCKHUNT_STATUS_WORK_ID_FLAG_FINAL_ABS_SET);
    }
...
pub fn install() {
    smashline::install_acmd_scripts!(
        game_duckhunt_attack11,
        game_duckhunt_attack12,
        game_duckhunt_attack13,
        game_duckhunt_attack100,
        game_duckhunt_attack100sub,
        game_duckhunt_attack100end,
        game_duckhunt_attackdash,
        game_duckhunt_attacks3hi,
        game_duckhunt_attacks3,
        game_duckhunt_attacks3lw,
        game_duckhunt_attackhi3,
        game_duckhunt_attacklw3,
        game_duckhunt_attacks4,
        game_duckhunt_attackhi4,
        game_duckhunt_attacklw4,
        game_duckhunt_attackairn,
        game_duckhunt_attackairf,
        game_duckhunt_attackairb,
        game_duckhunt_attackairhi,
        game_duckhunt_attackairlw,
        game_duckhunt_catch,
        game_duckhunt_catchdash,
        game_duckhunt_catchturn,
        game_duckhunt_catchattack,
        game_duckhunt_throwf,
        game_duckhunt_throwb,
        game_duckhunt_throwhi,
        game_duckhunt_throwlw,
        game_duckhunt_downattacku,
        game_duckhunt_downattackd,
        game_duckhunt_cliffattack,
        game_duckhunt_slipattack,
        game_duckhunt_can_fly,
        game_duckhunt_can_max,
        game_duckhunt_can_explode,
        game_duckhunt_clay_fly,
        game_duckhunt_clay_hit,
        game_duckhunt_clay_reflecthit,
        game_duckhunt_clay_wallhit,
        game_duckhunt_specialhi,
        game_duckhunt_speciallw,
        game_duckhunt_specialairlw,
        game_duckhunt_gunmanbullet_move,
        game_duckhunt_appealhir,
        game_duckhunt_appealhil,
        game_duckhunt_appealsr,
        game_duckhunt_appealsl,
        game_duckhunt_appeallwr,
        game_duckhunt_appeallwl,
        game_duckhunt_finalend,
        game_duckhunt_finalend_com,
        game_duckhunt_finalairend
    );
}
