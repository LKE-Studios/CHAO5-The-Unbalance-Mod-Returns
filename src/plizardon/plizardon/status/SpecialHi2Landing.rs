...
pub unsafe extern "C" fn status_plizardon_SpecialHi2Landing_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub unsafe extern "C" fn status_plizardon_SpecialHi2Landing_Main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    fighter.sub_shift_status_main(L2CValue::Ptr(plizardon_SpecialHi2Landing_Main_loop as *const () as _))
}

unsafe extern "C" fn plizardon_SpecialHi2Landing_Main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub unsafe extern "C" fn status_plizardon_SpecialHi2Landing_End(fighter: &mut L2CFighterCommon) -> L2CValue {
    0.into()
}
