...
pub fn install() {
    Agent::new("demon")
    .game_acmd("game_attack11", game_demon_Attack11)
    .game_acmd("game_attack12", game_demon_Attack12)
    .game_acmd("game_attack13", game_demon_Attack13)
    .game_acmd("game_flashpunch", game_demon_FlashPunch)
    .game_acmd("game_attack14", game_demon_Attack14)
    .game_acmd("game_attack15", game_demon_Attack15)
    .game_acmd("game_attack16", game_demon_Attack16)
    .game_acmd("game_attack17", game_demon_Attack17)
    .game_acmd("game_attack18", game_demon_Attack18)
    .game_acmd("game_attack19", game_demon_Attack19)
    .game_acmd("game_attack110", game_demon_Attack110)
    .game_acmd("game_attack100", game_demon_Attack100)
    .game_acmd("game_attack100sub", game_demon_Attack100Sub)
    .game_acmd("game_attack100end", game_demon_Attack100End)
    .game_acmd("game_attackdash", game_demon_AttackDash)
    .game_acmd("game_attackstand1", game_demon_AttackStand1)
    .game_acmd("game_attacks3hi", game_demon_AttackS3Hi)
    .game_acmd("game_attacks3", game_demon_AttackS3)
    .game_acmd("game_attacks3lw", game_demon_AttackS3Lw)
    .game_acmd("game_attackstand21", game_demon_AttackStand21)
    .game_acmd("game_attackstand22", game_demon_AttackStand22)
    .game_acmd("game_attackstand23", game_demon_AttackStand23)
    .game_acmd("game_attackstand24", game_demon_AttackStand24)
    .game_acmd("game_attackstand31", game_demon_AttackStand31)
    .game_acmd("game_attackstand32", game_demon_AttackStand32)
    .game_acmd("game_attackstand5", game_demon_AttackStand5)
    .game_acmd("game_attackstand4", game_demon_AttackStand4)
    .game_acmd("game_attackstand6", game_demon_AttackStand6)
    .game_acmd("game_attackhi3", game_demon_AttackHi3)
    .game_acmd("game_attackhi32", game_demon_AttackHi32)
    .game_acmd("game_attacklw3", game_demon_AttackLw3)
    .game_acmd("game_attacksquat1", game_demon_AttackSquat1)
    .game_acmd("game_attacksquat2", game_demon_AttackSquat2)
    .game_acmd("game_attacksquat3", game_demon_AttackSquat3)
    .game_acmd("game_attacksquat4", game_demon_AttackSquat4)
    .game_acmd("game_attacks4transform", game_demon_AttackS4Transform)
    .game_acmd("game_attacks4", game_demon_AttackS4)
    .game_acmd("game_attackhi4transform", game_demon_AttackHi4Transform)
    .game_acmd("game_attackhi4", game_demon_AttackHi4)
    .game_acmd("game_attacklw4transform", game_demon_AttackLw4Transform)
    .game_acmd("game_attacklw4", game_demon_AttackLw4)
    .game_acmd("game_attackstep2s", game_demon_AttackStep2s)
    .game_acmd("game_attackstep2", game_demon_AttackStep2)
    .game_acmd("game_attackstep2f", game_demon_AttackStep2f)
    .game_acmd("game_attackstep2l", game_demon_AttackStep2l)
    .game_acmd("game_attackairn", game_demon_AttackAirN)
    .game_acmd("game_attackairf", game_demon_AttackAirF)    
    .game_acmd("game_attackairb", game_demon_AttackAirB)
    .game_acmd("game_attackairhi", game_demon_AttackAirHi)
    .game_acmd("game_attackairlw", game_demon_AttackAirLw)
    .game_acmd("game_landingairlw", game_demon_LandingAirLw)
    .game_acmd("game_catch", game_demon_Catch)
    .game_acmd("game_catchdash", game_demon_CatchDash)
    .game_acmd("game_catchturn", game_demon_CatchTurn)
    .game_acmd("game_catchcommand", game_demon_CatchCommand)
    .game_acmd("game_catchattack", game_demon_CatchAttack)
    .game_acmd("game_throwf", game_demon_ThrowF)
    .game_acmd("game_throwb", game_demon_ThrowB)
    .game_acmd("game_throwhi", game_demon_ThrowHi)
    .game_acmd("game_throwlw", game_demon_ThrowLw)
    .game_acmd("game_throwcommand", game_demon_ThrowCommand)
    .game_acmd("game_downattackd", game_demon_DownAttackD)
    .game_acmd("game_downattacku", game_demon_DownAttackU)
    .game_acmd("game_cliffattack", game_demon_CliffAttack)
    .game_acmd("game_slipattack", game_demon_SlipAttack)
    .game_acmd("game_specialnstart", game_demon_SpecialNStart)
    .game_acmd("game_specialairnstart", game_demon_SpecialAirNStart)
    .game_acmd("game_specialnhi", game_demon_SpecialNHi)
    .game_acmd("game_specialn", game_demon_SpecialN)
    .game_acmd("game_specialnlw", game_demon_SpecialNLw)
    .game_acmd("game_specialairnhi", game_demon_SpecialAirNHi)
    .game_acmd("game_specialairn", game_demon_SpecialAirN)
    .game_acmd("game_specialairnlw", game_demon_SpecialAirNLw)
    .game_acmd("game_specials", game_demon_SpecialS)
    .game_acmd("game_specialshit", game_demon_SpecialSHit)
    .game_acmd("game_specialairs", game_demon_SpecialAirS)
    .game_acmd("game_specialairshit", game_demon_SpecialAirSHit)
    .game_acmd("game_specialhi", game_demon_SpecialHi)
    .game_acmd("game_specialhiground", game_demon_SpecialHiGround)
    .game_acmd("game_specialhiair", game_demon_SpecialHiAir)
    .game_acmd("game_speciallw", game_demon_SpecialLw)
    .game_acmd("game_specialairlw", game_demon_SpecialAirLw)
    .game_acmd("game_speciallwground", game_demon_SpecialLwGround)
    .game_acmd("game_speciallwfall", game_demon_SpecialLwFall)
    //.game_acmd("game_attackragedrive", game_demon_AttackRageDrive)
    //.game_acmd("game_attackairragedrive", game_demon_AttackAirRageDrive)
    //.game_acmd("game_attackragedriveground", game_demon_AttackRageDriveGround)
    .game_acmd("game_attackragedrivefall", game_demon_AttackRageDriveFall)
    .game_acmd("game_appealsr", game_demon_AppealSR)
    .game_acmd("game_appealsl", game_demon_AppealSL)
    .game_acmd("game_appealhir", game_demon_AppealHiR)
    .game_acmd("game_appealhil", game_demon_AppealHiL)
    .game_acmd("game_appeallwr", game_demon_AppealLwR)
    .game_acmd("game_appeallwl", game_demon_AppealLwL)
    .install();
}