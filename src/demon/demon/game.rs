...
unsafe extern "C" fn game_demon_AttackStep2s(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_DEMON_STATUS_ATTACK_WORK_FLAG_CRITICAL);
...
unsafe extern "C" fn game_demon_AttackStep2l(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        WorkModule::off_flag(fighter.module_accessor, *FIGHTER_DEMON_STATUS_ATTACK_WORK_FLAG_CRITICAL);
