...
unsafe extern "C" fn status_ganon_Special_S_Main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn ganon_Special_S_Main_Sub(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    Agent::new("ganon")
    .status(Main, *FIGHTER_STATUS_KIND_SPECIAL_S, status_ganon_Special_S_Main)
    .install();
}