...
unsafe fn status_ganon_special_s_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    //let explosion_reduction_coefficient = WorkModule::get_param_float(fighter.module_accessor, hash40("param_special_s"), hash40("explosion_reduction_coefficient"));
    ...
    //sv_kinetic_energy!(set_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_MOTION, explosion_reduction_coefficient);
    if fighter.global_table[SITUATION_KIND].get_i32() != *SITUATION_KIND_GROUND {
        ...
        fighter.global_table[SUB_STATUS].assign(&L2CValue::Ptr(ganon_special_s_substatus as *const () as _));
    }
    else {
...
unsafe fn ganon_special_s_substatus(fighter: &mut L2CFighterCommon, param_1: L2CValue) -> L2CValue {
    if !param_1.get_bool() {
