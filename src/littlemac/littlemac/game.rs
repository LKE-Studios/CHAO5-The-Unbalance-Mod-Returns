...
pub fn install() {
    Agent::new("littlemac")
    .game_acmd("game_attack11", game_littlemac_Attack11)
    .game_acmd("game_attack12", game_littlemac_Attack12)
    .game_acmd("game_attack13", game_littlemac_Attack13)
    .game_acmd("game_attack100", game_littlemac_Attack100)
    .game_acmd("game_attack100subl", game_littlemac_Attack100SubL)
    .game_acmd("game_attack100subr", game_littlemac_Attack100SubR)
    .game_acmd("game_attack100end", game_littlemac_Attack100End)
    .game_acmd("game_attackdash", game_littlemac_AttackDash)
    .game_acmd("game_attacks3", game_littlemac_AttackS3)
    .game_acmd("game_attackhi3", game_littlemac_AttackHi3)
    .game_acmd("game_attacklw3", game_littlemac_AttackLw3)
    .game_acmd("game_attacks4hi", game_littlemac_AttackS4Hi)
    .game_acmd("game_attacks4", game_littlemac_AttackS4)
    .game_acmd("game_attacks4lw", game_littlemac_AttackS4Lw)
    .game_acmd("game_attackhi4", game_littlemac_AttackHi4)
    .game_acmd("game_attacklw4", game_littlemac_AttackLw4)
    .game_acmd("game_attackairn", game_littlemac_AttackAirN)
    .game_acmd("game_attackairf", game_littlemac_AttackAirF)    
    .game_acmd("game_attackairb", game_littlemac_AttackAirB)
    .game_acmd("game_attackairhi", game_littlemac_AttackAirHi)
    .game_acmd("game_attackairlw", game_littlemac_AttackAirLw)
    .game_acmd("game_catch", game_littlemac_Catch)
    .game_acmd("game_catchdash", game_littlemac_CatchDash)
    .game_acmd("game_catchturn", game_littlemac_CatchTurn)
    .game_acmd("game_catchattack", game_littlemac_CatchAttack)
    .game_acmd("game_throwf", game_littlemac_ThrowF)
    .game_acmd("game_throwb", game_littlemac_ThrowB)
    .game_acmd("game_throwhi", game_littlemac_ThrowHi)
    .game_acmd("game_throwlw", game_littlemac_ThrowLw)
    .game_acmd("game_downattackd", game_littlemac_DownAttackD)
    .game_acmd("game_downattacku", game_littlemac_DownAttackU)
    .game_acmd("game_cliffattack", game_littlemac_CliffAttack)
    .game_acmd("game_slipattack", game_littlemac_SlipAttack)
    .game_acmd("game_specialndash", game_littlemac_SpecialNDash)
    .game_acmd("game_specialndashturn", game_littlemac_SpecialNDashTurn)
    .game_acmd("game_specialnmaxdash", game_littlemac_SpecialNMaxDash)
    .game_acmd("game_specialnmaxdashturn", game_littlemac_SpecialNMaxDashTurn)
    .game_acmd("game_specialn2", game_littlemac_SpecialN2)
    .game_acmd("game_specialairndash", game_littlemac_SpecialAirNDash)
    .game_acmd("game_specialairndashturn", game_littlemac_SpecialAirNDashTurn)
    .game_acmd("game_specialairnmaxdash", game_littlemac_SpecialAirNMaxDash)
    .game_acmd("game_specialairnmaxdashturn", game_littlemac_SpecialAirNMaxDashTurn)
    .game_acmd("game_specialairn2", game_littlemac_SpecialAirN2)
    .game_acmd("game_specialsjump", game_littlemac_SpecialSJump)
    .game_acmd("game_specialairsblow", game_littlemac_SpecialAirSBlow)
    .game_acmd("game_specialhi", game_littlemac_SpecialHi)
    .game_acmd("game_speciallwhit", game_littlemac_SpecialLwHit)
    .game_acmd("game_specialairlwhit", game_littlemac_SpecialAirLwHit)
    .game_acmd("game_appealsr", game_littlemac_AppealSR)
    .game_acmd("game_appealsl", game_littlemac_AppealSL)
    .game_acmd("game_appealhir", game_littlemac_AppealHiR)
    .game_acmd("game_appealhil", game_littlemac_AppealHiL)
    .game_acmd("game_appeallwr", game_littlemac_AppealLwR)
    .game_acmd("game_appeallwl", game_littlemac_AppealLwL)
    .game_acmd("game_finalattack", game_littlemac_FinalAttack)
    .game_acmd("game_finalairattack", game_littlemac_FinalAirAttack)
    .install();
}
