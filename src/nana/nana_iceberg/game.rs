...
pub fn install() {
    ...
    .game_acmd("game_attackcommon", game_nana_iceberg_AttackCommon)
    .game_acmd("game_finalrise", game_nana_iceberg_FinalRise)
    .game_acmd("game_finaldecline", game_nana_iceberg_FinalDecline)
    .game_acmd("game_finalwait", game_nana_iceberg_FinalWait)
    .install();
}