...
//Regular
unsafe extern "C" fn game_kamui_ryusensya_Regular(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ...
        let hold_rate = WorkModule::get_float(fighter.module_accessor, *WEAPON_KAMUI_RYUSENSYA_INSTANCE_WORK_ID_FLOAT_HOLD_RATE);
...
//ShotMax
unsafe extern "C" fn game_kamui_ryusensya_ShotMax(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
