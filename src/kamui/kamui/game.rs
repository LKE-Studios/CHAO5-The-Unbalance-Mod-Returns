...
//Attack11
unsafe extern "C" fn game_kamui_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_kamui_Attack12(fighter: &mut L2CAgentBase) {
...
//Attack13
unsafe extern "C" fn game_kamui_Attack13(fighter: &mut L2CAgentBase) {
...
//Attack100Sub
unsafe extern "C" fn game_kamui_Attack100Sub(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.7, /*Angle*/ 361, /*KBG*/ 20, /*FKB*/ 0, /*BKB*/ 10, /*Size*/ 8.2, /*X*/ 0.0, /*Y*/ 7.0, /*Z*/ 18.0, /*X2*/ Some(0.0), /*Y2*/ Some(7.0), /*Z2*/ Some(10.0), /*Hitlag*/ 0.3, /*SDI*/ 0.6, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_THRU, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_purple"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_BITE);
        AttackModule::set_add_reaction_frame(fighter.module_accessor, /*ID*/ 0, /*Frames*/ 2.0, /*Unk*/ false);
        ATK_SET_SHIELD_SETOFF_MUL_arg3(fighter, /*ID1*/ 0, /*ID2*/ 1, /*ShieldstunMul*/ 8.0);
...
//Attack100End
unsafe extern "C" fn game_kamui_Attack100End(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AttackDash
unsafe extern "C" fn game_kamui_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3
unsafe extern "C" fn game_kamui_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
//AttackHi3
unsafe extern "C" fn game_kamui_AttackHi3(fighter: &mut L2CAgentBase) {
...
//AttackLw3
unsafe extern "C" fn game_kamui_AttackLw3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackS4Charge
unsafe extern "C" fn game_kamui_AttackS4Charge(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_SPEARHAND, false, 0);
...
//AttackHi4
unsafe extern "C" fn game_kamui_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
...
//AttackLw4
unsafe extern "C" fn game_kamui_AttackLw4(fighter: &mut L2CAgentBase) {
...
//AttackAirN
unsafe extern "C" fn game_kamui_AttackAirN(fighter: &mut L2CAgentBase) {
...
//AttackAirF 
unsafe extern "C" fn game_kamui_AttackAirF(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackAirB
unsafe extern "C" fn game_kamui_AttackAirB(fighter: &mut L2CAgentBase) {
...
//AttackAirHi
unsafe extern "C" fn game_kamui_AttackAirHi(fighter: &mut L2CAgentBase) {
...
//AttackAirLw
unsafe extern "C" fn game_kamui_AttackAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//LandingAirLw
unsafe extern "C" fn game_kamui_LandingAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//Catch
unsafe extern "C" fn game_kamui_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//CatchDash
unsafe extern "C" fn game_kamui_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchTurn
unsafe extern "C" fn game_kamui_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchAttack
unsafe extern "C" fn game_kamui_CatchAttack(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.66);
...
//ThrowF
unsafe extern "C" fn game_kamui_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_SPEARHAND, false, 0);
...
//ThrowB
unsafe extern "C" fn game_kamui_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_SPEARHAND, false, 0);
...
//ThrowHi
unsafe extern "C" fn game_kamui_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
    ...
    if is_excute(fighter) {
        ArticleModule::remove_exist(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_WATERDRAGON, ArticleOperationTarget(0));
        VisibilityModule::set_whole(fighter.module_accessor, true);
    }
}   

//ThrowLw
unsafe extern "C" fn game_kamui_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_WATERDRAGON, false, 0);
        ArticleModule::set_visibility_whole(fighter.module_accessor, *FIGHTER_KAMUI_GENERATE_ARTICLE_WATERDRAGON, false, ArticleOperationTarget(*ARTICLE_OPE_TARGET_ALL));
...
//CliffAttack
unsafe extern "C" fn game_kamui_CliffAttack(fighter: &mut L2CAgentBase) {
...
//SlipAttack
unsafe extern "C" fn game_kamui_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_kamui_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_kamui_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.5, /*X*/ 0.0, /*Y*/ 4.5, /*Z*/ 17.0, /*X2*/ Some(0.0), /*Y2*/ Some(4.5), /*Z2*/ Some(6.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
    }
...
//SpecialSWallAttackF
unsafe extern "C" fn game_kamui_SpecialSWallAttackF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialSWallAttackB
unsafe extern "C" fn game_kamui_SpecialSWallAttackB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialHi
unsafe extern "C" fn game_kamui_SpecialHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
...
//SpecialAirHi
unsafe extern "C" fn game_kamui_SpecialAirHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        SA_SET(fighter, *SITUATION_KIND_AIR);
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//AppealHiR
unsafe extern "C" fn game_kamui_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_kamui_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_CLUB), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_kamui_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_kamui_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BOMBCHU), 0, 0, false, false);
    }
}
...
//AppealLwR
unsafe extern "C" fn game_kamui_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_kamui_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_KILLSWORD), 0, 0, false, false);
    }
}
...
//FinalEnd
unsafe extern "C" fn game_kamui_FinalEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_kamui_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        CAM_ZOOM_OUT(fighter, );
        camera!(fighter, *MA_MSC_CMD_CAMERA_CAM_OFFSET, 0, 0);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_KAMUI_FINAL, /*ID*/ 0, /*Damage*/ 75.0, /*Angle*/ 60, /*KBG*/ 42, /*FKB*/ 0, /*BKB*/ 15, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_WATER, /*Type*/ *ATTACK_REGION_NONE);
...
pub fn install() {
    Agent::new("kamui")
    .game_acmd("game_attack11", game_kamui_Attack11, Low)
    .game_acmd("game_attack12", game_kamui_Attack12, Low)
    .game_acmd("game_attack100", game_kamui_Attack100, Low)
    .game_acmd("game_attack100sub", game_kamui_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_kamui_Attack100End, Low)
    .game_acmd("game_attackdash", game_kamui_AttackDash, Low)
    .game_acmd("game_attacks3", game_kamui_AttackS3, Low)
    .game_acmd("game_attackhi3", game_kamui_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_kamui_AttackLw3, Low)
    .game_acmd("game_attackhi4", game_kamui_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_kamui_AttackLw4, Low)
    .game_acmd("game_attackairn", game_kamui_AttackAirN, Low)
    .game_acmd("game_attackairf", game_kamui_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_kamui_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_kamui_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_kamui_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_kamui_LandingAirLw, Low)
    .game_acmd("game_catch", game_kamui_Catch, Low)
    .game_acmd("game_catchdash", game_kamui_CatchDash, Low)
    .game_acmd("game_catchturn", game_kamui_CatchTurn, Low)
    .game_acmd("game_catchattack", game_kamui_CatchAttack, Low)
    .game_acmd("game_throwf", game_kamui_ThrowF, Low)
    .game_acmd("game_downattackd", game_kamui_DownAttackD, Low)
    .game_acmd("game_downattacku", game_kamui_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_kamui_CliffAttack, Low)
    .game_acmd("game_slipattack", game_kamui_SlipAttack, Low)
    .game_acmd("game_specialswallattackf", game_kamui_SpecialSWallAttackF, Low)
    .game_acmd("game_specialswallattackb", game_kamui_SpecialSWallAttackB, Low)
    .game_acmd("game_specialhi", game_kamui_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_kamui_SpecialAirHi, Low)
    .game_acmd("game_appealsr", game_kamui_AppealSR, Low)
    .game_acmd("game_appealsl", game_kamui_AppealSL, Low)
    .game_acmd("game_appealhir", game_kamui_AppealHiR, Low)
    .game_acmd("game_appealhil", game_kamui_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_kamui_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_kamui_AppealLwL, Low)
    .game_acmd("game_finalend", game_kamui_FinalEnd, Low)
    .game_acmd("game_finalairend", game_kamui_FinalAirEnd, Low)
    .install();
}
