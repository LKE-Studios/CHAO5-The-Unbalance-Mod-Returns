...
pub fn install() {
    Agent::new("kamui")
    .game_acmd("game_attack11", game_kamui_Attack11)
    .game_acmd("game_attack12", game_kamui_Attack12)
    .game_acmd("game_attack100", game_kamui_Attack100)
    .game_acmd("game_attack100sub", game_kamui_Attack100Sub)
    .game_acmd("game_attack100end", game_kamui_Attack100End)
    .game_acmd("game_attackdash", game_kamui_AttackDash)
    .game_acmd("game_attacks3", game_kamui_AttackS3)
    .game_acmd("game_attackhi3", game_kamui_AttackHi3)
    .game_acmd("game_attacklw3", game_kamui_AttackLw3)
    .game_acmd("game_attackhi4", game_kamui_AttackHi4)
    .game_acmd("game_attacklw4", game_kamui_AttackLw4)
    .game_acmd("game_attackairn", game_kamui_AttackAirN)
    .game_acmd("game_attackairf", game_kamui_AttackAirF)    
    .game_acmd("game_attackairb", game_kamui_AttackAirB)
    .game_acmd("game_attackairhi", game_kamui_AttackAirHi)
    .game_acmd("game_attackairlw", game_kamui_AttackAirLw)
    .game_acmd("game_landingairlw", game_kamui_LandingAirLw)
    .game_acmd("game_catch", game_kamui_Catch)
    .game_acmd("game_catchdash", game_kamui_CatchDash)
    .game_acmd("game_catchturn", game_kamui_CatchTurn)
    .game_acmd("game_catchattack", game_kamui_CatchAttack)
    .game_acmd("game_throwf", game_kamui_ThrowF)
    .game_acmd("game_downattackd", game_kamui_DownAttackD)
    .game_acmd("game_downattacku", game_kamui_DownAttackU)
    .game_acmd("game_cliffattack", game_kamui_CliffAttack)
    .game_acmd("game_slipattack", game_kamui_SlipAttack)
    .game_acmd("game_specialswallattackf", game_kamui_SpecialSWallAttackF)
    .game_acmd("game_specialswallattackb", game_kamui_SpecialSWallAttackB)
    .game_acmd("game_specialhi", game_kamui_SpecialHi)
    .game_acmd("game_specialairhi", game_kamui_SpecialAirHi)
    .game_acmd("game_appealsr", game_kamui_AppealSR)
    .game_acmd("game_appealsl", game_kamui_AppealSL)
    .game_acmd("game_appealhir", game_kamui_AppealHiR)
    .game_acmd("game_appealhil", game_kamui_AppealHiL)
    .game_acmd("game_appeallwr", game_kamui_AppealLwR)
    .game_acmd("game_appeallwl", game_kamui_AppealLwL)
    .game_acmd("game_finalend", game_kamui_FinalEnd)
    .game_acmd("game_finalairend", game_kamui_FinalAirEnd)
    .install();
}
