...
unsafe extern "C" fn status_silver_SpecialNShoot_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if SILVER {
        ...
        original_status(Pre, fighter, *FIGHTER_MEWTWO_STATUS_KIND_SPECIAL_N_SHOOT)(fighter)
    }
}
