...
pub fn install() {
    Agent::new("pickel")
    .game_acmd("game_attackdash", game_pickel_AttackDash)
    .game_acmd("game_attacks3", game_pickel_AttackS3)
    .game_acmd("game_attackhi3", game_pickel_AttackHi3)
    .game_acmd("game_attacklw3", game_pickel_AttackLw3)
    .game_acmd("game_attacks4", game_pickel_AttackS4)
    .game_acmd("game_attackhi4", game_pickel_AttackHi4)
    .game_acmd("game_attacklw4", game_pickel_AttackLw4)
    .game_acmd("game_attackairn", game_pickel_AttackAirN)
    .game_acmd("game_attackairf", game_pickel_AttackAirF)    
    .game_acmd("game_attackairb", game_pickel_AttackAirB)
    .game_acmd("game_attackairhi", game_pickel_AttackAirHi)
    .game_acmd("game_attackairlw", game_pickel_AttackAirLw)
    .game_acmd("game_attackairlw2", game_pickel_AttackAirLw2) 
    .game_acmd("game_catch", game_pickel_Catch)
    .game_acmd("game_catchdash", game_pickel_CatchDash)
    .game_acmd("game_catchturn", game_pickel_CatchTurn)
    .game_acmd("game_catchattack", game_pickel_CatchAttack)
    .game_acmd("game_throwf", game_pickel_ThrowF)
    .game_acmd("game_throwb", game_pickel_ThrowB)
    .game_acmd("game_throwhi", game_pickel_ThrowHi)
    .game_acmd("game_throwlw", game_pickel_ThrowLw)
    .game_acmd("game_downattackd", game_pickel_DownAttackD)
    .game_acmd("game_downattacku", game_pickel_DownAttackU)
    .game_acmd("game_cliffattack", game_pickel_CliffAttack)
    .game_acmd("game_slipattack", game_pickel_SlipAttack)
    .game_acmd("game_specialn1", game_pickel_SpecialN1)
    .game_acmd("game_specialsdrive", game_pickel_SpecialSDrive)    
    .game_acmd("game_specialsride", game_pickel_SpecialSRide)
    .game_acmd("game_specialairsride", game_pickel_SpecialAirSRide)
    .game_acmd("game_specialhistart", game_pickel_SpecialHiStart)
    .game_acmd("game_specialairhistart", game_pickel_SpecialAirHiStart)
    .game_acmd("game_specialairhi", game_pickel_SpecialAirHi)
    .game_acmd("game_appealsr", game_pickel_AppealSR)
    .game_acmd("game_appealsl", game_pickel_AppealSL)
    .game_acmd("game_appealhir", game_pickel_AppealHiR)
    .game_acmd("game_appealhil", game_pickel_AppealHiL)
    .game_acmd("game_appeallwr", game_pickel_AppealLwR)
    .game_acmd("game_appeallwl", game_pickel_AppealLwL)
    .game_acmd("game_finalend", game_pickel_FinalEnd)
    .game_acmd("game_finalairend", game_pickel_FinalAirEnd)
    .install();
}
