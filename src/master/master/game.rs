...
pub fn install() {
    Agent::new("master")
    .game_acmd("game_attack11", game_master_Attack11)
    .game_acmd("game_attack12", game_master_Attack12)
    .game_acmd("game_attack13", game_master_Attack13)
    .game_acmd("game_attack100", game_master_Attack100)
    .game_acmd("game_attack100sub", game_master_Attack100Sub)
    .game_acmd("game_attack100end", game_master_Attack100End)
    .game_acmd("game_attackdash", game_master_AttackDash)
    .game_acmd("game_attacks3", game_master_AttackS3)
    .game_acmd("game_attackhi3", game_master_AttackHi3)
    .game_acmd("game_attacklw3", game_master_AttackLw3)
    .game_acmd("game_attacks4hi", game_master_AttackS4Hi)
    .game_acmd("game_attacks4", game_master_AttackS4)
    .game_acmd("game_attacks4lw", game_master_AttackS4Lw)
    .game_acmd("game_attackhi4", game_master_AttackHi4)
    .game_acmd("game_attacklw4", game_master_AttackLw4)
    .game_acmd("game_attackairn", game_master_AttackAirN)
    .game_acmd("game_landingairn", game_master_LandingAirN)
    .game_acmd("game_attackairf", game_master_AttackAirF)    
    .game_acmd("game_attackairb", game_master_AttackAirB)
    .game_acmd("game_attackairhi", game_master_AttackAirHi)
    .game_acmd("game_attackairlw", game_master_AttackAirLw)
    .game_acmd("game_catch", game_master_Catch)
    .game_acmd("game_catchturn", game_master_CatchTurn)
    .game_acmd("game_catchdash", game_master_CatchDash)
    .game_acmd("game_catchattack", game_master_CatchAttack)
    .game_acmd("game_throwf", game_master_ThrowF)
    .game_acmd("game_throwb", game_master_ThrowB)
    .game_acmd("game_throwhi", game_master_ThrowHi)
    .game_acmd("game_throwlw", game_master_ThrowLw)
    .game_acmd("game_downattackd", game_master_DownAttackD)
    .game_acmd("game_downattacku", game_master_DownAttackU)
    .game_acmd("game_cliffattack", game_master_CliffAttack)
    .game_acmd("game_slipattack", game_master_SlipAttack)
    .game_acmd("game_specialnstart", game_master_SpecialNStart)
    .game_acmd("game_specialairnstart", game_master_SpecialAirNStart)
    .game_acmd("game_specialsf", game_master_SpecialSF)
    .game_acmd("game_specialsfdash", game_master_SpecialSFDash)
    .game_acmd("game_specialairsf", game_master_SpecialAirSF)
    .game_acmd("game_specialairsfdash", game_master_SpecialAirSFDash)
    .game_acmd("game_specialhi", game_master_SpecialHi)
    .game_acmd("game_specialairhi", game_master_SpecialAirHi)
    .game_acmd("game_specialairhiovertake", game_master_SpecialAirHiOvertake)    
    .game_acmd("game_speciallw", game_master_SpecialLw)
    .game_acmd("game_specialairlw", game_master_SpecialAirLw)
    .game_acmd("game_speciallwhit", game_master_SpecialLwHit)
    .game_acmd("game_specialairlwhit", game_master_SpecialAirLwHit)
    .game_acmd("game_appealsr", game_master_AppealSR)
    .game_acmd("game_appealsl", game_master_AppealSL)
    .game_acmd("game_appealhir", game_master_AppealHiR)
    .game_acmd("game_appealhil", game_master_AppealHiL)
    .game_acmd("game_appeallwr", game_master_AppealLwR)
    .game_acmd("game_appeallwl", game_master_AppealLwL)
    .game_acmd("game_finalend", game_master_FinalEnd)
    .game_acmd("game_finalairend", game_master_FinalAirEnd)
    .install();
}
