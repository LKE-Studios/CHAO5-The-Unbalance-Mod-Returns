...
pub fn install() {
    ...
    .game_acmd("game_attack11", game_rosetta_tico_Attack11)
    .game_acmd("game_attack12", game_rosetta_tico_Attack12)
    .game_acmd("game_attack13", game_rosetta_tico_Attack13)
    .game_acmd("game_attack100", game_rosetta_tico_Attack100)
    .game_acmd("game_attack100sub", game_rosetta_tico_Attack100Sub)
    .game_acmd("game_attack100end", game_rosetta_tico_Attack100End)
    .game_acmd("game_attackdash", game_rosetta_tico_AttackDash)
    .game_acmd("game_attacks3", game_rosetta_tico_AttackS3)
    .game_acmd("game_attackhi3", game_rosetta_tico_AttackHi3)
    .game_acmd("game_attacklw3", game_rosetta_tico_AttackLw3)
    .game_acmd("game_attacks4lw", game_rosetta_tico_AttackS4Lw)
    .game_acmd("game_attacks4", game_rosetta_tico_AttackS4)
    .game_acmd("game_attacks4hi", game_rosetta_tico_AttackS4Hi)
    .game_acmd("game_attackhi4", game_rosetta_tico_AttackHi4)
    .game_acmd("game_attacklw4", game_rosetta_tico_AttackLw4)
    .game_acmd("game_attackairn", game_rosetta_tico_AttackAirN)
    .game_acmd("game_attackairf", game_rosetta_tico_AttackAirF)    
    .game_acmd("game_attackairb", game_rosetta_tico_AttackAirB)
    .game_acmd("game_attackairhi", game_rosetta_tico_AttackAirHi)
    .game_acmd("game_attackairlw", game_rosetta_tico_AttackAirLw)
    .game_acmd("game_specialnfly", game_rosetta_tico_SpecialNFly)
    .game_acmd("game_specials", game_rosetta_tico_SpecialS)
    .install();
}