...
//Attack11
unsafe extern "C" fn game_rosetta_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_rosetta_Attack12(fighter: &mut L2CAgentBase) {
...
//Attack13
unsafe extern "C" fn game_rosetta_Attack13(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
...
//Attack100
unsafe extern "C" fn game_rosetta_Attack100(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
...
//Attack100Sub
unsafe extern "C" fn game_rosetta_Attack100Sub(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 3.4, /*Angle*/ 361, /*KBG*/ 12, /*FKB*/ 0, /*BKB*/ 8, /*Size*/ 8.0, /*X*/ 0.0, /*Y*/ 10.0, /*Z*/ 16.5, /*X2*/ Some(0.0), /*Y2*/ Some(12.0), /*Z2*/ Some(16.5), /*Hitlag*/ 0.2, /*SDI*/ 0.4, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_magic"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_MAGIC);
        AttackModule::set_add_reaction_frame(fighter.module_accessor, /*ID*/ 0, /*Frames*/ 3.0, /*Unk*/ false);
        ATK_SET_SHIELD_SETOFF_MUL(fighter, /*ID*/ 0, /*ShieldstunMul*/ 5.0);
...
//Attack100End
unsafe extern "C" fn game_rosetta_Attack100End(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//AttackDash
unsafe extern "C" fn game_rosetta_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3
unsafe extern "C" fn game_rosetta_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
...
//AttackHi3
unsafe extern "C" fn game_rosetta_AttackHi3(fighter: &mut L2CAgentBase) {
...
//AttackLw3
unsafe extern "C" fn game_rosetta_AttackLw3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackS4Hi
unsafe extern "C" fn game_rosetta_AttackS4Hi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
...
//AttackS4
unsafe extern "C" fn game_rosetta_AttackS4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackS4Lw
unsafe extern "C" fn game_rosetta_AttackS4Lw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackHi4
unsafe extern "C" fn game_rosetta_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackLw4
unsafe extern "C" fn game_rosetta_AttackLw4(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    ...
    if is_excute(fighter) {
        ...
        AttackModule::set_attack_height_all(fighter.module_accessor, AttackHeight(*ATTACK_HEIGHT_LOW), false);
        shield!(fighter, MA_MSC_CMD_REFLECTOR, COLLISION_KIND_REFLECTOR, 0, Hash40::new("top"), 9.5, 0, 3.5, -15.8, 0, 3.5, 16.0, 1.5, 1.0, 700, false, 1.0, FIGHTER_REFLECTOR_GROUP_HOMERUNBAT);
    }
    wait(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        AttackModule::clear_all(fighter.module_accessor);
...
//AttackAirN
unsafe extern "C" fn game_rosetta_AttackAirN(fighter: &mut L2CAgentBase) {
...
//AttackAirF 
unsafe extern "C" fn game_rosetta_AttackAirF(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirB
unsafe extern "C" fn game_rosetta_AttackAirB(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirHi
unsafe extern "C" fn game_rosetta_AttackAirHi(fighter: &mut L2CAgentBase) {
...
//AttackAirLw
unsafe extern "C" fn game_rosetta_AttackAirLw(fighter: &mut L2CAgentBase) {
...
//Catch
unsafe extern "C" fn game_rosetta_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 5.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//CatchDash
unsafe extern "C" fn game_rosetta_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 5.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//CatchTurn
unsafe extern "C" fn game_rosetta_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
...
//CatchAttack
unsafe extern "C" fn game_rosetta_CatchAttack(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//ThrowF
unsafe extern "C" fn game_rosetta_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_rosetta_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_rosetta_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_rosetta_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_rosetta_CliffAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//SlipAttack
unsafe extern "C" fn game_rosetta_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_rosetta_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_rosetta_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.5, /*X*/ 0.0, /*Y*/ 5.5, /*Z*/ 13.5, /*X2*/ Some(0.0), /*Y2*/ Some(5.5), /*Z2*/ Some(5.5), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
    }
...
//SpecialN
unsafe extern "C" fn game_rosetta_SpecialN(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
...
//SpecialAirN
unsafe extern "C" fn game_rosetta_SpecialAirN(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_ROSETTA_STATUS_SPECIAL_N_FLAG_CHARGE);
...
//SpecialS
unsafe extern "C" fn game_rosetta_SpecialS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirS
unsafe extern "C" fn game_rosetta_SpecialAirS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 0.75);
    }
}
...
//SpecialHi
unsafe extern "C" fn game_rosetta_SpecialHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialLw
unsafe extern "C" fn game_rosetta_SpecialLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    for _ in 0..27 {
        if is_excute(fighter) {
...
//SpecialAirLw
unsafe extern "C" fn game_rosetta_SpecialAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    for _ in 0..27 {
        if is_excute(fighter) {
            WorkModule::on_flag(fighter.module_accessor, *FIGHTER_ROSETTA_STATUS_SPECIAL_LW_FLAG_ENABLE_SEARCH);
...
//AppealHiR
unsafe extern "C" fn game_rosetta_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_rosetta_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_STARRING), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_rosetta_AppealSR(fighter: &mut L2CAgentBase) {
...
//AppealSL
unsafe extern "C" fn game_rosetta_AppealSL(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 44.0);
    if is_excute(fighter) {
        DamageModule::heal(fighter.module_accessor, -30.0, 0);
    }
...
//AppealLwR
unsafe extern "C" fn game_rosetta_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_rosetta_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_STARROD), 0, 0, false, false);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 35.0, /*Angle*/ 361, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 40, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(13.4), /*Hitlag*/ 0.0, /*SDI*/ 0.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_bind"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_BODY);
    }
...
pub fn install() {
    Agent::new("rosetta")
    .game_acmd("game_attack11", game_rosetta_Attack11, Low)
    .game_acmd("game_attack12", game_rosetta_Attack12, Low)
    .game_acmd("game_attack13", game_rosetta_Attack13, Low)
    .game_acmd("game_attack100", game_rosetta_Attack100, Low)
    .game_acmd("game_attack100sub", game_rosetta_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_rosetta_Attack100End, Low)
    .game_acmd("game_attackdash", game_rosetta_AttackDash, Low)
    .game_acmd("game_attacks3", game_rosetta_AttackS3, Low)
    .game_acmd("game_attackhi3", game_rosetta_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_rosetta_AttackLw3, Low)
    .game_acmd("game_attacks4lw", game_rosetta_AttackS4Lw, Low)
    .game_acmd("game_attacks4", game_rosetta_AttackS4, Low)
    .game_acmd("game_attacks4hi", game_rosetta_AttackS4Hi, Low)
    .game_acmd("game_attackhi4", game_rosetta_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_rosetta_AttackLw4, Low)
    .game_acmd("game_attackairn", game_rosetta_AttackAirN, Low)
    .game_acmd("game_attackairf", game_rosetta_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_rosetta_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_rosetta_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_rosetta_AttackAirLw, Low)
    .game_acmd("game_catch", game_rosetta_Catch, Low)
    .game_acmd("game_catchdash", game_rosetta_CatchDash, Low)
    .game_acmd("game_catchturn", game_rosetta_CatchTurn, Low)
    .game_acmd("game_catchattack", game_rosetta_CatchAttack, Low)
    .game_acmd("game_throwf", game_rosetta_ThrowF, Low)
    .game_acmd("game_throwb", game_rosetta_ThrowB, Low)
    .game_acmd("game_throwhi", game_rosetta_ThrowHi, Low)
    .game_acmd("game_throwlw", game_rosetta_ThrowLw, Low)
    .game_acmd("game_downattackd", game_rosetta_DownAttackD, Low)
    .game_acmd("game_downattacku", game_rosetta_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_rosetta_CliffAttack, Low)
    .game_acmd("game_slipattack", game_rosetta_SlipAttack, Low)
    .game_acmd("game_specialn", game_rosetta_SpecialN, Low) 
    .game_acmd("game_specialairn", game_rosetta_SpecialAirN, Low) 
    .game_acmd("game_specials", game_rosetta_SpecialS, Low) 
    .game_acmd("game_specialairs", game_rosetta_SpecialAirS, Low) 
    .game_acmd("game_specialhi", game_rosetta_SpecialHi, Low) 
    .game_acmd("game_speciallw", game_rosetta_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_rosetta_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_rosetta_AppealSR, Low)
    .game_acmd("game_appealsl", game_rosetta_AppealSL, Low)
    .game_acmd("game_appealhir", game_rosetta_AppealHiR, Low)
    .game_acmd("game_appealhil", game_rosetta_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_rosetta_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_rosetta_AppealLwL, Low)
    .install();
}