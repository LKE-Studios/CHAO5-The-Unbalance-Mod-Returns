...
pub fn install() {
    Agent::new("rosetta")
    .game_acmd("game_attack11", game_rosetta_Attack11)
    .game_acmd("game_attack12", game_rosetta_Attack12)
    .game_acmd("game_attack13", game_rosetta_Attack13)
    .game_acmd("game_attack100", game_rosetta_Attack100)
    .game_acmd("game_attack100sub", game_rosetta_Attack100Sub)
    .game_acmd("game_attack100end", game_rosetta_Attack100End)
    .game_acmd("game_attackdash", game_rosetta_AttackDash)
    .game_acmd("game_attacks3", game_rosetta_AttackS3)
    .game_acmd("game_attackhi3", game_rosetta_AttackHi3)
    .game_acmd("game_attacklw3", game_rosetta_AttackLw3)
    .game_acmd("game_attacks4lw", game_rosetta_AttackS4Lw)
    .game_acmd("game_attacks4", game_rosetta_AttackS4)
    .game_acmd("game_attacks4hi", game_rosetta_AttackS4Hi)
    .game_acmd("game_attackhi4", game_rosetta_AttackHi4)
    .game_acmd("game_attacklw4", game_rosetta_AttackLw4)
    .game_acmd("game_attackairn", game_rosetta_AttackAirN)
    .game_acmd("game_attackairf", game_rosetta_AttackAirF)    
    .game_acmd("game_attackairb", game_rosetta_AttackAirB)
    .game_acmd("game_attackairhi", game_rosetta_AttackAirHi)
    .game_acmd("game_attackairlw", game_rosetta_AttackAirLw)
    .game_acmd("game_catch", game_rosetta_Catch)
    .game_acmd("game_catchdash", game_rosetta_CatchDash)
    .game_acmd("game_catchturn", game_rosetta_CatchTurn)
    .game_acmd("game_catchattack", game_rosetta_CatchAttack)
    .game_acmd("game_throwf", game_rosetta_ThrowF)
    .game_acmd("game_throwb", game_rosetta_ThrowB)
    .game_acmd("game_throwhi", game_rosetta_ThrowHi)
    .game_acmd("game_throwlw", game_rosetta_ThrowLw)
    .game_acmd("game_downattackd", game_rosetta_DownAttackD)
    .game_acmd("game_downattacku", game_rosetta_DownAttackU)
    .game_acmd("game_cliffattack", game_rosetta_CliffAttack)
    .game_acmd("game_slipattack", game_rosetta_SlipAttack)
    .game_acmd("game_specialn", game_rosetta_SpecialN) 
    .game_acmd("game_specialairn", game_rosetta_SpecialAirN) 
    .game_acmd("game_specials", game_rosetta_SpecialS) 
    .game_acmd("game_specialairs", game_rosetta_SpecialAirS) 
    .game_acmd("game_specialhi", game_rosetta_SpecialHi) 
    .game_acmd("game_speciallw", game_rosetta_SpecialLw)
    .game_acmd("game_specialairlw", game_rosetta_SpecialAirLw)
    .game_acmd("game_appealsr", game_rosetta_AppealSR)
    .game_acmd("game_appealsl", game_rosetta_AppealSL)
    .game_acmd("game_appealhir", game_rosetta_AppealHiR)
    .game_acmd("game_appealhil", game_rosetta_AppealHiL)
    .game_acmd("game_appeallwr", game_rosetta_AppealLwR)
    .game_acmd("game_appeallwl", game_rosetta_AppealLwL)
    .install();
}