...
pub fn install() {
    Agent::new("lucas")
    .game_acmd("game_attack11_claus", game_claus_Attack11)
    .game_acmd("game_attack12_claus", game_claus_Attack12)
    .game_acmd("game_attack13_claus", game_claus_Attack13)
    .game_acmd("game_attackdash_claus", game_claus_AttackDash)
    .game_acmd("game_attacks3hi_claus", game_claus_AttackS3Hi)
    .game_acmd("game_attacks3_claus", game_claus_AttackS3)
    .game_acmd("game_attacks3lw_claus", game_claus_AttackS3Lw)
    .game_acmd("game_attackhi3_claus", game_claus_AttackHi3)
    .game_acmd("game_attacklw3_claus", game_claus_AttackLw3)
    .game_acmd("game_attacks4_claus", game_claus_AttackS4)
    .game_acmd("game_attackhi4_claus", game_claus_AttackHi4)
    .game_acmd("game_attacklw4_claus", game_claus_AttackLw4)
    .game_acmd("game_attackairn_claus", game_claus_AttackAirN)
    .game_acmd("game_attackairf_claus", game_claus_AttackAirF)    
    ...
    .game_acmd("game_throwhi_claus", game_claus_ThrowHi)
    .game_acmd("game_throwlw_claus", game_claus_ThrowLw)
    .game_acmd("game_downattackd_claus", game_claus_DownAttackD)
    .game_acmd("game_downattacku_claus", game_claus_DownAttackU)
    .game_acmd("game_cliffattack_claus", game_claus_CliffAttack)
    ...
    .game_acmd("game_specialairhidownboundu_claus", game_claus_SpecialAirHiDownBoundU)
    .game_acmd("game_speciallwstart_claus", game_claus_SpecialLwStart)
    .game_acmd("game_speciallwend_claus", game_claus_SpecialLwEnd)
    .game_acmd("game_specialairlwstart_claus", game_claus_SpecialAirLwStart)
    .game_acmd("game_specialairlwend_claus", game_claus_SpecialAirLwEnd)
    .game_acmd("game_speciallwhold_claus", game_claus_SpecialLwHold)
    .game_acmd("game_specialairlwhold_claus", game_claus_SpecialAirLwHold)
    .game_acmd("game_appealsr_claus", game_claus_AppealSR)
    .game_acmd("game_appealsl_claus", game_claus_AppealSL)
    .game_acmd("game_appealhir_claus", game_claus_AppealHiR)
    .game_acmd("game_appealhil_claus", game_claus_AppealHiL)
