...
//Attack11 
unsafe extern "C" fn game_claus_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12 
unsafe extern "C" fn game_claus_Attack12(fighter: &mut L2CAgentBase) {
...
//Attack13 
unsafe extern "C" fn game_claus_Attack13(fighter: &mut L2CAgentBase) {
...
//AttackDash
unsafe extern "C" fn game_claus_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3Hi
unsafe extern "C" fn game_claus_AttackS3Hi(fighter: &mut L2CAgentBase) {
...
//AttackS3
unsafe extern "C" fn game_claus_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 0.0, 3.0);
    }
...
//AttackS3Lw
unsafe extern "C" fn game_claus_AttackS3Lw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 0.0, 3.0);
    }
...
//AttackHi3
unsafe extern "C" fn game_claus_AttackHi3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackLw3
unsafe extern "C" fn game_claus_AttackLw3(fighter: &mut L2CAgentBase) {
...
//AttackS4
unsafe extern "C" fn game_claus_AttackS4(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AttackHi4
unsafe extern "C" fn game_claus_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//AttackLw4
unsafe extern "C" fn game_claus_AttackLw4(fighter: &mut L2CAgentBase) {
...
//AttackAirN
unsafe extern "C" fn game_claus_AttackAirN(fighter: &mut L2CAgentBase) {
    ...
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 3.35, /*Angle*/ 366, /*KBG*/ 66, /*FKB*/ 0, /*BKB*/ 20, /*Size*/ 10.9, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.7, /*SDI*/ 2.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 4, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_elec"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_PSI);
    }
...
//AttackAirF
unsafe extern "C" fn game_claus_AttackAirF(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 1.2);
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
//AttackAirB
unsafe extern "C" fn game_claus_AttackAirB(fighter: &mut L2CAgentBase) {
...
//AttackAirHi
unsafe extern "C" fn game_claus_AttackAirHi(fighter: &mut L2CAgentBase) {
...
//AttackAirLw
unsafe extern "C" fn game_claus_AttackAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
    frame(fighter.lua_state_agent, 4.0);
...
//ThrowF
unsafe extern "C" fn game_claus_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_claus_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_claus_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_claus_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_claus_CliffAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 22.0);
    if is_excute(fighter) {
...
//SlipAttack
unsafe extern "C" fn game_claus_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_claus_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_claus_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 48, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ -13.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(-5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
    }
...
//SpecialNHold
unsafe extern "C" fn game_claus_SpecialNHold(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 0.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_LUCAS_STATUS_SPECIAL_N_FLAG_GENERATE_ARTICLE);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 4.0, /*Angle*/ 30, /*KBG*/ 84, /*FKB*/ 0, /*BKB*/ 45, /*Size*/ 11.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(0.0), /*Hitlag*/ 0.5, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 1, /*Trip*/ 0.0, /*Rehit*/ 5, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_ice"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_PSI);
    }
}

//SpecialAirNHold
unsafe extern "C" fn game_claus_SpecialAirNHold(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 0.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_LUCAS_STATUS_SPECIAL_N_FLAG_GENERATE_ARTICLE);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 4.0, /*Angle*/ 30, /*KBG*/ 84, /*FKB*/ 0, /*BKB*/ 45, /*Size*/ 11.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(0.0), /*Z2*/ Some(0.0), /*Hitlag*/ 0.5, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 1, /*Trip*/ 0.0, /*Rehit*/ 5, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_ice"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_PSI);
...
//SpecialS
unsafe extern "C" fn game_claus_SpecialS(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 21.0);
    if is_excute(fighter) {
...
//SpecialAirS
unsafe extern "C" fn game_claus_SpecialAirS(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 21.0);
    if is_excute(fighter) {
...
//SpecialAirHi
unsafe extern "C" fn game_claus_SpecialAirHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirHiReflect
unsafe extern "C" fn game_claus_SpecialAirHiReflect(fighter: &mut L2CAgentBase) {
    WHOLE_HIT(fighter, *HIT_STATUS_INVINCIBLE);
...
unsafe extern "C" fn game_claus_SpecialAirHiDownBoundD(fighter: &mut L2CAgentBase) {
    WHOLE_HIT(fighter, *HIT_STATUS_INVINCIBLE);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_LUCAS_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_NO_LAST_ATTACK) {
        if is_excute(fighter) {
            AttackModule::clear_all(fighter.module_accessor);
...
unsafe extern "C" fn game_claus_SpecialAirHiDownBoundU(fighter: &mut L2CAgentBase) {
    WHOLE_HIT(fighter, *HIT_STATUS_INVINCIBLE);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_LUCAS_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_NO_LAST_ATTACK) {
        if is_excute(fighter) {
            AttackModule::clear_all(fighter.module_accessor);
...
//SpecialLwStart
unsafe extern "C" fn game_claus_SpecialLwStart(fighter: &mut L2CAgentBase) {
...
//SpecialAirLwStart
unsafe extern "C" fn game_claus_SpecialAirLwStart(fighter: &mut L2CAgentBase) {
    wait(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 10.0, /*Angle*/ 180, /*KBG*/ 100, /*FKB*/ 23, /*BKB*/ 0, /*Size*/ 16.0, /*X*/ 0.0, /*Y*/ 6.5, /*Z*/ 11.5, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.0, /*SDI*/ 0.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 6, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ true, /*DisableHitlag*/ true, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
    }
...
//SpecialAirLwEnd
unsafe extern "C" fn game_claus_SpecialAirLwEnd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 20.0, /*Angle*/ 45, /*KBG*/ 85, /*FKB*/ 0, /*BKB*/ 40, /*Size*/ 12.5, /*X*/ 0.0, /*Y*/ 6.3, /*Z*/ 7.0, /*X2*/ Some(0.0), /*Y2*/ Some(6.3), /*Z2*/ Some(9.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_paralyze"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_ELEC, /*Type*/ *ATTACK_REGION_PSI);
    }
...
//SpecialLwHold
unsafe extern "C" fn game_claus_SpecialLwHold(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        if is_excute(fighter) {
            ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.4, /*Angle*/ 85, /*KBG*/ 100, /*FKB*/ 40, /*BKB*/ 0, /*Size*/ 12.0, /*X*/ 0.0, /*Y*/ 6.3, /*Z*/ 14.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 1.0, /*SDI*/ 3.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 5, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_elec"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_PSI);
...
//SpecialAirLwHold
unsafe extern "C" fn game_claus_SpecialAirLwHold(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        if is_excute(fighter) {
            ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.4, /*Angle*/ 85, /*KBG*/ 100, /*FKB*/ 40, /*BKB*/ 0, /*Size*/ 12.0, /*X*/ 0.0, /*Y*/ 6.3, /*Z*/ 14.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 1.0, /*SDI*/ 3.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 5, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_elec"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_MAGIC, /*Type*/ *ATTACK_REGION_PSI);
            ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 0.0, /*Angle*/ 180, /*KBG*/ 100, /*FKB*/ 40, /*BKB*/ 0, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 9.0, /*Z*/ 22.0, /*X2*/ Some(0.0), /*Y2*/ Some(9.0), /*Z2*/ Some(60.0), /*Hitlag*/ 0.0, /*SDI*/ 0.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 3, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ true, /*DisableHitlag*/ true, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA_d, /*Hitbits*/ *COLLISION_CATEGORY_MASK_NO_STAGE_GIMMICK, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_NONE);
...
//AppealHiR
unsafe extern "C" fn game_claus_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_claus_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BADGE), 0, 0, false, false);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.0, /*Angle*/ 0, /*KBG*/ 1, /*FKB*/ 0, /*BKB*/ 1, /*Size*/ 1000.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 1.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_G, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_slip"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_SLAP, /*Type*/ *ATTACK_REGION_NONE);
    }
...
//AppealSR
unsafe extern "C" fn game_claus_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_claus_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_LUCAS_GENERATE_ARTICLE_HIMOHEBI, false, -1);
        ArticleModule::change_motion(fighter.module_accessor, *FIGHTER_LUCAS_GENERATE_ARTICLE_HIMOHEBI, Hash40::new("appeal_s"), false, -1.0);
        DamageModule::heal(fighter.module_accessor, -18.0, 0);
...
//AppealLwR
unsafe extern "C" fn game_claus_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_claus_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//WessDance
unsafe extern "C" fn game_claus_WessDance(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    Agent::new("lucas")
    .game_acmd("game_attack11_claus", game_claus_Attack11, Low)
    .game_acmd("game_attack12_claus", game_claus_Attack12, Low)
    .game_acmd("game_attack13_claus", game_claus_Attack13, Low)
    .game_acmd("game_attackdash_claus", game_claus_AttackDash, Low)
    .game_acmd("game_attacks3hi_claus", game_claus_AttackS3Hi, Low)
    .game_acmd("game_attacks3_claus", game_claus_AttackS3, Low)
    .game_acmd("game_attacks3lw_claus", game_claus_AttackS3Lw, Low)
    .game_acmd("game_attackhi3_claus", game_claus_AttackHi3, Low)
    .game_acmd("game_attacklw3_claus", game_claus_AttackLw3, Low)
    .game_acmd("game_attacks4_claus", game_claus_AttackS4, Low)
    .game_acmd("game_attackhi4_claus", game_claus_AttackHi4, Low)
    .game_acmd("game_attacklw4_claus", game_claus_AttackLw4, Low)
    .game_acmd("game_attackairn_claus", game_claus_AttackAirN, Low)
    .game_acmd("game_attackairf_claus", game_claus_AttackAirF, Low)    
    .game_acmd("game_attackairb_claus", game_claus_AttackAirB, Low)
    .game_acmd("game_attackairhi_claus", game_claus_AttackAirHi, Low)
    .game_acmd("game_attackairlw_claus", game_claus_AttackAirLw, Low)
    .game_acmd("game_catchattack_claus", game_claus_CatchAttack, Low)
    .game_acmd("game_throwf_claus", game_claus_ThrowF, Low)
    .game_acmd("game_throwb_claus", game_claus_ThrowB, Low)
    .game_acmd("game_throwhi_claus", game_claus_ThrowHi, Low)
    .game_acmd("game_throwlw_claus", game_claus_ThrowLw, Low)
    .game_acmd("game_downattackd_claus", game_claus_DownAttackD, Low)
    .game_acmd("game_downattacku_claus", game_claus_DownAttackU, Low)
    .game_acmd("game_cliffattack_claus", game_claus_CliffAttack, Low)
    .game_acmd("game_slipattack_claus", game_claus_SlipAttack, Low)
    .game_acmd("game_specialnhold_claus", game_claus_SpecialNHold, Low)
    .game_acmd("game_specialairnhold_claus", game_claus_SpecialAirNHold, Low)
    .game_acmd("game_specials_claus", game_claus_SpecialS, Low)
    .game_acmd("game_specialairs_claus", game_claus_SpecialAirS, Low)
    .game_acmd("game_specialairhi_claus", game_claus_SpecialAirHi, Low)
    .game_acmd("game_specialairhireflect_claus", game_claus_SpecialAirHiReflect, Low)
    .game_acmd("game_specialairhidownboundd_claus", game_claus_SpecialAirHiDownBoundD, Low)
    .game_acmd("game_specialairhidownboundu_claus", game_claus_SpecialAirHiDownBoundU, Low)
    .game_acmd("game_speciallwstart_claus", game_claus_SpecialLwStart, Low)
    .game_acmd("game_speciallwend_claus", game_claus_SpecialLwEnd, Low)
    .game_acmd("game_specialairlwstart_claus", game_claus_SpecialAirLwStart, Low)
    .game_acmd("game_specialairlwend_claus", game_claus_SpecialAirLwEnd, Low)
    .game_acmd("game_speciallwhold_claus", game_claus_SpecialLwHold, Low)
    .game_acmd("game_specialairlwhold_claus", game_claus_SpecialAirLwHold, Low)
    .game_acmd("game_appealsr_claus", game_claus_AppealSR, Low)
    .game_acmd("game_appealsl_claus", game_claus_AppealSL, Low)
    .game_acmd("game_appealhir_claus", game_claus_AppealHiR, Low)
    .game_acmd("game_appealhil_claus", game_claus_AppealHiL, Low)
    .game_acmd("game_appeallwr_claus", game_claus_AppealLwR, Low)
    .game_acmd("game_appeallwl_claus", game_claus_AppealLwL, Low)
    .game_acmd("game_wessdance_claus", game_claus_WessDance, Low)
    .install();
}