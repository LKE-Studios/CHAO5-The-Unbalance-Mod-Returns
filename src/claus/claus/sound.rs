...
pub fn install() {
    Agent::new("lucas")
    .sound_acmd("sound_entryl_claus", sound_claus_EntryL, Low)
    .sound_acmd("sound_entryr_claus", sound_claus_EntryR, Low)
    .sound_acmd("sound_win1_claus", sound_claus_Win1, Low)
    .sound_acmd("sound_win3_claus", sound_claus_Win3, Low)
    .sound_acmd("sound_attack11_claus", sound_claus_Attack11, Low)
    .sound_acmd("sound_attack12_claus", sound_claus_Attack12, Low)
    .sound_acmd("sound_attack13_claus", sound_claus_Attack13, Low)
    .sound_acmd("sound_attacklw4_claus", sound_claus_AttackLw4, Low)
    .sound_acmd("sound_attackairlw_claus", sound_claus_AttackAirLw, Low)
    .sound_acmd("sound_speciallwstart_claus", sound_claus_SpecialLwStart, Low)    
    .sound_acmd("sound_specialairlwstart_claus", sound_claus_SpecialAirLwStart, Low)    
    .sound_acmd("sound_appealsr_claus", sound_claus_AppealSR, Low)    
    .sound_acmd("sound_appealsl_claus", sound_claus_AppealSL, Low)      
    .sound_acmd("sound_wessdance_claus", sound_claus_WessDance, Low)
    .install();
}