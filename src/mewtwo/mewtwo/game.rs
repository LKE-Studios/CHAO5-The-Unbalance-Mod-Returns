...
unsafe extern "C" fn game_mewtwo_SpecialS(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(fighter) {
        ...
        ATTACK_ABS(fighter, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 44.0, 280, 91, 0, 30, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_flower"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        ATTACK_ABS(fighter, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 44.0, 361, 100, 0, 0, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, false, Hash40::new("collision_attr_flower"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
pub fn install() {
    Agent::new("mewtwo")
    .game_acmd("game_attack11", game_mewtwo_Attack11, Low)
    .game_acmd("game_attack100", game_mewtwo_Attack100, Low)
    .game_acmd("game_attack100sub", game_mewtwo_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_mewtwo_Attack100End, Low)
    .game_acmd("game_attackdash", game_mewtwo_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_mewtwo_AttackS3Hi, Low) 
    .game_acmd("game_attacks3", game_mewtwo_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_mewtwo_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_mewtwo_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_mewtwo_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_mewtwo_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_mewtwo_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_mewtwo_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_mewtwo_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_mewtwo_AttackLw4, Low)
    .game_acmd("game_attackairn", game_mewtwo_AttackAirN, Low)
    .game_acmd("game_attackairf", game_mewtwo_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_mewtwo_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_mewtwo_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_mewtwo_AttackAirLw, Low)
    .game_acmd("game_catch", game_mewtwo_Catch, Low)
    .game_acmd("game_catchturn", game_mewtwo_CatchTurn, Low)
    .game_acmd("game_catchdash", game_mewtwo_CatchDash, Low)
    .game_acmd("game_catchattack", game_mewtwo_CatchAttack, Low)
    .game_acmd("game_throwf", game_mewtwo_ThrowF, Low)
    .game_acmd("game_throwb", game_mewtwo_ThrowB, Low)
    .game_acmd("game_throwhi", game_mewtwo_ThrowHi, Low)
    .game_acmd("game_throwlw", game_mewtwo_ThrowLw, Low)
    .game_acmd("game_downattackd", game_mewtwo_DownAttackD, Low)
    .game_acmd("game_downattacku", game_mewtwo_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_mewtwo_CliffAttack, Low)
    .game_acmd("game_slipattack", game_mewtwo_SlipAttack, Low)
    .game_acmd("game_specials", game_mewtwo_SpecialS, Low)
    .game_acmd("game_specialhi", game_mewtwo_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_mewtwo_SpecialAirHi, Low)   
    .game_acmd("game_appealsr", game_mewtwo_AppealSR, Low)
    .game_acmd("game_appealsl", game_mewtwo_AppealSL, Low)
    .game_acmd("game_appealhir", game_mewtwo_AppealHiR, Low)
    .game_acmd("game_appealhil", game_mewtwo_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_mewtwo_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_mewtwo_AppealLwL, Low)
    .install();
}