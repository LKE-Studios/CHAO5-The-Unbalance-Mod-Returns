...
//Fly
unsafe extern "C" fn game_trail_ice_Fly(fighter: &mut L2CAgentBase) {
...
//FlyLast
unsafe extern "C" fn game_trail_ice_FlyLast(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    Agent::new("trail_ice")   
    .game_acmd("game_fly", game_trail_ice_Fly) 
    .game_acmd("game_flylast", game_trail_ice_FlyLast)
    .install();
}