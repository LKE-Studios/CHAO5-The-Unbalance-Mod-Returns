...
pub fn install() {
    Agent::new("trail")
    .game_acmd("game_glidedirection", game_trail_GlideDirection, Low)
    .game_acmd("game_glideattack", game_trail_GlideAttack, Low)
    .game_acmd("game_attack11", game_trail_Attack11, Low)
    .game_acmd("game_attack12", game_trail_Attack12, Low)
    .game_acmd("game_attack13", game_trail_Attack13, Low)
    .game_acmd("game_attackdash", game_trail_AttackDash, Low)
    .game_acmd("game_attacks3", game_trail_AttackS3, Low)
    .game_acmd("game_attacks32", game_trail_AttackS32, Low)
    .game_acmd("game_attacks33", game_trail_AttackS33, Low)
    .game_acmd("game_attackhi3", game_trail_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_trail_AttackLw3, Low)
    .game_acmd("game_attacks4", game_trail_AttackS4, Low)
    .game_acmd("game_attackhi4", game_trail_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_trail_AttackLw4, Low)
    .game_acmd("game_attackairn", game_trail_AttackAirN, Low)
    .game_acmd("game_attackairn2", game_trail_AttackAirN2, Low)
    .game_acmd("game_attackairn3", game_trail_AttackAirN3, Low)
    .game_acmd("game_attackairf", game_trail_AttackAirF, Low) 
    .game_acmd("game_attackairf2", game_trail_AttackAirF2, Low) 
    .game_acmd("game_attackairf3", game_trail_AttackAirF3, Low)    
    .game_acmd("game_attackairb", game_trail_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_trail_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_trail_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_trail_LandingAirLw, Low)
    .game_acmd("game_catch", game_trail_Catch, Low)
    .game_acmd("game_catchdash", game_trail_CatchDash, Low)
    .game_acmd("game_catchturn", game_trail_CatchTurn, Low)
    .game_acmd("game_catchattack", game_trail_CatchAttack, Low)
    .game_acmd("game_throwf", game_trail_ThrowF, Low)
    .game_acmd("game_throwb", game_trail_ThrowB, Low)
    .game_acmd("game_throwhi", game_trail_ThrowHi, Low)
    .game_acmd("game_throwlw", game_trail_ThrowLw, Low)
    .game_acmd("game_downattackd", game_trail_DownAttackD, Low)
    .game_acmd("game_downattacku", game_trail_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_trail_CliffAttack, Low)
    .game_acmd("game_slipattack", game_trail_SlipAttack, Low)
    .game_acmd("game_specialn1start", game_trail_SpecialN1Start, Low)
    .game_acmd("game_specialairn1start", game_trail_SpecialAirN1Start, Low)
    .game_acmd("game_specialn1", game_trail_SpecialN1, Low) 
    .game_acmd("game_specialn12", game_trail_SpecialN12, Low)  
    .game_acmd("game_specialairn12", game_trail_SpecialAirN12, Low)  
    .game_acmd("game_specialn2", game_trail_SpecialN2, Low)  
    .game_acmd("game_specialn3", game_trail_SpecialN3, Low)
    .game_acmd("game_specialairn1", game_trail_SpecialAirN1, Low) 
    .game_acmd("game_specialairn2", game_trail_SpecialAirN2, Low)  
    .game_acmd("game_specialairn3", game_trail_SpecialAirN3, Low)
    .game_acmd("game_specials1", game_trail_SpecialS1, Low)  
    .game_acmd("game_specials2", game_trail_SpecialS2, Low)  
    .game_acmd("game_specials3", game_trail_SpecialS3, Low)
    .game_acmd("game_specialairs1", game_trail_SpecialAirS1, Low) 
    .game_acmd("game_specialairs2", game_trail_SpecialAirS2, Low)  
    .game_acmd("game_specialairs3", game_trail_SpecialAirS3, Low)
    .game_acmd("game_specialhi", game_trail_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_trail_SpecialAirHi, Low)
    .game_acmd("game_speciallw", game_trail_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_trail_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_trail_AppealSR, Low)
    .game_acmd("game_appealsl", game_trail_AppealSL, Low)
    .game_acmd("game_appealhir", game_trail_AppealHiR, Low)
    .game_acmd("game_appealhil", game_trail_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_trail_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_trail_AppealLwL, Low)
    .game_acmd("game_finalend", game_trail_FinalEnd, Low)
    .game_acmd("game_finalendl", game_trail_FinalEndL, Low)
    .game_acmd("game_finalendr", game_trail_FinalEndR, Low)
    .game_acmd("game_finalairendl", game_trail_FinalAirEndL, Low)
    .install();
}