...
pub fn install() {
    Agent::new("sonic")
    .game_acmd("game_dash", game_sonic_Dash, Low)
    .game_acmd("game_run", game_sonic_Run, Low)
    .game_acmd("game_attack11", game_sonic_Attack11, Low)
    .game_acmd("game_attack12", game_sonic_Attack12, Low)
    .game_acmd("game_attack13", game_sonic_Attack13, Low)
    .game_acmd("game_attackdash", game_sonic_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_sonic_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_sonic_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_sonic_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_sonic_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_sonic_AttackLw3, Low)
    .game_acmd("game_attacks4hi", game_sonic_AttackS4Hi, Low)
    .game_acmd("game_attacks4", game_sonic_AttackS4, Low)
    .game_acmd("game_attacks4lw", game_sonic_AttackS4Lw, Low)
    .game_acmd("game_attackhi4", game_sonic_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_sonic_AttackLw4, Low)
    .game_acmd("game_attackairn", game_sonic_AttackAirN, Low)
    .game_acmd("game_attackairf", game_sonic_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_sonic_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_sonic_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_sonic_AttackAirLw, Low)
    .game_acmd("game_catch", game_sonic_Catch, Low)
    .game_acmd("game_catchdash", game_sonic_CatchDash, Low)
    .game_acmd("game_catchturn", game_sonic_CatchTurn, Low)
    .game_acmd("game_catchattack", game_sonic_CatchAttack, Low)
    .game_acmd("game_throwf", game_sonic_ThrowF, Low)
    .game_acmd("game_throwb", game_sonic_ThrowB, Low)
    .game_acmd("game_throwhi", game_sonic_ThrowHi, Low)
    .game_acmd("game_throwlw", game_sonic_ThrowLw, Low)
    .game_acmd("game_downattackd", game_sonic_DownAttackD, Low)
    .game_acmd("game_downattacku", game_sonic_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_sonic_CliffAttack, Low)
    .game_acmd("game_slipattack", game_sonic_SlipAttack, Low)
    .game_acmd("game_specialnhoming", game_sonic_SpecialNHoming, Low)
    .game_acmd("game_specialsdashattack", game_sonic_SpecialSDashAttack, Low)  
    .game_acmd("game_specialsdashhi", game_sonic_SpecialSDashHi, Low) 
    .game_acmd("game_specialsdashhop", game_sonic_SpecialSDashHop, Low)  
    .game_acmd("game_specialsdashlr", game_sonic_SpecialSDashLw, Low) 
    .game_acmd("game_specialsspin", game_sonic_SpecialSSpin, Low)
    .game_acmd("game_specialhi", game_sonic_SpecialHi, Low)
    .game_acmd("game_speciallwhold", game_sonic_SpecialLwHold, Low)
    .game_acmd("0x195dc47911", game_sonic_0x195dc47911, Low)
    .game_acmd("game_appealsr", game_sonic_AppealSR, Low)
    .game_acmd("game_appealsl", game_sonic_AppealSL, Low)
    .game_acmd("game_appealhir", game_sonic_AppealHiR, Low)
    .game_acmd("game_appealhil", game_sonic_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_sonic_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_sonic_AppealLwL, Low)
    .install();
}
