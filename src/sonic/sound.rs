...
unsafe fn sound_sonic_attackdash(fighter: &mut L2CAgentBase) {
	if WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) >= 8 && WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) <= 15 {//Knuckles
        frame(fighter.lua_state_agent, 4.0);
        if macros::is_excute(fighter) {
            macros::PLAY_SEQUENCE(fighter, Hash40::new("se_sonic_landing01"));
        }
...
unsafe fn sound_sonic_attacks4charge(fighter: &mut L2CAgentBase) {
    if WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) >= 8 && WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) <= 15 {//Knuckles
        ...
        if macros::is_excute(fighter) {
            macros::PLAY_SE(fighter, Hash40::new("se_common_smash_start"));
            macros::PLAY_STATUS(fighter, Hash40::new("se_sonic_smash_s01"));
        }
        frame(fighter.lua_state_agent, 61.0);
        if macros::is_excute(fighter) {
            macros::STOP_SE(fighter, Hash40::new("se_sonic_smash_s01"));
        }
    }
}
...
unsafe fn sound_sonic_attackhi4(fighter: &mut L2CAgentBase) {
	if WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) >= 8 && WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) <= 15 {//Knuckles
        if macros::is_excute(fighter) {
            macros::STOP_SE(fighter, Hash40::new_raw(0x13589f8893));
        }
...
unsafe fn sound_sonic_attacklw4(fighter: &mut L2CAgentBase) {
    if WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) >= 8 && WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) <= 15 {//Knuckles
        ...
        if macros::is_excute(fighter) {
            macros::PLAY_SE(fighter, Hash40::new("vc_sonic_attack07"));
            macros::PLAY_STATUS(fighter, Hash40::new("se_sonic_smash_h01"));
        }
        frame(fighter.lua_state_agent, 30.0);
        if macros::is_excute(fighter) {
            macros::PLAY_SE(fighter, Hash40::new("se_sonic_landing02"));
...
unsafe fn sound_sonic_attackairhi(fighter: &mut L2CAgentBase) {
    if WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) >= 8 && WorkModule::get_int(fighter.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR) <= 15 {//Knuckles
        ...
        wait(fighter.lua_state_agent, 8.0);
        if macros::is_excute(fighter) {
            macros::PLAY_SE(fighter, Hash40::new("se_sonic_attackair_h01"));
        }
    }
}
