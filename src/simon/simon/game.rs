...
pub fn install() {
    Agent::new("simon")
    .game_acmd("game_attack11", game_simon_Attack11)
    .game_acmd("game_attack12", game_simon_Attack12)
    .game_acmd("game_attack100", game_simon_Attack100)
    .game_acmd("game_attack100sub", game_simon_Attack100Sub)
    .game_acmd("game_attack100end", game_simon_Attack100End)
    .game_acmd("game_attackdash", game_simon_AttackDash)
    .game_acmd("game_attacks3", game_simon_AttackS3)
    .game_acmd("game_attackhi3", game_simon_AttackHi3)
    .game_acmd("game_attacklw3", game_simon_AttackLw3)
    .game_acmd("game_attacklw32", game_simon_AttackLw32)
    .game_acmd("game_attacks4hi", game_simon_AttackS4Hi)
    .game_acmd("game_attacks4", game_simon_AttackS4)
    .game_acmd("game_attacks4lw", game_simon_AttackS4Lw)
    .game_acmd("game_attackhi4", game_simon_AttackHi4)
    .game_acmd("game_attacklw4", game_simon_AttackLw4)
    .game_acmd("game_attackairn", game_simon_AttackAirN)
    .game_acmd("game_attackairfhi", game_simon_AttackAirFHi) 
    .game_acmd("game_attackairf", game_simon_AttackAirF) 
    .game_acmd("game_attackairflw", game_simon_AttackAirFLw) 
    .game_acmd("game_attackairbhi", game_simon_AttackAirBHi)   
    .game_acmd("game_attackairb", game_simon_AttackAirB)
    .game_acmd("game_attackairblw", game_simon_AttackAirBLw)
    .game_acmd("game_attackairhi", game_simon_AttackAirHi)
    .game_acmd("game_attackairlw", game_simon_AttackAirLw)
    .game_acmd("game_catch", game_simon_Catch)
    .game_acmd("game_catchdash", game_simon_CatchDash)
    .game_acmd("game_catchturn", game_simon_CatchTurn)
    .game_acmd("game_catchattack", game_simon_CatchAttack)
    .game_acmd("game_throwf", game_simon_ThrowF)
    .game_acmd("game_throwb", game_simon_ThrowB)
    .game_acmd("game_throwhi", game_simon_ThrowHi)
    .game_acmd("game_throwlw", game_simon_ThrowLw)
    .game_acmd("game_downattackd", game_simon_DownAttackD)
    .game_acmd("game_downattacku", game_simon_DownAttackU)
    .game_acmd("game_cliffattack", game_simon_CliffAttack)
    .game_acmd("game_slipattack", game_simon_SlipAttack)
    .game_acmd("game_specialn", game_simon_SpecialN)  
    .game_acmd("game_specialairn", game_simon_SpecialAirN)
    .game_acmd("game_specials1", game_simon_SpecialS1)  
    .game_acmd("game_specials2", game_simon_SpecialS2)  
    .game_acmd("game_specialairs1", game_simon_SpecialAirS1)
    .game_acmd("game_specialairs2", game_simon_SpecialAirS2)
    .game_acmd("game_specialhi", game_simon_SpecialHi)
    .game_acmd("game_specialairhi", game_simon_SpecialAirHi)
    .game_acmd("game_speciallw", game_simon_SpecialLw)
    .game_acmd("game_specialairlw", game_simon_SpecialAirLw)
    .game_acmd("game_appealsr", game_simon_AppealSR)
    .game_acmd("game_appealsl", game_simon_AppealSL)
    .game_acmd("game_appealhir", game_simon_AppealHiR)
    .game_acmd("game_appealhil", game_simon_AppealHiL)
    .game_acmd("game_appeallwr", game_simon_AppealLwR)
    .game_acmd("game_appeallwl", game_simon_AppealLwL)
    .game_acmd("game_finalend", game_simon_FinalEnd)
    .game_acmd("game_finalairend", game_simon_FinalAirEnd)
    .install();
}