...
pub unsafe extern "C" fn frame_younglink_Main(fighter: &mut L2CFighterCommon) {
    ...
    ModelModule::set_joint_scale(fighter.module_accessor, Hash40::new("sword"), &Vector3f{x: 1.0, y: 1.1, z: 1.0});
...
pub fn install() {
    Agent::new("younglink")
    .on_line(Main, frame_younglink_Main)
    .install();
}