...
//Fly
unsafe extern "C" fn game_younglink_boomerang_Fly(fighter: &mut L2CAgentBase) {
...
//Turn
unsafe extern "C" fn game_younglink_boomerang_Turn(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    ...
    .game_acmd("game_fly", game_younglink_boomerang_Fly, Low)
    .game_acmd("game_turn", game_younglink_boomerang_Turn, Low)
    .install();
}