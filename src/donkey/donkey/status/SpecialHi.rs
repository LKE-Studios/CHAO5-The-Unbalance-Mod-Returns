...
unsafe extern "C" fn status_donkey_SpecialHi_Pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn status_donkey_SpecialHi_Init(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    Agent::new("donkey")
    .status(Pre, *FIGHTER_STATUS_KIND_SPECIAL_HI, status_donkey_SpecialHi_Pre)
    .status(Init, *FIGHTER_STATUS_KIND_SPECIAL_HI, status_donkey_SpecialHi_Init)
