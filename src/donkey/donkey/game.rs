...
pub fn install() {
    Agent::new("donkey")
    .game_acmd("game_attack11", game_donkey_Attack11)
    .game_acmd("game_attack12", game_donkey_Attack12)
    .game_acmd("game_attackdash", game_donkey_AttackDash)
    .game_acmd("game_attacks3hi", game_donkey_AttackS3Hi)
    .game_acmd("game_attacks3", game_donkey_AttackS3)
    .game_acmd("game_attacks3lw", game_donkey_AttackS3Lw)
    .game_acmd("game_attackhi3", game_donkey_AttackHi3)
    .game_acmd("game_attacklw3", game_donkey_AttackLw3)
    .game_acmd("game_attacks4", game_donkey_AttackS4)
    .game_acmd("game_attackhi4", game_donkey_AttackHi4)
    .game_acmd("game_attacklw4", game_donkey_AttackLw4)
    .game_acmd("game_attackairn", game_donkey_AttackAirN)
    .game_acmd("game_attackairf", game_donkey_AttackAirF)    
    .game_acmd("game_attackairb", game_donkey_AttackAirB)
    .game_acmd("game_attackairhi", game_donkey_AttackAirHi)
    .game_acmd("game_attackairlw", game_donkey_AttackAirLw)
    .game_acmd("game_catch", game_donkey_Catch)
    .game_acmd("game_catchdash", game_donkey_CatchDash)
    .game_acmd("game_catchturn", game_donkey_CatchTurn)
    .game_acmd("game_catchattack", game_donkey_CatchAttack)
    .game_acmd("game_throwf", game_donkey_ThrowF)
    .game_acmd("game_throwff", game_donkey_ThrowFF)
    .game_acmd("game_throwfb", game_donkey_ThrowFB)
    .game_acmd("game_throwfhi", game_donkey_ThrowFHi)
    .game_acmd("game_throwflw", game_donkey_ThrowFLw)
    .game_acmd("game_throwb", game_donkey_ThrowB)
    .game_acmd("game_throwhi", game_donkey_ThrowHi)
    .game_acmd("game_throwlw", game_donkey_ThrowLw)
    .game_acmd("game_downattackd", game_donkey_DownAttackD)
    .game_acmd("game_downattacku", game_donkey_DownAttackU)
    .game_acmd("game_cliffattack", game_donkey_CliffAttack)
    .game_acmd("game_slipattack", game_donkey_SlipAttack)
    .game_acmd("game_specialn", game_donkey_SpecialN)
    .game_acmd("game_specialnmax", game_donkey_SpecialNMax)
    .game_acmd("game_specialairn", game_donkey_SpecialAirN)
    .game_acmd("game_specialairnmax", game_donkey_SpecialAirNMax)
    .game_acmd("game_specials", game_donkey_SpecialS)
    .game_acmd("game_specialairss", game_donkey_SpecialAirS)
    .game_acmd("game_specialhi", game_donkey_SpecialHi)
    .game_acmd("game_specialhi2", game_donkey_SpecialHi2)
    .game_acmd("game_specialairhi", game_donkey_SpecialAirHi)
    .game_acmd("game_speciallwloop", game_donkey_SpecialLwLoop)
    .game_acmd("game_specialairlw", game_donkey_SpecialAirLw)
    .game_acmd("game_appealsr", game_donkey_AppealSR)
    .game_acmd("game_appealsl", game_donkey_AppealSL)
    .game_acmd("game_appealhir", game_donkey_AppealHiR)
    .game_acmd("game_appealhil", game_donkey_AppealHiL)
    .game_acmd("game_appeallwr", game_donkey_AppealLwR)
    .game_acmd("game_appeallwl", game_donkey_AppealLwL)
    .game_acmd("game_appeallwr2", game_donkey_AppealLwR2)
    .game_acmd("game_appeallwl2", game_donkey_AppealLwL2)
