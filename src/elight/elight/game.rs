...
pub fn install() {
    Agent::new("elight")
    .game_acmd("game_attack11", game_elight_Attack11, Low)
    .game_acmd("game_attack12", game_elight_Attack12, Low)
    .game_acmd("game_attack13", game_elight_Attack13, Low)
    .game_acmd("game_attack100", game_elight_Attack100, Low)
    .game_acmd("game_attack100sub", game_elight_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_elight_Attack100End, Low)
    .game_acmd("game_attackdash", game_elight_AttackDash, Low)
    .game_acmd("game_attacks3", game_elight_AttackS3, Low)
    .game_acmd("game_attackhi3", game_elight_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_elight_AttackLw3, Low)
    .game_acmd("game_attacks4", game_elight_AttackS4, Low)
    .game_acmd("game_attackhi4", game_elight_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_elight_AttackLw4, Low)
    .game_acmd("game_attackairn", game_elight_AttackAirN, Low)
    .game_acmd("game_attackairf", game_elight_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_elight_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_elight_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_elight_AttackAirLw, Low)
    .game_acmd("game_catch", game_elight_Catch, Low)
    .game_acmd("game_catchdash", game_elight_CatchDash, Low)
    .game_acmd("game_catchturn", game_elight_CatchTurn, Low)
    .game_acmd("game_catchattack", game_elight_CatchAttack, Low)
    .game_acmd("game_throwf", game_elight_ThrowF, Low)
    .game_acmd("game_throwb", game_elight_ThrowB, Low)
    .game_acmd("game_throwhi", game_elight_ThrowHi, Low)
    .game_acmd("game_throwlw", game_elight_ThrowLw, Low)
    .game_acmd("game_downattackd", game_elight_DownAttackD, Low)
    .game_acmd("game_downattacku", game_elight_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_elight_CliffAttack, Low)
    .game_acmd("game_slipattack", game_elight_SlipAttack, Low)
    .game_acmd("game_specialn", game_elight_SpecialN, Low)
    .game_acmd("game_specialairn", game_elight_SpecialAirN, Low)
    .game_acmd("game_specialn2", game_elight_SpecialN2, Low)
    .game_acmd("game_specialairn2", game_elight_SpecialAirN2, Low)
    .game_acmd("game_specialnhold", game_elight_SpecialNHold, Low)
    .game_acmd("game_specialairnhold", game_elight_SpecialAirNHold, Low)
    .game_acmd("game_specialsstart", game_elight_SpecialSStart, Low)
    .game_acmd("game_specialairsstart", game_elight_SpecialAirSStart, Low)
    .game_acmd("game_specials", game_elight_SpecialS, Low)
    .game_acmd("game_specialairs", game_elight_SpecialAirS, Low)
    .game_acmd("game_specialsend", game_elight_SpecialSEnd, Low)
    .game_acmd("game_specialairsend", game_elight_SpecialAirSEnd, Low)
    .game_acmd("game_specialhistart", game_elight_SpecialHiStart, Low)
    .game_acmd("game_specialairhistart", game_elight_SpecialAirHiStart, Low)
    .game_acmd("game_specialairhijump", game_elight_SpecialAirHiJump, Low)
    .game_acmd("game_appealsr", game_elight_AppealSR, Low)
    .game_acmd("game_appealsl", game_elight_AppealSL, Low)
    .game_acmd("game_appealhir", game_elight_AppealHiR, Low)
    .game_acmd("game_appealhil", game_elight_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_elight_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_elight_AppealLwL, Low)
    .install();
}