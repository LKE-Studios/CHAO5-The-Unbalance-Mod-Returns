...
#[acmd_script(//Attack11
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack11(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//Attack12
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack12(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//Attack13
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack13(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//Attack100
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack100(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        macros::FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
#[acmd_script(//Attack100Sub
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack100sub(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 3.3, /*Angle*/ 361, /*KBG*/ 10, /*FKB*/ 0, /*BKB*/ 11, /*Size*/ 12.0, /*X*/ 0.0, /*Y*/ 9.0, /*Z*/ 16.0, /*X2*/ Some(0.0), /*Y2*/ Some(9.0), /*Z2*/ Some(8.0), /*Hitlag*/ 0.4, /*SDI*/ 0.6, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_MAGIC);
        AttackModule::set_add_reaction_frame(fighter.module_accessor, /*ID*/ 0, /*Frames*/ 2.0, /*Unk*/ false);
        macros::ATK_SET_SHIELD_SETOFF_MUL(fighter, /*ID*/ 0, /*ShieldstunMul*/ 3.0);
...
#[acmd_script(//Attack100End
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attack100end(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//AttackDash
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackdash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//AttackS3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attacks3(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackHi3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackhi3(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackLw3
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attacklw3(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackS4
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_reflet_attacks4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//AttackHi4
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackhi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
    ...
    if macros::is_excute(fighter) {
        ...
        if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_REFLET_INSTANCE_WORK_ID_FLAG_THUNDER_SWORD_ON) == false {
            macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("sword"), /*Damage*/ 22.2, /*Angle*/ 96, /*KBG*/ 84, /*FKB*/ 0, /*BKB*/ 45, /*Size*/ 8.2, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 0.0, /*X2*/ Some(0.0), /*Y2*/ Some(1.0), /*Z2*/ Some(0.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
        }
    }
    wait(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//AttackHi42
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackhi42(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script(//AttackLw4
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attacklw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script(//AttackAirN
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackairn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 4.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//AttackAirF 
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackairf(fighter: &mut L2CAgentBase) {
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 4.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
#[acmd_script(//AttackAirB
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackairb(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AttackAirHi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackairhi(fighter: &mut L2CAgentBase) {
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 5.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
#[acmd_script(//AttackAirLw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_attackairlw(fighter: &mut L2CAgentBase) {
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.53);
    frame(fighter.lua_state_agent, 2.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
#[acmd_script(//Catch
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//CatchDash
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_catchdash(fighter: &mut L2CAgentBase) {  
    frame(fighter.lua_state_agent, 9.0);
    if macros::is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
#[acmd_script(//CatchTurn
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_catchturn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if macros::is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
#[acmd_script(//CatchAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_catchattack(fighter: &mut L2CAgentBase) {
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//ThrowF
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_throwf(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 14.0, /*Angle*/ 45, /*KBG*/ 55, /*FKB*/ 0, /*BKB*/ 95, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_magic"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
...
#[acmd_script(//ThrowB
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_throwb(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 17.0, /*Angle*/ 52, /*KBG*/ 58, /*FKB*/ 0, /*BKB*/ 85, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_magic"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, /*ID*/ 0, /*Damage*/ 3.0, /*Angle*/ 361, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 40, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
    }
    frame(fighter.lua_state_agent, 24.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//ThrowHi
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_throwhi(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 16.0, /*Angle*/ 93, /*KBG*/ 52, /*FKB*/ 0, /*BKB*/ 75, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_magic"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, /*ID*/ 0, /*Damage*/ 3.0, /*Angle*/ 361, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 40, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
    }
    frame(fighter.lua_state_agent, 14.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//ThrowLw
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_throwlw(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//CliffAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_cliffattack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 25.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//SlipAttack
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_slipattack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 20.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//DownAttackD
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_downattackd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if macros::is_excute(fighter) {
...
#[acmd_script(//DownAttackU
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_downattacku(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 14.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 15.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ 11.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
    }
...
#[acmd_script(//Shoot0
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_thunder_shoot0(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Shoot1
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_thunder_shoot1(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Shoot2
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_thunder_shoot2(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//GigaSpark
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_thunder_gigaspark(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        ControlModule::set_rumble(fighter.module_accessor, Hash40::new("rbkind_nohit_beamm"), 0, false, 0);
...
#[acmd_script(//Tron0
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_thunder_tron0(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Shoot0
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_gigafire_shoot0(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Burn
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_gigafire_burn(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Rise
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_gigafire_rise(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::QUAKE(fighter, *CAMERA_QUAKE_KIND_S);
...
#[acmd_script(//Vanish
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_gigafire_vanish(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//SpecialS
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_reflet_specials(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//SpecialAirS
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_reflet_specialairs(fighter: &mut L2CAgentBase) {
    macros::FT_MOTION_RATE(fighter, /*FSM*/ 0.64);
    frame(fighter.lua_state_agent, 17.0);
    if macros::is_excute(fighter) {
	    WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_REFLET_STATUS_SPECIAL_S_FLAG_TRY);
...
#[acmd_script(//Shoot0
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_elwind_shoot0(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//Shoot1
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_elwind_shoot1(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//SpecialLwCapture
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_reflet_speciallwcapture(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//SpecialAirLwCapture
    ...
    category = ACMD_GAME,
    low_priority )]
unsafe fn game_reflet_specialairlwcapture(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, /*ID*/ 0, /*Damage*/ 0.0, /*Angle*/ 60, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 0, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
    }
    wait(fighter.lua_state_agent, 6.0);
...
#[acmd_script(//AppealHiR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appealhir(fighter: &mut L2CAgentBase) {
...
#[acmd_script(//AppealHiL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appealhil(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 15.0, /*Angle*/ 0, /*KBG*/ 0, /*FKB*/ 0, /*BKB*/ 0, /*Size*/ 150.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.0, /*SDI*/ 0.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ true, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_flower"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_BODY);
        DamageModule::heal(fighter.module_accessor, -30.0, 0);
...
#[acmd_script(//AppealSR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appealsr(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//AppealSL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appealsl(fighter: &mut L2CAgentBase) {  
    if macros::is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_DEATHSCYTHE), 0, 0, false, false);
    }
}
...
#[acmd_script(//AppealLwR
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appeallwr(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script(//AppealLwL
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_appeallwl(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 25.0, /*Angle*/ 270, /*KBG*/ 50, /*FKB*/ 0, /*BKB*/ 90, /*Size*/ 13.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 3.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 6, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ false, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_sleep"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_NONE);
    }
}
...
#[acmd_script(//Final
    ...
    category = ACMD_GAME, 
    low_priority )]
unsafe fn game_reflet_final(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
        game_reflet_attack11,
        game_reflet_attack12,
        game_reflet_attack13,
        game_reflet_attack100,
        game_reflet_attack100sub,
        game_reflet_attack100end,
        game_reflet_attackdash,
        game_reflet_attacks3,
        game_reflet_attackhi3,
        game_reflet_attacklw3,
        game_reflet_attacks4,
        game_reflet_attackhi4,
        game_reflet_attackhi42,
        game_reflet_attacklw4,
        game_reflet_attackairn,
        game_reflet_attackairf,
        game_reflet_attackairb,
        game_reflet_attackairhi,
        game_reflet_attackairlw,
        game_reflet_catch,
        game_reflet_catchdash,
        game_reflet_catchturn,
        game_reflet_catchattack,
        game_reflet_throwf,
        game_reflet_throwb,
        game_reflet_throwhi,
        game_reflet_throwlw,
        game_reflet_downattacku,
        game_reflet_downattackd,
        game_reflet_cliffattack,
        game_reflet_slipattack,
        game_reflet_thunder_shoot0,
        game_reflet_thunder_shoot1,
        game_reflet_thunder_shoot2,
        game_reflet_thunder_gigaspark,
        game_reflet_thunder_tron0,
        game_reflet_gigafire_shoot0,
        game_reflet_gigafire_burn,
        game_reflet_gigafire_rise,
        game_reflet_gigafire_vanish,
        game_reflet_specials,
        game_reflet_specialairs,
        game_reflet_elwind_shoot0,
        game_reflet_elwind_shoot1,
        game_reflet_speciallwcapture,
        game_reflet_specialairlwcapture,
        game_reflet_appealsr,
        game_reflet_appealsl,
        game_reflet_appealhir,
        game_reflet_appealhil,
        game_reflet_appeallwr,
        game_reflet_appeallwl,
        game_reflet_final
    );
}
