...
pub fn install() {
    Agent::new("reflet")
    .game_acmd("game_attack11", game_reflet_Attack11, Low)
    .game_acmd("game_attack12", game_reflet_Attack12, Low)
    .game_acmd("game_attack13", game_reflet_Attack13, Low)
    .game_acmd("game_attack100", game_reflet_Attack100, Low)
    .game_acmd("game_attack100sub", game_reflet_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_reflet_Attack100End, Low)
    .game_acmd("game_attackdash", game_reflet_AttackDash, Low)
    .game_acmd("game_attacks3", game_reflet_AttackS3, Low)
    .game_acmd("game_attackhi3", game_reflet_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_reflet_AttackLw3, Low)
    .game_acmd("game_attacks4", game_reflet_AttackS4, Low)
    .game_acmd("game_attackhi4", game_reflet_AttackHi4, Low)
    .game_acmd("game_attackhi42", game_reflet_AttackHi42, Low)
    .game_acmd("game_attacklw4", game_reflet_AttackLw4, Low)
    .game_acmd("game_attackairn", game_reflet_AttackAirN, Low)
    .game_acmd("game_attackairf", game_reflet_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_reflet_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_reflet_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_reflet_AttackAirLw, Low)
    .game_acmd("game_catch", game_reflet_Catch, Low)
    .game_acmd("game_catchdash", game_reflet_CatchDash, Low)
    .game_acmd("game_catchturn", game_reflet_CatchTurn, Low)
    .game_acmd("game_catchattack", game_reflet_CatchAttack, Low)
    .game_acmd("game_throwf", game_reflet_ThrowF, Low)
    .game_acmd("game_throwb", game_reflet_ThrowB, Low)
    .game_acmd("game_throwhi", game_reflet_ThrowHi, Low)
    .game_acmd("game_throwlw", game_reflet_ThrowLw, Low)
    .game_acmd("game_downattackd", game_reflet_DownAttackD, Low)
    .game_acmd("game_downattacku", game_reflet_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_reflet_CliffAttack, Low)
    .game_acmd("game_slipattack", game_reflet_SlipAttack, Low)
    .game_acmd("game_specials", game_reflet_SpecialS, Low)  
    .game_acmd("game_specialairs", game_reflet_SpecialAirS, Low)
    .game_acmd("game_specialhi", game_reflet_SpecialHi, Low)
    .game_acmd("game_specialhi2", game_reflet_SpecialHi2, Low)
    .game_acmd("game_specialairhi", game_reflet_SpecialAirHi, Low)
    .game_acmd("game_specialairhi2", game_reflet_SpecialAirHi2, Low)
    .game_acmd("game_speciallwcapture", game_reflet_SpecialLwCapture, Low)
    .game_acmd("game_specialairlwcapture", game_reflet_SpecialAirLwCapture, Low)
    .game_acmd("game_appealsr", game_reflet_AppealSR, Low)
    .game_acmd("game_appealsl", game_reflet_AppealSL, Low)
    .game_acmd("game_appealhir", game_reflet_AppealHiR, Low)
    .game_acmd("game_appealhil", game_reflet_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_reflet_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_reflet_AppealLwL, Low)
    .game_acmd("game_final", game_reflet_Final, Low)
    .install();
}
