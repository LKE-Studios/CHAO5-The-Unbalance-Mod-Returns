...
pub fn install() {
    Agent::new("marth")
    .game_acmd("game_attack11", game_marth_Attack11)
    .game_acmd("game_attack12", game_marth_Attack12)
    .game_acmd("game_attackdash", game_marth_AttackDash)
    .game_acmd("game_attacks3", game_marth_AttackS3)
    .game_acmd("game_attackhi3", game_marth_AttackHi3)
    .game_acmd("game_attacklw3", game_marth_AttackLw3)
    .game_acmd("game_attacks4", game_marth_AttackS4)
    .game_acmd("game_attackhi4", game_marth_AttackHi4)
    .game_acmd("game_attacklw4", game_marth_AttackLw4)
    .game_acmd("game_attackairn", game_marth_AttackAirN)
    .game_acmd("game_attackairf", game_marth_AttackAirF)    
    .game_acmd("game_attackairb", game_marth_AttackAirB)
    .game_acmd("game_attackairhi", game_marth_AttackAirHi)
    .game_acmd("game_attackairlw", game_marth_AttackAirLw)
    .game_acmd("game_catch", game_marth_Catch)
    .game_acmd("game_catchturn", game_marth_CatchTurn)
    .game_acmd("game_catchdash", game_marth_CatchDash)
    .game_acmd("game_catchattack", game_marth_CatchAttack)
    .game_acmd("game_throwf", game_marth_ThrowF)
    .game_acmd("game_throwb", game_marth_ThrowB)
    .game_acmd("game_throwhi", game_marth_ThrowHi)
    .game_acmd("game_throwlw", game_marth_ThrowLw)
    .game_acmd("game_downattackd", game_marth_DownAttackD)
    .game_acmd("game_downattacku", game_marth_DownAttackU)
    .game_acmd("game_cliffattack", game_marth_CliffAttack)
    .game_acmd("game_slipattack", game_marth_SlipAttack)
    .game_acmd("game_specialnend", game_marth_SpecialNEnd)
    .game_acmd("game_specialnendhi", game_marth_SpecialNEndHi)
    .game_acmd("game_specialnendlw", game_marth_SpecialNEndLw)
    .game_acmd("game_specialairnend", game_marth_SpecialAirNEnd)
    .game_acmd("game_specialairnendhi", game_marth_SpecialAirNEndHi)
    .game_acmd("game_specialairnendlw", game_marth_SpecialAirNEndLw)
    .game_acmd("game_specialnendmax", game_marth_SpecialNEndMax)
    .game_acmd("game_specialnendmaxhi", game_marth_SpecialNEndMaxHi)
    .game_acmd("game_specialnendmaxlw", game_marth_SpecialNEndMaxLw)
    .game_acmd("game_specialairnendmax", game_marth_SpecialAirNEndMax)
    .game_acmd("game_specialairnendmaxhi", game_marth_SpecialAirNEndMaxHi)
    .game_acmd("game_specialairnendmaxlw", game_marth_SpecialAirNEndMaxLw)
    .game_acmd("game_specials4hi", game_marth_SpecialS4Hi)
    .game_acmd("game_specials4s", game_marth_SpecialS4S)
    .game_acmd("game_specials4lw", game_marth_SpecialS4Lw)
    .game_acmd("game_specialairs4hi", game_marth_SpecialAirS4Hi)
    .game_acmd("game_specialairs4s", game_marth_SpecialAirS4S)
    .game_acmd("game_specialairs4lw", game_marth_SpecialAirS4Lw)
    .game_acmd("game_specialhi", game_marth_SpecialHi)
    .game_acmd("game_specialairhi", game_marth_SpecialAirHi)
    .game_acmd("game_appealsr", game_marth_AppealSR)
    .game_acmd("game_appealsl", game_marth_AppealSL)
    .game_acmd("game_appealhir", game_marth_AppealHiR)
    .game_acmd("game_appealhil", game_marth_AppealHiL)
    .game_acmd("game_appeallwr", game_marth_AppealLwR)
    .game_acmd("game_appeallwl", game_marth_AppealLwL)
    .game_acmd("game_finalend", game_marth_FinalEnd)
    .game_acmd("game_finalairend", game_marth_FinalAirEnd)
    .install();
}
