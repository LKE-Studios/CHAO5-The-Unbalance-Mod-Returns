...
pub fn install() {
    Agent::new("link")
    .expression_acmd("expression_ascendjump", expression_link_AscendJump, Low)
    .expression_acmd("expression_ascendairjump", expression_link_AscendAirJump, Low)
    .expression_acmd("expression_ascendstart", expression_link_AscendStart, Low)
    .expression_acmd("expression_ascend", expression_link_Ascend, Low)
    .expression_acmd("expression_ascendend", expression_link_AscendEnd, Low)
    .expression_acmd("expression_revaliglideturn", expression_link_RevaliGlideTurn, Low)
    .expression_acmd("expression_revaliglidedrop", expression_link_RevaliGlideDrop, Low)
    .expression_acmd("expression_revaliglidelanding", expression_link_RevaliGlideLanding, Low)
    .expression_acmd("expression_attachwall", expression_link_AttachWall, Low)
    .expression_acmd("expression_attachwallclimb", expression_link_AttachWallClimb, Low)
    .install();
}