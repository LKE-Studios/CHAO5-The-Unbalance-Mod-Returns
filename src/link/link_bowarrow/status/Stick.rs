...
unsafe extern "C" fn status_link_bowarrow_Stick_End(weapon: &mut L2CFighterBase) -> L2CValue {
...
pub fn install() {
    ...
    .status(End, *WN_LINK_BOWARROW_STATUS_KIND_STICK, status_link_bowarrow_Stick_End)
    .install();
}