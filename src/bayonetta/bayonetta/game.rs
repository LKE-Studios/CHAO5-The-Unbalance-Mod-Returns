...
pub fn install() {
    ...
    .game_acmd("game_speciallw", game_bayonetta_SpecialLw)
    .game_acmd("game_specialairlw", game_bayonetta_SpecialAirLw)
    ...
    .game_acmd("game_shootingarml_atkon_attack11", game_bayonetta_ShootingArmL_AtkOn_Attack11)
    .game_acmd("game_shootingarml_atkon_attack12", game_bayonetta_ShootingArmL_AtkOn_Attack12)
    .game_acmd("game_shootingarml_atkon_attack13", game_bayonetta_ShootingArmL_AtkOn_Attack13)
    .game_acmd("game_shootingarml_atkon_attack100", game_bayonetta_ShootingArmL_AtkOn_Attack100)
    .game_acmd("game_shootingarml_atkon_attacklw3", game_bayonetta_ShootingArmL_AtkOn_AttackLw3)
    .game_acmd("game_shootingarml_atkon_attackhi4", game_bayonetta_ShootingArmL_AtkOn_AttackHi4)
    .game_acmd("game_shootingarml_atkon_attackairf", game_bayonetta_ShootingArmL_AtkOn_AttackAirF)
    .game_acmd("game_shootingarml_atkon_attackairf2", game_bayonetta_ShootingArmL_AtkOn_AttackAirF2)
    .game_acmd("game_shootingarml_atkon_attackairf3", game_bayonetta_ShootingArmL_AtkOn_AttackAirF3)
    .game_acmd("game_shootingarml_atkon_attackairhi", game_bayonetta_ShootingArmL_AtkOn_AttackAirHi)
    .game_acmd("game_shootingarml_atkon_specialairhi", game_bayonetta_ShootingArmL_AtkOn_SpecialAirHi)
    .game_acmd("game_shootingarml_atkon_specialhi", game_bayonetta_ShootingArmL_AtkOn_SpecialHi)
    .game_acmd("game_shootingarmr_atkon_attack100", game_bayonetta_ShootingArmR_AtkOn_Attack100)
    .game_acmd("game_shootingarmr_atkon_attack100end", game_bayonetta_ShootingArmR_AtkOn_Attack100End)
    .game_acmd("game_shootingarmr_atkon_attack13", game_bayonetta_ShootingArmR_AtkOn_Attack13)
    .game_acmd("game_shootingarmr_atkon_attackdash", game_bayonetta_ShootingArmR_AtkOn_AttackDash)
    .game_acmd("game_shootingarmr_atkon_attackhi3", game_bayonetta_ShootingArmR_AtkOn_AttackHi3)
    .game_acmd("game_shootingarmr_atkon_attacks4", game_bayonetta_ShootingArmR_AtkOn_AttackS4)
    .game_acmd("game_shootingarmr_atkon_attacks4hi", game_bayonetta_ShootingArmR_AtkOn_AttackS4Hi)
    .game_acmd("game_shootingarmr_atkon_attacks4lw", game_bayonetta_ShootingArmR_AtkOn_AttackS4Lw)
    .game_acmd("game_shootingarmr_atkon_attackhi4", game_bayonetta_ShootingArmR_AtkOn_AttackHi4)
    .game_acmd("game_shootingarmr_atkon_attackairf3", game_bayonetta_ShootingArmR_AtkOn_AttackAirF3)
    .game_acmd("game_shootingarmr_atkon_attackairhi", game_bayonetta_ShootingArmR_AtkOn_AttackAirHi)
    .game_acmd("game_shootingarmr_atkon_specialairhi", game_bayonetta_ShootingArmR_AtkOn_SpecialAirHi)
    .game_acmd("game_shootingarmr_atkon_specialhi", game_bayonetta_ShootingArmR_AtkOn_SpecialHi)
    .game_acmd("game_shootinglegl_atkon_attacks32", game_bayonetta_ShootingLegL_AtkOn_AttackS32)
    .game_acmd("game_shootinglegl_atkon_attacklw3", game_bayonetta_ShootingLegL_AtkOn_AttackLw3)
    .game_acmd("game_shootinglegl_atkon_attackairb", game_bayonetta_ShootingLegL_AtkOn_AttackAirB)
    .game_acmd("game_shootinglegl_atkon_attackairf3", game_bayonetta_ShootingLegL_AtkOn_AttackAirF3)
    .game_acmd("game_shootinglegl_atkon_attackairhi", game_bayonetta_ShootingLegL_AtkOn_AttackAirHi)
    .game_acmd("game_shootinglegl_atkon_landingairlw", game_bayonetta_ShootingLegL_AtkOn_LandingAirLw)
    .game_acmd("game_shootinglegl_atkon_attacklw4", game_bayonetta_ShootingLegL_AtkOn_AttackLw4)
    .game_acmd("game_shootinglegl_atkon_specialairsu", game_bayonetta_ShootingLegL_AtkOn_SpecialAirSU)
    .game_acmd("game_shootinglegl_atkon_specialairhi", game_bayonetta_ShootingLegL_AtkOn_SpecialAirHi)
    .game_acmd("game_shootinglegl_atkon_specialhi", game_bayonetta_ShootingLegL_AtkOn_SpecialHi)
    .game_acmd("game_shootinglegr_atkon_attacks3", game_bayonetta_ShootingLegR_AtkOn_AttackS3)
    .game_acmd("game_shootinglegr_atkon_attacks33", game_bayonetta_ShootingLegR_AtkOn_AttackS33)
    .game_acmd("game_shootinglegr_atkon_attacklw3", game_bayonetta_ShootingLegR_AtkOn_AttackLw3)
    .game_acmd("game_shootinglegr_atkon_attacklw4", game_bayonetta_ShootingLegR_AtkOn_AttackLw4)
    .game_acmd("game_shootinglegr_atkon_attackairf3", game_bayonetta_ShootingLegR_AtkOn_AttackAirF3)
    .game_acmd("game_shootinglegr_atkon_attackairhi", game_bayonetta_ShootingLegR_AtkOn_AttackAirHi)
    .game_acmd("game_shootinglegr_atkon_specials", game_bayonetta_ShootingLegR_AtkOn_SpecialS)
    .game_acmd("game_shootinglegr_atkon_specialsholdend", game_bayonetta_ShootingLegR_AtkOn_SpecialSHoldEnd)
    .game_acmd("game_shootinglegr_atkon_specialairsu", game_bayonetta_ShootingLegR_AtkOn_SpecialAirSU)
    .game_acmd("game_shootinglegr_atkon_specialairhi", game_bayonetta_ShootingLegR_AtkOn_SpecialAirHi)
    .game_acmd("game_shootinglegr_atkon_specialhi", game_bayonetta_ShootingLegR_AtkOn_SpecialHi)
    .install();
}