...
pub fn install() {
    Agent::new("bayonetta")
    .game_acmd("game_attack11", game_bayonetta_Attack11)
    .game_acmd("game_attack12", game_bayonetta_Attack12)
    .game_acmd("game_attack13", game_bayonetta_Attack13)
    .game_acmd("game_attack100", game_bayonetta_Attack100)
    .game_acmd("game_attack100loop", game_bayonetta_Attack100Loop)
    .game_acmd("game_attack100loopsub", game_bayonetta_Attack100LoopSub)
    .game_acmd("game_attack100end", game_bayonetta_Attack100End)
    .game_acmd("game_attackdash", game_bayonetta_AttackDash)
    .game_acmd("game_attacks3", game_bayonetta_AttackS3)
    .game_acmd("game_attacks32", game_bayonetta_AttackS32)
    .game_acmd("game_attacks33", game_bayonetta_AttackS33)
    .game_acmd("game_attackhi3", game_bayonetta_AttackHi3)
    .game_acmd("game_attacklw3", game_bayonetta_AttackLw3)
    .game_acmd("game_attacks4hi", game_bayonetta_AttackS4Hi)
    .game_acmd("game_attacks4", game_bayonetta_AttackS4)
    .game_acmd("game_attacks4lw", game_bayonetta_AttackS4Lw)
    .game_acmd("game_attackairn", game_bayonetta_AttackAirN)
    .game_acmd("game_attackairnhold", game_bayonetta_AttackAirNHold)
    .game_acmd("game_attackairf", game_bayonetta_AttackAirF)
    .game_acmd("game_attackairf2", game_bayonetta_AttackAirF2)
    .game_acmd("game_attackairf3", game_bayonetta_AttackAirF3)
    .game_acmd("game_attackairb", game_bayonetta_AttackAirB)
    .game_acmd("game_attackairhi", game_bayonetta_AttackAirHi)
    .game_acmd("game_attackairhihold", game_bayonetta_AttackAirHiHold)
    .game_acmd("game_attackairlw", game_bayonetta_AttackAirLw)
    .game_acmd("game_landingairlw", game_bayonetta_LandingAirLw)
    .game_acmd("game_catch", game_bayonetta_Catch)
    .game_acmd("game_catchdash", game_bayonetta_CatchDash)
    .game_acmd("game_catchturn", game_bayonetta_CatchTurn)
    .game_acmd("game_catchattack", game_bayonetta_CatchAttack)
    .game_acmd("game_throwf", game_bayonetta_ThrowF)
    .game_acmd("game_throwb", game_bayonetta_ThrowB)
    .game_acmd("game_throwhi", game_bayonetta_ThrowHi)
    .game_acmd("game_throwlw", game_bayonetta_ThrowLw)
    .game_acmd("game_downattacku", game_bayonetta_DownAttackU)
    .game_acmd("game_downattackd", game_bayonetta_DownAttackD)
    .game_acmd("game_cliffattack", game_bayonetta_CliffAttack)
    .game_acmd("game_slipattack", game_bayonetta_SlipAttack)
    .game_acmd("game_specials", game_bayonetta_SpecialS)
    .game_acmd("game_specialsholdend", game_bayonetta_SpecialSHoldEnd)
    .game_acmd("game_specialairsd", game_bayonetta_SpecialAirSD)
    .game_acmd("game_specialairsdlanding", game_bayonetta_SpecialAirSDLanding)
    .game_acmd("game_specialairsu", game_bayonetta_SpecialAirSU)
    .game_acmd("game_specialhi", game_bayonetta_SpecialHi)
    .game_acmd("game_specialairhi", game_bayonetta_SpecialAirHi)
    .game_acmd("game_specialhi", game_bayonetta_SpecialLw)
    .game_acmd("game_specialairhi", game_bayonetta_SpecialAirLw)
    .game_acmd("game_appealsr", game_bayonetta_AppealSR)
    .game_acmd("game_appealsl", game_bayonetta_AppealSL)
    .game_acmd("game_appealhir", game_bayonetta_AppealHiR)
    .game_acmd("game_appealhil", game_bayonetta_AppealHiL)
    .game_acmd("game_appeallwr", game_bayonetta_AppealLwR)
    .game_acmd("game_appeallwl", game_bayonetta_AppealLwL)
    .game_acmd("game_bayonetta_shootingarml_atkon_attack11", game_bayonetta_ShootingArmL_AtkOn_Attack11)
    .game_acmd("game_bayonetta_shootingarml_atkon_attack12", game_bayonetta_ShootingArmL_AtkOn_Attack12)
    .game_acmd("game_bayonetta_shootingarml_atkon_attack13", game_bayonetta_ShootingArmL_AtkOn_Attack13)
    .game_acmd("game_bayonetta_shootingarml_atkon_attack100", game_bayonetta_ShootingArmL_AtkOn_Attack100)
    .game_acmd("game_bayonetta_shootingarml_atkon_attacklw3", game_bayonetta_ShootingArmL_AtkOn_AttackLw3)
    .game_acmd("game_bayonetta_shootingarml_atkon_attackhi4", game_bayonetta_ShootingArmL_AtkOn_AttackHi4)
    .game_acmd("game_bayonetta_shootingarml_atkon_attackairf", game_bayonetta_ShootingArmL_AtkOn_AttackAirF)
    .game_acmd("game_bayonetta_shootingarml_atkon_attackairf2", game_bayonetta_ShootingArmL_AtkOn_AttackAirF2)
    .game_acmd("game_bayonetta_shootingarml_atkon_attackairf3", game_bayonetta_ShootingArmL_AtkOn_AttackAirF3)
    .game_acmd("game_bayonetta_shootingarml_atkon_attackairhi", game_bayonetta_ShootingArmL_AtkOn_AttackAirHi)
    .game_acmd("game_bayonetta_shootingarml_atkon_specialairhi", game_bayonetta_ShootingArmL_AtkOn_SpecialAirHi)
    .game_acmd("game_bayonetta_shootingarml_atkon_specialhi", game_bayonetta_ShootingArmL_AtkOn_SpecialHi)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attack100", game_bayonetta_ShootingArmR_AtkOn_Attack100)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attack100end", game_bayonetta_ShootingArmR_AtkOn_Attack100End)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attack13", game_bayonetta_ShootingArmR_AtkOn_Attack13)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attackdash", game_bayonetta_ShootingArmR_AtkOn_AttackDash)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attackhi3", game_bayonetta_ShootingArmR_AtkOn_AttackHi3)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attacklw3", game_bayonetta_ShootingArmR_AtkOn_AttackLw3)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attacks4", game_bayonetta_ShootingArmR_AtkOn_AttackS4)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attacks4hi", game_bayonetta_ShootingArmR_AtkOn_AttackS4Hi)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attacks4lw", game_bayonetta_ShootingArmR_AtkOn_AttackS4Lw)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attackhi4", game_bayonetta_ShootingArmR_AtkOn_AttackHi4)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attackairf3", game_bayonetta_ShootingArmR_AtkOn_AttackAirF3)
    .game_acmd("game_bayonetta_shootingarmr_atkon_attackairhi", game_bayonetta_ShootingArmR_AtkOn_AttackAirHi)
    .game_acmd("game_bayonetta_shootingarmr_atkon_specialairhi", game_bayonetta_ShootingArmR_AtkOn_SpecialAirHi)
    .game_acmd("game_bayonetta_shootingarmr_atkon_specialhi", game_bayonetta_ShootingArmR_AtkOn_SpecialHi)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attacks32", game_bayonetta_ShootingLegL_AtkOn_AttackS32)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attacklw3", game_bayonetta_ShootingLegL_AtkOn_AttackLw3)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attackairb", game_bayonetta_ShootingLegL_AtkOn_AttackAirB)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attackairf3", game_bayonetta_ShootingLegL_AtkOn_AttackAirF3)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attackairhi", game_bayonetta_ShootingLegL_AtkOn_AttackAirHi)
    .game_acmd("game_bayonetta_shootinglegl_atkon_attacklw4", game_bayonetta_ShootingLegL_AtkOn_AttackLw4)
    .game_acmd("game_bayonetta_shootinglegl_atkon_specialairsu", game_bayonetta_ShootingLegL_AtkOn_SpecialAirSU)
    .game_acmd("game_bayonetta_shootinglegl_atkon_specialairhi", game_bayonetta_ShootingLegL_AtkOn_SpecialAirHi)
    .game_acmd("game_bayonetta_shootinglegl_atkon_specialhi", game_bayonetta_ShootingLegL_AtkOn_SpecialHi)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attacks3", game_bayonetta_ShootingLegR_AtkOn_AttackS3)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attacks33", game_bayonetta_ShootingLegR_AtkOn_AttackS33)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attacklw3", game_bayonetta_ShootingLegR_AtkOn_AttackLw3)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attacklw4", game_bayonetta_ShootingLegR_AtkOn_AttackLw4)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attackairf3", game_bayonetta_ShootingLegR_AtkOn_AttackAirF3)
    .game_acmd("game_bayonetta_shootinglegr_atkon_attackairhi", game_bayonetta_ShootingLegR_AtkOn_AttackAirHi)
    .game_acmd("game_bayonetta_shootinglegr_atkon_specials", game_bayonetta_ShootingLegR_AtkOn_SpecialS)
    .game_acmd("game_bayonetta_shootinglegr_atkon_specialsholdend", game_bayonetta_ShootingLegR_AtkOn_SpecialSHoldEnd)
    .game_acmd("game_bayonetta_shootinglegr_atkon_specialairsu", game_bayonetta_ShootingLegR_AtkOn_SpecialAirSU)
    .game_acmd("game_bayonetta_shootinglegr_atkon_specialairhi", game_bayonetta_ShootingLegR_AtkOn_SpecialAirHi)
    .game_acmd("game_bayonetta_shootinglegr_atkon_specialhi", game_bayonetta_ShootingLegR_AtkOn_SpecialHi)
    .install();
}