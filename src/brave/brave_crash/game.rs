...
//Crash1 [Magic Burst]
unsafe extern "C" fn game_brave_crash_Crash1(fighter: &mut L2CAgentBase) {
...
//Crash2 [Kamikazee]
unsafe extern "C" fn game_brave_crash_Crash2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::disable_tip(fighter.module_accessor);
    }
...
pub fn install() {
    ...
    .game_acmd("game_crash1", game_brave_crash_Crash1, Low)
    .game_acmd("game_crash2", game_brave_crash_Crash2, Low)
    .install();
}