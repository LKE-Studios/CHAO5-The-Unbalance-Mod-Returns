...
//SpecialN1
unsafe extern "C" fn game_brave_fireball_SpecialN1(fighter: &mut L2CAgentBase) {
...
//SpecialN2
unsafe extern "C" fn game_brave_fireball_SpecialN2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialN3
unsafe extern "C" fn game_brave_fireball_SpecialN3(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//BurstL
unsafe extern "C" fn game_brave_fireball_BurstL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
