...
//DeathBall1 [Whack]
unsafe extern "C" fn game_brave_deathball_Deathball1(fighter: &mut L2CAgentBase) {
...
//DeathBall2 [Thwack]
unsafe extern "C" fn game_brave_deathball_Deathball2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::disable_tip(fighter.module_accessor);
    }
...
pub fn install() {
    ...
    .game_acmd("game_deathball1", game_brave_explosion_Deathball1)
    .game_acmd("game_deathball2", game_brave_explosion_Deathball2)
    .install();
}