...
pub fn install() {
    Agent::new("brave")
    .game_acmd("game_attack11", game_brave_Attack11)
    .game_acmd("game_attack12", game_brave_Attack12)
    .game_acmd("game_attack13", game_brave_Attack13)
    .game_acmd("game_attackdash", game_brave_AttackDash)
    .game_acmd("game_attacks3", game_brave_AttackS3)
    .game_acmd("game_attacks3s2", game_brave_AttackS3S2)
    .game_acmd("game_attackhi3", game_brave_AttackHi3)
    .game_acmd("game_attacklw3", game_brave_AttackLw3)
    .game_acmd("game_attacks4", game_brave_AttackS4)
    .game_acmd("game_attackhi4", game_brave_AttackHi4)
    .game_acmd("game_attacklw4", game_brave_AttackLw4)
    .game_acmd("game_attackairn", game_brave_AttackAirN)
    .game_acmd("game_attackairf", game_brave_AttackAirF)
    .game_acmd("game_attackairb", game_brave_AttackAirB)
    .game_acmd("game_attackairhi", game_brave_AttackAirHi)
    .game_acmd("game_attackairlw", game_brave_AttackAirLw)
    .game_acmd("game_catch", game_brave_Catch)
    .game_acmd("game_catchdash", game_brave_CatchDash)
    .game_acmd("game_catchturn", game_brave_CatchTurn)
    .game_acmd("game_catchattack", game_brave_CatchAttack)
    .game_acmd("game_throwf", game_brave_ThrowF)
    .game_acmd("game_throwb", game_brave_ThrowB)
    .game_acmd("game_throwhi", game_brave_ThrowHi)
    .game_acmd("game_throwlw", game_brave_ThrowLw)
    .game_acmd("game_downattacku", game_brave_DownAttackU)
    .game_acmd("game_downattackd", game_brave_DownAttackD)
    .game_acmd("game_cliffattack", game_brave_CliffAttack)
    .game_acmd("game_slipattack", game_brave_SlipAttack)
    .game_acmd("game_specials1", game_brave_SpecialS1)
    .game_acmd("game_specials2", game_brave_SpecialS2)
    .game_acmd("game_specials3", game_brave_SpecialS3)
    .game_acmd("game_specials32", game_brave_SpecialS32)
    .game_acmd("game_specialairs1", game_brave_SpecialAirS1)
    .game_acmd("game_specialairs2", game_brave_SpecialAirS2)
    .game_acmd("game_specialairs3", game_brave_SpecialAirS3)
    .game_acmd("game_specialairs32", game_brave_SpecialAirS32)
    .game_acmd("game_specialhi1", game_brave_SpecialHi1)
    .game_acmd("game_specialhi2", game_brave_SpecialHi2)
    .game_acmd("game_specialhi3", game_brave_SpecialHi3)
    .game_acmd("game_specialairhi1", game_brave_SpecialAirHi1)
    .game_acmd("game_specialairhi2", game_brave_SpecialAirHi2)
    .game_acmd("game_specialairhi3", game_brave_SpecialAirHi3)
    .game_acmd("game_specialhiempty", game_brave_SpecialHiEmpty)
    .game_acmd("game_specialairhiempty", game_brave_SpecialAirHiEmpty)
    .game_acmd("game_speciallw8", game_brave_SpecialLw8)
    .game_acmd("game_speciallw8_com", game_brave_SpecialLw8_Com)
    .game_acmd("game_specialairlw8", game_brave_SpecialAirLw8)
    .game_acmd("game_speciallw10", game_brave_SpecialLw10)
    .game_acmd("game_specialairlw10", game_brave_SpecialAirLw10)
    .game_acmd("game_speciallw17", game_brave_SpecialLw17)
    .game_acmd("game_speciallw18", game_brave_SpecialLw18)
    .game_acmd("game_speciallw19", game_brave_SpecialLw19)
    .game_acmd("game_speciallw20", game_brave_SpecialLw20)
    .game_acmd("game_specialairlw17", game_brave_SpecialAirLw17)
    .game_acmd("game_specialairlw18", game_brave_SpecialAirLw18)
    .game_acmd("game_specialairlw19", game_brave_SpecialAirLw19)
    .game_acmd("game_specialairlw20", game_brave_SpecialAirLw20)
    .game_acmd("game_appealsr", game_brave_AppealSR)
    .game_acmd("game_appealsl", game_brave_AppealSL)
    .game_acmd("game_appealhir", game_brave_AppealHiR)
    .game_acmd("game_appealhil", game_brave_AppealHiL)
    .game_acmd("game_appeallwr", game_brave_AppealLwR)
    .game_acmd("game_appeallwl", game_brave_AppealLwL)
    .game_acmd("game_finalend", game_brave_FinalEnd)
    .game_acmd("game_finalairend", game_brave_FinalAirEnd)
    .install();
}
