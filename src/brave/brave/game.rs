...
//Attack11
unsafe extern "C" fn game_brave_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_brave_Attack12(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.4);
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//Attack13
unsafe extern "C" fn game_brave_Attack13(fighter: &mut L2CAgentBase) {
...
//AttackDash
unsafe extern "C" fn game_brave_AttackDash(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
...
//AttackS3
unsafe extern "C" fn game_brave_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
...
//AttackS3S2
unsafe extern "C" fn game_brave_AttackS3S2(fighter: &mut L2CAgentBase) {
...
//AttackHi3 
unsafe extern "C" fn game_brave_AttackHi3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
//AttackLw3
unsafe extern "C" fn game_brave_AttackLw3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackS4
unsafe extern "C" fn game_brave_AttackS4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//AttackHi4
unsafe extern "C" fn game_brave_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
//AttackLw4
unsafe extern "C" fn game_brave_AttackLw4(fighter: &mut L2CAgentBase) {
...
//AttackAirF 
unsafe extern "C" fn game_brave_AttackAirF(fighter: &mut L2CAgentBase) {
...
//AttackAirB
unsafe extern "C" fn game_brave_AttackAirB(fighter: &mut L2CAgentBase) {
...
//AttackAirHi
unsafe extern "C" fn game_brave_AttackAirHi(fighter: &mut L2CAgentBase) {
...
//Catch
unsafe extern "C" fn game_brave_Catch(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//CatchDash
unsafe extern "C" fn game_brave_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
...
//CatchTurn
unsafe extern "C" fn game_brave_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, /*CanCatchRebound*/ true);
    }
...
//CatchAttack
unsafe extern "C" fn game_brave_CatchAttack(fighter: &mut L2CAgentBase) {
...
//ThrowF
unsafe extern "C" fn game_brave_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_brave_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_brave_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_brave_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_brave_CliffAttack(fighter: &mut L2CAgentBase) {
...
//SlipAttack
unsafe extern "C" fn game_brave_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_brave_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_brave_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 17.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 14.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ -16.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(-5.5), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
    }
...
//SpecialS1
unsafe extern "C" fn game_brave_SpecialS1(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialS2
unsafe extern "C" fn game_brave_SpecialS2(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_BRAVE_STATUS_SPECIAL_S_FLAG_ENABLE_SPARK);
    }
...
//SpecialS3
unsafe extern "C" fn game_brave_SpecialS3(fighter: &mut L2CAgentBase) {  
    frame(fighter.lua_state_agent, 10.0);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_BRAVE_STATUS_SPECIAL_S_FLAG_SUCCESS_SP) {
        if is_excute(fighter) {
...
//SpecialS32
unsafe extern "C" fn game_brave_SpecialS32(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirS1
unsafe extern "C" fn game_brave_SpecialAirS1(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 11.0, 6.0);
    }
    frame(fighter.lua_state_agent, 9.0);
...
//SpecialAirS2
unsafe extern "C" fn game_brave_SpecialAirS2(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_BRAVE_STATUS_SPECIAL_S_FLAG_ENABLE_SPARK);
    }
...
//SpecialAirS3
unsafe extern "C" fn game_brave_SpecialAirS3(fighter: &mut L2CAgentBase) {  
    frame(fighter.lua_state_agent, 10.0);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_BRAVE_STATUS_SPECIAL_S_FLAG_SUCCESS_SP) {
        if is_excute(fighter) {
            WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_BRAVE_STATUS_SPECIAL_S_FLAG_ACTIVATE_LIGHTNING);
...
//SpecialAirS32
unsafe extern "C" fn game_brave_SpecialAirS32(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 11.0, 11.0);
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
        DamageModule::heal(fighter.module_accessor, -40.0, 0);
...
//SpecialLw8
unsafe extern "C" fn game_brave_SpecialLw8(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
    }
...
//SpecialLw8_Com
unsafe extern "C" fn game_brave_SpecialLw8_Com(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
    }
...
//SpecialAirLw8
unsafe extern "C" fn game_brave_SpecialAirLw8(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 8.0);
    if is_excute(fighter) {
        HitModule::set_whole(fighter.module_accessor, HitStatus(*HIT_STATUS_INVINCIBLE), 0);
    }
...
//SpecialLw17
unsafe extern "C" fn game_brave_SpecialLw17(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 7.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//SpecialAirLw17 [Flame Slash]
unsafe extern "C" fn game_brave_SpecialAirLw17(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 7.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//SpecialLw18
unsafe extern "C" fn game_brave_SpecialLw18(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 7.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//SpecialAirLw18 [Kacrackle]
unsafe extern "C" fn game_brave_SpecialAirLw18(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.5);
    frame(fighter.lua_state_agent, 7.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//SpecialLw19
unsafe extern "C" fn game_brave_SpecialLw19(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 11.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_BRAVE_INSTANCE_WORK_ID_FLAG_PLAY_MISS_SE);
...
//SpecialAirLw19 [Metal Slash]
unsafe extern "C" fn game_brave_SpecialAirLw19(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 11.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_BRAVE_INSTANCE_WORK_ID_FLAG_PLAY_MISS_SE);
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("sword1"), /*Damage*/ 16.0, /*Angle*/ 361, /*KBG*/ 110, /*FKB*/ 0, /*BKB*/ 30, /*Size*/ 6.3, /*X*/ 10.8, /*Y*/ 0.0, /*Z*/ -2.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ f32::NAN, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_cutup_metal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
...
//SpecialLw20
unsafe extern "C" fn game_brave_SpecialLw20(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialAirLw20 [Hatchet Man]
unsafe extern "C" fn game_brave_SpecialAirLw20(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, *DAMAGE_NO_REACTION_MODE_ALWAYS, 0.0);
        MotionModule::set_rate(fighter.module_accessor, 1.6);
    }
...
//SpecialLw10 [Kacklang]
unsafe extern "C" fn game_brave_SpecialLw10(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::clear_all(fighter.module_accessor);
    }
...
//SpecialAirLw10 [Kacklang]
unsafe extern "C" fn game_brave_SpecialAirLw10(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
...
//AppealHiR
unsafe extern "C" fn game_brave_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_brave_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BEAMSWORD), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_brave_AppealSR(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_brave_AppealSL(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_STAFF), 0, 0, false, false);
    }
...
//FinalEnd
unsafe extern "C" fn game_brave_FinalEnd(fighter: &mut L2CAgentBase) { 
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_brave_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_BRAVE_ATTACK_ABSOLUTE_KIND_FINAL, /*ID*/ 0, /*Damage*/ 777.0, /*Angle*/ 65, /*KBG*/ 53, /*FKB*/ 0, /*BKB*/ 81, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_elec"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_CUTUP, /*Type*/ *ATTACK_REGION_SWORD);
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_VISUAL_SCENE_FLAG_ABS_SET);
        CAM_ZOOM_OUT(fighter, );
...
pub fn install() {
    Agent::new("brave")
    .game_acmd("game_attack11", game_brave_Attack11, Low)
    .game_acmd("game_attack12", game_brave_Attack12, Low)
    .game_acmd("game_attack13", game_brave_Attack13, Low)
    .game_acmd("game_attackdash", game_brave_AttackDash, Low)
    .game_acmd("game_attacks3", game_brave_AttackS3, Low)
    .game_acmd("game_attacks3s2", game_brave_AttackS3S2, Low)
    .game_acmd("game_attackhi3", game_brave_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_brave_AttackLw3, Low)
    .game_acmd("game_attacks4", game_brave_AttackS4, Low)
    .game_acmd("game_attackhi4", game_brave_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_brave_AttackLw4, Low)
    .game_acmd("game_attackairn", game_brave_AttackAirN, Low)
    .game_acmd("game_attackairf", game_brave_AttackAirF, Low)
    .game_acmd("game_attackairb", game_brave_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_brave_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_brave_AttackAirLw, Low)
    .game_acmd("game_catch", game_brave_Catch, Low)
    .game_acmd("game_catchdash", game_brave_CatchDash, Low)
    .game_acmd("game_catchturn", game_brave_CatchTurn, Low)
    .game_acmd("game_catchattack", game_brave_CatchAttack, Low)
    .game_acmd("game_throwf", game_brave_ThrowF, Low)
    .game_acmd("game_throwb", game_brave_ThrowB, Low)
    .game_acmd("game_throwhi", game_brave_ThrowHi, Low)
    .game_acmd("game_throwlw", game_brave_ThrowLw, Low)
    .game_acmd("game_downattacku", game_brave_DownAttackU, Low)
    .game_acmd("game_downattackd", game_brave_DownAttackD, Low)
    .game_acmd("game_cliffattack", game_brave_CliffAttack, Low)
    .game_acmd("game_slipattack", game_brave_SlipAttack, Low)
    .game_acmd("game_specials1", game_brave_SpecialS1, Low)
    .game_acmd("game_specials2", game_brave_SpecialS2, Low)
    .game_acmd("game_specials3", game_brave_SpecialS3, Low)
    .game_acmd("game_specials32", game_brave_SpecialS32, Low)
    .game_acmd("game_specialairs1", game_brave_SpecialAirS1, Low)
    .game_acmd("game_specialairs2", game_brave_SpecialAirS2, Low)
    .game_acmd("game_specialairs3", game_brave_SpecialAirS3, Low)
    .game_acmd("game_specialairs32", game_brave_SpecialAirS32, Low)
    .game_acmd("game_specialhi1", game_brave_SpecialHi1, Low)
    .game_acmd("game_specialhi2", game_brave_SpecialHi2, Low)
    .game_acmd("game_specialhi3", game_brave_SpecialHi3, Low)
    .game_acmd("game_specialairhi1", game_brave_SpecialAirHi1, Low)
    .game_acmd("game_specialairhi2", game_brave_SpecialAirHi2, Low)
    .game_acmd("game_specialairhi3", game_brave_SpecialAirHi3, Low)
    .game_acmd("game_specialhiempty", game_brave_SpecialHiEmpty, Low)
    .game_acmd("game_specialairhiempty", game_brave_SpecialAirHiEmpty, Low)
    .game_acmd("game_speciallw8", game_brave_SpecialLw8, Low)
    .game_acmd("game_speciallw8_com", game_brave_SpecialLw8_Com, Low)
    .game_acmd("game_specialairlw8", game_brave_SpecialAirLw8, Low)
    .game_acmd("game_speciallw10", game_brave_SpecialLw10, Low)
    .game_acmd("game_specialairlw10", game_brave_SpecialAirLw10, Low)
    .game_acmd("game_speciallw17", game_brave_SpecialLw17, Low)
    .game_acmd("game_speciallw18", game_brave_SpecialLw18, Low)
    .game_acmd("game_speciallw19", game_brave_SpecialLw19, Low)
    .game_acmd("game_speciallw20", game_brave_SpecialLw20, Low)
    .game_acmd("game_specialairlw17", game_brave_SpecialAirLw17, Low)
    .game_acmd("game_specialairlw18", game_brave_SpecialAirLw18, Low)
    .game_acmd("game_specialairlw19", game_brave_SpecialAirLw19, Low)
    .game_acmd("game_specialairlw20", game_brave_SpecialAirLw20, Low)
    .game_acmd("game_appealsr", game_brave_AppealSR, Low)
    .game_acmd("game_appealsl", game_brave_AppealSL, Low)
    .game_acmd("game_appealhir", game_brave_AppealHiR, Low)
    .game_acmd("game_appealhil", game_brave_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_brave_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_brave_AppealLwL, Low)
    .game_acmd("game_finalend", game_brave_FinalEnd, Low)
    .game_acmd("game_finalairend", game_brave_FinalAirEnd, Low)
    .install();
}
