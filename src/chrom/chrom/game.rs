...
pub fn install() {
    Agent::new("chrom")
    .game_acmd("game_attack11", game_chrom_Attack11)
    .game_acmd("game_attackdash", game_chrom_AttackDash)
    .game_acmd("game_attacks3", game_chrom_AttackS3)
    .game_acmd("game_attackhi3", game_chrom_AttackHi3)
    .game_acmd("game_attacklw3", game_chrom_AttackLw3)
    .game_acmd("game_attacks4", game_chrom_AttackS4)
    .game_acmd("game_attackhi4", game_chrom_AttackHi4)
    .game_acmd("game_attacklw4", game_chrom_AttackLw4)
    .game_acmd("game_attackairn", game_chrom_AttackAirN)
    .game_acmd("game_attackairf", game_chrom_AttackAirF)    
    .game_acmd("game_attackairb", game_chrom_AttackAirB)
    .game_acmd("game_attackairhi", game_chrom_AttackAirHi)
    .game_acmd("game_attackairlw", game_chrom_AttackAirLw)
    .game_acmd("game_catch", game_chrom_Catch)
    .game_acmd("game_catchdash", game_chrom_CatchDash)
    .game_acmd("game_catchturn", game_chrom_CatchTurn)
    .game_acmd("game_catchattack", game_chrom_CatchAttack)
    .game_acmd("game_throwf", game_chrom_ThrowF)
    .game_acmd("game_throwb", game_chrom_ThrowB)
    .game_acmd("game_throwhi", game_chrom_ThrowHi)
    .game_acmd("game_throwlw", game_chrom_ThrowLw)
    .game_acmd("game_downattackd", game_chrom_DownAttackD)
    .game_acmd("game_downattacku", game_chrom_DownAttackU)
    .game_acmd("game_cliffattack", game_chrom_CliffAttack)
    .game_acmd("game_slipattack", game_chrom_SlipAttack)
    .game_acmd("game_specialnend", game_chrom_SpecialNEnd)
    .game_acmd("game_specialnend2", game_chrom_SpecialNEnd2)
    .game_acmd("game_specialnend3", game_chrom_SpecialNEnd3)
    .game_acmd("game_specialnendmax", game_chrom_SpecialNEndMax)
    .game_acmd("game_specialairnend", game_chrom_SpecialAirNEnd)
    .game_acmd("game_specialairnend2", game_chrom_SpecialAirNEnd2)
    .game_acmd("game_specialairnend3", game_chrom_SpecialAirNEnd3)
    .game_acmd("game_specialairnendmax", game_chrom_SpecialAirNEndMax)
    .game_acmd("game_specials4hi", game_chrom_SpecialS4Hi)
    .game_acmd("game_specials4lw", game_chrom_SpecialS4Lw)
    .game_acmd("game_specials4s", game_chrom_SpecialS4S)
    .game_acmd("game_specialairs4hi", game_chrom_SpecialAirS4Hi)
    .game_acmd("game_specialairs4lw", game_chrom_SpecialAirS4Lw)
    .game_acmd("game_specialairs4s", game_chrom_SpecialAirS4S)
    .game_acmd("game_specialhi2", game_chrom_SpecialHi2)
    .game_acmd("game_specialhi3", game_chrom_SpecialHi3)
    .game_acmd("game_specialhi4", game_chrom_SpecialHi4)
    .game_acmd("game_specialairhi2", game_chrom_SpecialAirHi2)
    .game_acmd("game_speciallwhit", game_chrom_SpecialLwHit)
    .game_acmd("game_specialairlwhit", game_chrom_SpecialAirLwHit)
    .game_acmd("game_appealsr", game_chrom_AppealSR)
    .game_acmd("game_appealsl", game_chrom_AppealSL)
    .game_acmd("game_appealhir", game_chrom_AppealHiR)
