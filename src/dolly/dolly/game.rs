...
pub fn install() {
    Agent::new("dolly")
    .game_acmd("game_attack11", game_dolly_Attack11, Low)
    .game_acmd("game_attack12", game_dolly_Attack12, Low)
    .game_acmd("game_attack13", game_dolly_Attack13, Low)
    .game_acmd("game_attackdash", game_dolly_AttackDash, Low)
    .game_acmd("game_attacks3", game_dolly_AttackS3, Low)
    .game_acmd("game_attackhi3", game_dolly_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_dolly_AttackLw3, Low)
    .game_acmd("game_attacks4", game_dolly_AttackS4, Low)
    .game_acmd("game_attackhi4", game_dolly_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_dolly_AttackLw4, Low)
    .game_acmd("game_attackairn", game_dolly_AttackAirN, Low)
    .game_acmd("game_attackairf", game_dolly_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_dolly_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_dolly_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_dolly_AttackAirLw, Low)
    .game_acmd("game_catch", game_dolly_Catch, Low)
    .game_acmd("game_catchdash", game_dolly_CatchDash, Low)
    .game_acmd("game_catchturn", game_dolly_CatchTurn, Low)
    .game_acmd("game_catchattack", game_dolly_CatchAttack, Low)
    .game_acmd("game_throwf", game_dolly_ThrowF, Low)
    .game_acmd("game_throwb", game_dolly_ThrowB, Low)
    .game_acmd("game_throwhi", game_dolly_ThrowHi, Low)
    .game_acmd("game_throwlw", game_dolly_ThrowLw, Low)
    .game_acmd("game_downattackd", game_dolly_DownAttackD, Low)
    .game_acmd("game_downattacku", game_dolly_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_dolly_CliffAttack, Low)
    .game_acmd("game_escapepattack", game_dolly_EscapeAttack, Low)
    .game_acmd("game_slipattack", game_dolly_SlipAttack, Low)
    .game_acmd("game_specialn", game_dolly_SpecialN, Low)
    .game_acmd("game_specialairn", game_dolly_SpecialAirN, Low)
    .game_acmd("game_dolly_specialsfattack", game_dolly_SpecialSFAttack, Low)
    .game_acmd("game_dolly_specialsfstart", game_dolly_SpecialSFStart, Low)
    .game_acmd("game_dolly_specialairsfstart", game_dolly_SpecialAirSFStart, Low)
    .game_acmd("game_dolly_specialsbattack", game_dolly_SpecialSBAttack, Low)
    .game_acmd("game_dolly_specialsbattackw", game_dolly_SpecialSBAttackW, Low)
    .game_acmd("game_specialhi1", game_dolly_SpecialHi1, Low)
    .game_acmd("game_specialhicommand", game_dolly_SpecialHiCommand, Low)
    .game_acmd("game_specialairhi1", game_dolly_SpecialAirHi1, Low)
    .game_acmd("game_specialairhicommand", game_dolly_SpecialAirHiCommand, Low)
    .game_acmd("game_specialairlw", game_dolly_SpecialAirLw, Low)
    .game_acmd("game_specialairlwrise", game_dolly_SpecialAirLwRise, Low)
    .game_acmd("game_specialairlwrisew", game_dolly_SpecialAirLwRiseW, Low)
    .game_acmd("game_superspecial", game_dolly_SuperSpecial, Low)
    .game_acmd("game_superspecial2start", game_dolly_SuperSpecial2Start, Low)
    .game_acmd("game_superspecial2", game_dolly_SuperSpecial2, Low)
    .game_acmd("game_appealsr", game_dolly_AppealSR, Low)
    .game_acmd("game_appealsl", game_dolly_AppealSL, Low)
    .game_acmd("game_appealhir", game_dolly_AppealHiR, Low)
    .game_acmd("game_appealhil", game_dolly_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_dolly_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_dolly_AppealLwL, Low)
    .game_acmd("game_finalend", game_dolly_FinalEnd, Low)
    .game_acmd("game_finalairend", game_dolly_FinalAirEnd, Low)
    .install();
}
