...
unsafe fn gamewatch_downb(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
        ...
        lua_bind::KineticEnergy::clear_speed(energy);
    }
}
