...
unsafe fn gamewatch_jab100(fighter: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        ...
        acmd!(lua_state, {
            ...
            if(is_excute){
                methodlib::L2CValue::as_hash()const(FIGHTER_GAMEWATCH_GENERATE_ARTICLE_NORMAL_WEAPON, hash40("attack_100"))
...
unsafe fn gamewatch_sidetilt(fighter: &mut L2CAgentBase) {
    ...
    acmd!(lua_state, {
        ...
        if(is_excute){
            ...
            methodlib::L2CValue::as_hash()const(FIGHTER_GAMEWATCH_GENERATE_ARTICLE_NORMAL_WEAPON, hash40("attack_s3"))
            ArticleModule::change_motion()
        ...
        frame(Frame=25)
        if(is_excute){
            ArticleModule::remove(FIGHTER_GAMEWATCH_GENERATE_ARTICLE_NORMAL_WEAPON)
        }
    });
}
...
unsafe fn gamewatch_downtilt(fighter: &mut L2CAgentBase) {
    ...
    acmd!(lua_state, {
        if(is_excute){
            ...
            ArticleModule::generate_article(FIGHTER_GAMEWATCH_GENERATE_ARTICLE_NORMAL_WEAPON)
            methodlib::L2CValue::as_hash()const(FIGHTER_GAMEWATCH_GENERATE_ARTICLE_NORMAL_WEAPON, hash40("attack_lw3"))
            ArticleModule::change_motion()
        }
        frame(Frame=6)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("top"), Damage=15.0, Angle=88, KBG=112, FKB=0, BKB=45, Size=8.2, X=0.0, Y=2.1, Z=6.7, X2=0.0, Y2=2.1, Z2=17.8, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_G, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_normal"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_OBJECT)
            ATTACK(ID=1, Part=0, Bone=hash40("top"), Damage=15.0, Angle=89, KBG=112, FKB=0, BKB=45, Size=8.2, X=0.0, Y=9.3, Z=6.7, X2=0.0, Y2=2.1, Z2=17.8, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_G, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_normal"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_OBJECT)
            ATTACK(ID=2, Part=0, Bone=hash40("top"), Damage=7.5, Angle=90, KBG=128, FKB=0, BKB=45, Size=20.2, X=0.0, Y=9.3, Z=6.7, X2=0.0, Y2=22.1, Z2=16.8, Hitlag=0.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=4, Reflectable=false, Absorbable=false, Flinchless=true, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_G, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_none"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_NONE, Type=ATTACK_REGION_OBJECT)
...
unsafe fn gamewatch_throwf(fighter: &mut L2CAgentBase) {
    ...
    acmd!(lua_state, {
        if(is_excute){
            ...
            WorkModule::set_float(50, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=5)
        if(is_excute){
            WorkModule::set_float(-110, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=9)
        if(is_excute){
            WorkModule::set_float(120, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=13)
        if(is_excute){
            WorkModule::set_float(-30, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=17)
        if(is_excute){
            WorkModule::set_float(135, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=22)
        if(is_excute){
            WorkModule::set_float(-70, FIGHTER_GAMEWATCH_STATUS_THROW_WORK_FLOAT_STOCK_ICON_ROTATE)
        }
        frame(Frame=25)
        if(is_excute){
...
#[acmd_script(//SpecialS7_Sub
    agent = "gamewatch", 
    script = "game_specials7sub", 
    category = ACMD_GAME, 
    low_priority )]
unsafe fn gamewatch_sideb7(fighter: &mut L2CAgentBase) {
    acmd!(lua_state, {
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("top"), Damage=32.0, Angle=45, KBG=80, FKB=0, BKB=120, Size=9.0, X=0.0, Y=10.6, Z=8.9, X2=LUA_VOID, Y2=LUA_VOID, Z2=LUA_VOID, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_normal"), SFXLevel=ATTACK_SOUND_LEVEL_L, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_OBJECT)
            ATTACK(ID=1, Part=0, Bone=hash40("top"), Damage=32.0, Angle=45, KBG=80, FKB=0, BKB=120, Size=9.0, X=0.0, Y=7.0, Z=5.6, X2=LUA_VOID, Y2=LUA_VOID, Z2=LUA_VOID, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_normal"), SFXLevel=ATTACK_SOUND_LEVEL_L, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_OBJECT)
            DamageModule::heal(-999.0, 0);
            ItemModule::have_item(ItemKind(*ITEM_KIND_STARMAN), 0, 0, false, false)
        }
    });
}
