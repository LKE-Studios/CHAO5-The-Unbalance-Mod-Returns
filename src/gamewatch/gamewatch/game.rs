...
pub fn install() {
    Agent::new("gamewatch")
    .game_acmd("game_attack11", game_gamewatch_Attack11, Low)
    .game_acmd("game_attack100", game_gamewatch_Attack100, Low)
    .game_acmd("game_attack100sub", game_gamewatch_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_gamewatch_Attack100End, Low)
    .game_acmd("game_attackdash", game_gamewatch_AttackDash, Low)
    .game_acmd("game_attacks3", game_gamewatch_AttackS3, Low)
    .game_acmd("game_attackhi3", game_gamewatch_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_gamewatch_AttackLw3, Low)
    .game_acmd("game_attacks4", game_gamewatch_AttackS4, Low)
    .game_acmd("game_attackhi4", game_gamewatch_AttackHi4, Low)
    .game_acmd("game_attackhi4r", game_gamewatch_AttackHi4R, Low)
    .game_acmd("game_attacklw4", game_gamewatch_AttackLw4, Low)
    .game_acmd("game_attackairn", game_gamewatch_AttackAirN, Low)
    .game_acmd("game_attackairf", game_gamewatch_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_gamewatch_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_gamewatch_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_gamewatch_AttackAirLw, Low)
    .game_acmd("game_landingairb", game_gamewatch_LandingAirB, Low)
    .game_acmd("game_landingairlw", game_gamewatch_LandingAirLw, Low)
    .game_acmd("game_catch", game_gamewatch_Catch, Low)
    .game_acmd("game_catchdash", game_gamewatch_CatchDash, Low)
    .game_acmd("game_catchturn", game_gamewatch_CatchTurn, Low)
    .game_acmd("game_catchattack", game_gamewatch_CatchAttack, Low)
    .game_acmd("game_throwf", game_gamewatch_ThrowF, Low)
    .game_acmd("game_throwb", game_gamewatch_ThrowB, Low)
    .game_acmd("game_throwhi", game_gamewatch_ThrowHi, Low)
    .game_acmd("game_throwlw", game_gamewatch_ThrowLw, Low)
    .game_acmd("game_downattackd", game_gamewatch_DownAttackD, Low)
    .game_acmd("game_downattacku", game_gamewatch_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_gamewatch_CliffAttack, Low)
    .game_acmd("game_slipattack", game_gamewatch_SlipAttack, Low)
    .game_acmd("game_specialn", game_gamewatch_SpecialN, Low)
    .game_acmd("game_specialairn", game_gamewatch_SpecialAirN, Low)
    .game_acmd("game_specials1", game_gamewatch_SpecialS1, Low)
    .game_acmd("game_specialairs1", game_gamewatch_SpecialAirS1, Low)
    .game_acmd("game_specials1_sub", game_gamewatch_SpecialS1_Sub, Low)
    .game_acmd("game_specials2", game_gamewatch_SpecialS2, Low)
    .game_acmd("game_specialairs2", game_gamewatch_SpecialAirS2, Low)
    .game_acmd("game_specials2_sub", game_gamewatch_SpecialS2_Sub, Low)
    .game_acmd("game_specials3", game_gamewatch_SpecialS3, Low)
    .game_acmd("game_specialairs3", game_gamewatch_SpecialAirS3, Low)
    .game_acmd("game_specials3_sub", game_gamewatch_SpecialS3_Sub, Low)
    .game_acmd("game_specials4", game_gamewatch_SpecialS4, Low)
    .game_acmd("game_specialairs4", game_gamewatch_SpecialAirS4, Low)
    .game_acmd("game_specials4_sub", game_gamewatch_SpecialS4_Sub, Low)
    .game_acmd("game_specials5", game_gamewatch_SpecialS5, Low)
    .game_acmd("game_specialairs5", game_gamewatch_SpecialAirS5, Low)
    .game_acmd("game_specials5_sub", game_gamewatch_SpecialS5_Sub, Low)
    .game_acmd("game_specials6", game_gamewatch_SpecialS6, Low)
    .game_acmd("game_specialairs6", game_gamewatch_SpecialAirS6, Low)
    .game_acmd("game_specials6_sub", game_gamewatch_SpecialS6_Sub, Low)
    .game_acmd("game_specials7", game_gamewatch_SpecialS7, Low)
    .game_acmd("game_specialairs7", game_gamewatch_SpecialAirS7, Low)
    .game_acmd("game_specials7_sub", game_gamewatch_SpecialS7_Sub, Low)
    .game_acmd("game_specials8", game_gamewatch_SpecialS8, Low)
    .game_acmd("game_specialairs8", game_gamewatch_SpecialAirS8, Low)
    .game_acmd("game_specials8_sub", game_gamewatch_SpecialS8_Sub, Low)
    .game_acmd("game_specials9", game_gamewatch_SpecialS9, Low)
    .game_acmd("game_specialairs9", game_gamewatch_SpecialAirS9, Low)
    .game_acmd("game_specials9_sub", game_gamewatch_SpecialS9_Sub, Low)
    .game_acmd("game_specialhi", game_gamewatch_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_gamewatch_SpecialAirHi, Low)
    .game_acmd("game_speciallw", game_gamewatch_SpecialLw, Low)
    .game_acmd("game_speciallwshoot", game_gamewatch_SpecialLwShoot, Low)
    .game_acmd("game_speciallwend", game_gamewatch_SpecialLwEnd, Low)
    .game_acmd("game_specialairlw", game_gamewatch_SpecialAirLw, Low)
    .game_acmd("game_specialairlwshoot", game_gamewatch_SpecialAirLwShoot, Low)
    .game_acmd("game_specialairlwend", game_gamewatch_SpecialAirLwEnd, Low)
    .game_acmd("game_appealsr", game_gamewatch_AppealSR, Low)
    .game_acmd("game_appealsl", game_gamewatch_AppealSL, Low)
    .game_acmd("game_appealhir", game_gamewatch_AppealHiR, Low)
    .game_acmd("game_appealhil", game_gamewatch_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_gamewatch_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_gamewatch_AppealLwL, Low)
    .install();
}