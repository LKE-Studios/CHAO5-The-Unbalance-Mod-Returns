...
pub fn install() {
    Agent::new("lucas")
    .game_acmd("game_attack11", game_lucas_Attack11, Low)
    .game_acmd("game_attack12", game_lucas_Attack12, Low)
    .game_acmd("game_attack13", game_lucas_Attack13, Low)
    .game_acmd("game_attackdash", game_lucas_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_lucas_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_lucas_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_lucas_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_lucas_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_lucas_AttackLw3, Low)
    .game_acmd("game_attacks4", game_lucas_AttackS4, Low)
    .game_acmd("game_attackhi4", game_lucas_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_lucas_AttackLw4, Low)
    .game_acmd("game_attackairn", game_lucas_AttackAirN, Low)
    .game_acmd("game_attackairf", game_lucas_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_lucas_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_lucas_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_lucas_AttackAirLw, Low)
    .game_acmd("game_catchattack", game_lucas_CatchAttack, Low)
    .game_acmd("game_throwf", game_lucas_ThrowF, Low)
    .game_acmd("game_throwb", game_lucas_ThrowB, Low)
    .game_acmd("game_throwhi", game_lucas_ThrowHi, Low)
    .game_acmd("game_throwlw", game_lucas_ThrowLw, Low)
    .game_acmd("game_downattackd", game_lucas_DownAttackD, Low)
    .game_acmd("game_downattacku", game_lucas_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_lucas_CliffAttack, Low)
    .game_acmd("game_slipattack", game_lucas_SlipAttack, Low)
    .game_acmd("game_specialnhold", game_lucas_SpecialNHold, Low)
    .game_acmd("game_specialairnhold", game_lucas_SpecialAirNHold, Low)
    .game_acmd("game_specials", game_lucas_SpecialS, Low)
    .game_acmd("game_specialairs", game_lucas_SpecialAirS, Low)
    .game_acmd("game_specialairhi", game_lucas_SpecialAirHi, Low)
    .game_acmd("game_specialairhireflect", game_lucas_SpecialAirHiReflect, Low)
    .game_acmd("game_specialairhidownboundd", game_lucas_SpecialAirHiDownBoundD, Low)
    .game_acmd("game_specialairhidownboundu", game_lucas_SpecialAirHiDownBoundU, Low)
    .game_acmd("game_speciallwstart", game_lucas_SpecialLwStart, Low)
    .game_acmd("game_speciallwend", game_lucas_SpecialLwEnd, Low)
    .game_acmd("game_specialairlwstart", game_lucas_SpecialAirLwStart, Low)
    .game_acmd("game_specialairlwend", game_lucas_SpecialAirLwEnd, Low)
    .game_acmd("game_speciallwhold", game_lucas_SpecialLwHold, Low)
    .game_acmd("game_specialairlwhold", game_lucas_SpecialAirLwHold, Low)
    .game_acmd("game_appealsr", game_lucas_AppealSR, Low)
    .game_acmd("game_appealsl", game_lucas_AppealSL, Low)
    .game_acmd("game_appealhir", game_lucas_AppealHiR, Low)
    .game_acmd("game_appealhil", game_lucas_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_lucas_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_lucas_AppealLwL, Low)
    .game_acmd("game_wessdance", game_lucas_WessDance, Low)
    .install();
}