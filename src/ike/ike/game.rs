...
pub fn install() {
    Agent::new("ike")
    .game_acmd("game_attack11", game_ike_Attack11)
    .game_acmd("game_attack12", game_ike_Attack12)
    .game_acmd("game_attack13", game_ike_Attack13)
    .game_acmd("game_attackdash", game_ike_AttackDash)
    .game_acmd("game_attacks3hi", game_ike_AttackS3Hi)
    .game_acmd("game_attacks3", game_ike_AttackS3)
    .game_acmd("game_attacks3lw", game_ike_AttackS3Lw)
    .game_acmd("game_attackhi3", game_ike_AttackHi3)
    .game_acmd("game_attacklw3", game_ike_AttackLw3)
    .game_acmd("game_attacks4", game_ike_AttackS4)
    .game_acmd("game_attackhi4", game_ike_AttackHi4)
    .game_acmd("game_attacklw4", game_ike_AttackLw4)
    .game_acmd("game_attackairn", game_ike_AttackAirN)
    .game_acmd("game_attackairf", game_ike_AttackAirF)    
    .game_acmd("game_attackairb", game_ike_AttackAirB)
    .game_acmd("game_attackairhi", game_ike_AttackAirHi)
    .game_acmd("game_attackairlw", game_ike_AttackAirLw)
    .game_acmd("game_catch", game_ike_Catch)
    .game_acmd("game_catchdash", game_ike_CatchDash)
    .game_acmd("game_catchturn", game_ike_CatchTurn)
    .game_acmd("game_catchattack", game_ike_CatchAttack)
    .game_acmd("game_throwf", game_ike_ThrowF)
    .game_acmd("game_throwb", game_ike_ThrowB)
    .game_acmd("game_throwhi", game_ike_ThrowHi)
    .game_acmd("game_throwlw", game_ike_ThrowLw)
    .game_acmd("game_downattackd", game_ike_DownAttackD)
    .game_acmd("game_downattacku", game_ike_DownAttackU)
    .game_acmd("game_cliffattack", game_ike_CliffAttack)
    .game_acmd("game_slipattack", game_ike_SlipAttack)
    .game_acmd("game_specialnendmdl", game_ike_SpecialNEndMdl)
    .game_acmd("game_specialnendmax", game_ike_SpecialNEndMax)
    .game_acmd("game_specialairnendmdl", game_ike_SpecialAirNEndMdl)
    .game_acmd("game_specialairnendmax", game_ike_SpecialAirNEndMax)  
    .game_acmd("game_specialsattack", game_ike_SpecialSAttack)
    .game_acmd("game_specialsend", game_ike_SpecialSEnd)  
    .game_acmd("game_specialairsattack", game_ike_SpecialAirSAttack)  
    .game_acmd("game_specialairsend", game_ike_SpecialAirSEnd)
    .game_acmd("game_specialhi2", game_ike_SpecialHi2)
    .game_acmd("game_specialhi3", game_ike_SpecialHi3)
    .game_acmd("game_specialhi4", game_ike_SpecialHi4)
    .game_acmd("game_appealsr", game_ike_AppealSR)
    .game_acmd("game_appealsl", game_ike_AppealSL)
    .game_acmd("game_appealhir", game_ike_AppealHiR)
    .game_acmd("game_appealhil", game_ike_AppealHiL)
    .game_acmd("game_appeallwr", game_ike_AppealLwR)
    .game_acmd("game_appeallwl", game_ike_AppealLwL)
    .game_acmd("game_finalend", game_ike_FinalEnd)
    .install();
}
