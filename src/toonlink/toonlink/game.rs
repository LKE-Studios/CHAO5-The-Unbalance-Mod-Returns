...
pub fn install() {
    Agent::new("toonlink")
    .game_acmd("game_attack11", game_toonlink_Attack11, Low)
    .game_acmd("game_attack12", game_toonlink_Attack12, Low)
    .game_acmd("game_attack13", game_toonlink_Attack13, Low)
    .game_acmd("game_attackdash", game_toonlink_AttackDash, Low)
    .game_acmd("game_attacks3", game_toonlink_AttackS3, Low)
    .game_acmd("game_attackhi3", game_toonlink_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_toonlink_AttackLw3, Low)
    .game_acmd("game_attacks4", game_toonlink_AttackS4, Low)
    .game_acmd("game_attackhi4", game_toonlink_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_toonlink_AttackLw4, Low)
    .game_acmd("game_attackairn", game_toonlink_AttackAirN, Low)
    .game_acmd("game_attackairf", game_toonlink_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_toonlink_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_toonlink_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_toonlink_AttackAirLw, Low)
    .game_acmd("game_attackairlw2attack", game_toonlink_AttackAirLw2Attack, Low)
    .game_acmd("game_aircatch", game_toonlink_AirCatch, Low)
    .game_acmd("game_catchattack", game_toonlink_CatchAttack, Low)
    .game_acmd("game_throwf", game_toonlink_ThrowF, Low)
    .game_acmd("game_throwb", game_toonlink_ThrowB, Low)
    .game_acmd("game_throwhi", game_toonlink_ThrowHi, Low)
    .game_acmd("game_throwlw", game_toonlink_ThrowLw, Low)
    .game_acmd("game_downattackd", game_toonlink_DownAttackD, Low)
    .game_acmd("game_downattacku", game_toonlink_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_toonlink_CliffAttack, Low)
    .game_acmd("game_slipattack", game_toonlink_SlipAttack, Low)    
    .game_acmd("game_specialnstart", game_toonlink_SpecialNStart, Low)
    .game_acmd("game_specialairnstart", game_toonlink_SpecialAirNStart, Low)
    .game_acmd("game_specialhi", game_toonlink_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_toonlink_SpecialAirHi, Low)
    .game_acmd("game_appealsr", game_toonlink_AppealSR, Low)
    .game_acmd("game_appealsl", game_toonlink_AppealSL, Low)
    .game_acmd("game_appealhir", game_toonlink_AppealHiR, Low)
    .game_acmd("game_appealhil", game_toonlink_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_toonlink_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_toonlink_AppealLwL, Low)
    .game_acmd("game_finalc", game_toonlink_FinalC, Low)
    .install();
}
