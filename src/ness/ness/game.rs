...
unsafe extern "C" fn game_ness_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, /*ID*/ 0, /*Damage*/ 18.0, /*Angle*/ 135, /*KBG*/ 166, /*FKB*/ 0, /*BKB*/ 100, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
        ATTACK_ABS(fighter, /*Kind*/ *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, /*ID*/ 0, /*Damage*/ 3.0, /*Angle*/ 361, /*KBG*/ 100, /*FKB*/ 0, /*BKB*/ 60, /*Hitlag*/ 0.0, /*Unk*/ 1.0, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*Unk*/ 0.0, /*Unk*/ true, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_NONE, /*Type*/ *ATTACK_REGION_THROW);
    }
    frame(fighter.lua_state_agent, 26.0);
    if is_excute(fighter) {
...
pub fn install() {
    Agent::new("ness")
    .game_acmd("game_attack11", game_ness_Attack11)
    .game_acmd("game_attack12", game_ness_Attack12)
    .game_acmd("game_attack13", game_ness_Attack13)
    .game_acmd("game_attackdash", game_ness_AttackDash)
    .game_acmd("game_attacks3hi", game_ness_AttackS3Hi)
    .game_acmd("game_attacks3", game_ness_AttackS3)
    .game_acmd("game_attacks3lw", game_ness_AttackS3Lw)
    .game_acmd("game_attackhi3", game_ness_AttackHi3)
    .game_acmd("game_attacklw3", game_ness_AttackLw3)
    .game_acmd("game_attacks4", game_ness_AttackS4)
    .game_acmd("game_attackairn", game_ness_AttackAirN)
    .game_acmd("game_attackairf", game_ness_AttackAirF)    
    .game_acmd("game_attackairb", game_ness_AttackAirB)
    .game_acmd("game_attackairhi", game_ness_AttackAirHi)
    .game_acmd("game_attackairlw", game_ness_AttackAirLw)
    .game_acmd("game_catch", game_ness_Catch)
    .game_acmd("game_catchdash", game_ness_CatchDash)
    .game_acmd("game_catchturn", game_ness_CatchTurn)
    .game_acmd("game_catchattack", game_ness_CatchAttack)
    .game_acmd("game_throwf", game_ness_ThrowF)
    .game_acmd("game_throwb", game_ness_ThrowB)
    .game_acmd("game_throwhi", game_ness_ThrowHi)
    .game_acmd("game_throwlw", game_ness_ThrowLw)
    .game_acmd("game_downattackd", game_ness_DownAttackD)
    .game_acmd("game_downattacku", game_ness_DownAttackU)
    .game_acmd("game_cliffattack", game_ness_CliffAttack)
    .game_acmd("game_slipattack", game_ness_SlipAttack)
    .game_acmd("game_specials", game_ness_SpecialS)  
    .game_acmd("game_specialairs", game_ness_SpecialAirS) 
    .game_acmd("game_specialairhi", game_ness_SpecialAirHi)
    .game_acmd("game_speciallwhold", game_ness_SpecialLwHold)
    .game_acmd("game_specialairlwhold", game_ness_SpecialAirLwHold)
    .game_acmd("game_appealsr", game_ness_AppealSR)
    .game_acmd("game_appealsl", game_ness_AppealSL)
    .game_acmd("game_appealhir", game_ness_AppealHiR)
    .game_acmd("game_appealhil", game_ness_AppealHiL)
    .game_acmd("game_appeallwr", game_ness_AppealLwR)
    .game_acmd("game_appeallwl", game_ness_AppealLwL)
    .install();
}
