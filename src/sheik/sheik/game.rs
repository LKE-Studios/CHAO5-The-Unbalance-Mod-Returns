...
pub fn install() {
    Agent::new("sheik")
    .game_acmd("game_attack11", game_sheik_Attack11)
    .game_acmd("game_attack12", game_sheik_Attack12)
    .game_acmd("game_attack100", game_sheik_Attack100)
    .game_acmd("game_attack100sub", game_sheik_Attack100Sub)
    .game_acmd("game_attack100end", game_sheik_Attack100End)
    .game_acmd("game_attackdash", game_sheik_AttackDash)
    .game_acmd("game_attacks3", game_sheik_AttackS3)
    .game_acmd("game_attackhi3", game_sheik_AttackHi3)
    .game_acmd("game_attacklw3", game_sheik_AttackLw3)
    .game_acmd("game_attacks4", game_sheik_AttackS4)
    .game_acmd("game_attackhi4", game_sheik_AttackHi4)
    .game_acmd("game_attacklw4", game_sheik_AttackLw4)
    .game_acmd("game_attackairn", game_sheik_AttackAirN)
    .game_acmd("game_attackairf", game_sheik_AttackAirF)    
    .game_acmd("game_attackairb", game_sheik_AttackAirB)
    .game_acmd("game_attackairhi", game_sheik_AttackAirHi)
    .game_acmd("game_attackairlw", game_sheik_AttackAirLw)
    .game_acmd("game_catch", game_sheik_Catch)
    .game_acmd("game_catchdash", game_sheik_CatchDash)
    .game_acmd("game_catchturn", game_sheik_CatchTurn)
    .game_acmd("game_catchattack", game_sheik_CatchAttack)
    .game_acmd("game_throwf", game_sheik_ThrowF)
    .game_acmd("game_throwb", game_sheik_ThrowB)
    .game_acmd("game_throwhi", game_sheik_ThrowHi)
    .game_acmd("game_throwlw", game_sheik_ThrowLw)
    .game_acmd("game_downattackd", game_sheik_DownAttackD)
    .game_acmd("game_downattacku", game_sheik_DownAttackU)
    .game_acmd("game_cliffattack", game_sheik_CliffAttack)
    .game_acmd("game_slipattack", game_sheik_SlipAttack)
    .game_acmd("game_specialnend", game_sheik_SpecialNEnd)
    .game_acmd("game_specialairnend", game_sheik_SpecialAirNEnd)
    .game_acmd("game_specialhi", game_sheik_SpecialHi)
    .game_acmd("game_specialairhi", game_sheik_SpecialAirHi)
    .game_acmd("game_speciallwattack", game_sheik_SpecialLwAttack)
    .game_acmd("game_specialairlwattack", game_sheik_SpecialAirLwAttack)
    .game_acmd("game_appealsr", game_sheik_AppealSR)
    .game_acmd("game_appealsl", game_sheik_AppealSL)
    .game_acmd("game_appealhir", game_sheik_AppealHiR)
    .game_acmd("game_appealhil", game_sheik_AppealHiL)
    .game_acmd("game_appeallwr", game_sheik_AppealLwR)
    .game_acmd("game_appeallwl", game_sheik_AppealLwL)
    .game_acmd("game_finalattack", game_sheik_FinalAttack)
    .game_acmd("game_finalfinish", game_sheik_FinalFinish)
    .install();
}