...
pub fn install() {
    Agent::new("cloud")
    .game_acmd("game_attack11", game_cloud_Attack11, Low)
    .game_acmd("game_attack12", game_cloud_Attack12, Low)
    .game_acmd("game_attack13", game_cloud_Attack13, Low)
    .game_acmd("game_attackdash", game_cloud_AttackDash, Low)
    .game_acmd("game_attacks3", game_cloud_AttackS3, Low)
    .game_acmd("game_attackhi3", game_cloud_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_cloud_AttackLw3, Low)
    .game_acmd("game_attacks4", game_cloud_AttackS4, Low)
    .game_acmd("game_attackhi4", game_cloud_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_cloud_AttackLw4, Low)
    .game_acmd("game_attackairn", game_cloud_AttackAirN, Low)
    .game_acmd("game_attackairf", game_cloud_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_cloud_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_cloud_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_cloud_AttackAirLw, Low)
    .game_acmd("game_catch", game_cloud_Catch, Low)
    .game_acmd("game_catchdash", game_cloud_CatchDash, Low)
    .game_acmd("game_catchturn", game_cloud_CatchTurn, Low)
    .game_acmd("game_catchattack", game_cloud_CatchAttack, Low)
    .game_acmd("game_throwf", game_cloud_ThrowF, Low)
    .game_acmd("game_throwb", game_cloud_ThrowB, Low)
    .game_acmd("game_throwhi", game_cloud_ThrowHi, Low)
    .game_acmd("game_throwlw", game_cloud_ThrowLw, Low)
    .game_acmd("game_downattackd", game_cloud_DownAttackD, Low)
    .game_acmd("game_downattacku", game_cloud_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_cloud_CliffAttack, Low)
    .game_acmd("game_slipattack", game_cloud_SlipAttack, Low)
    .game_acmd("game_specialn", game_cloud_SpecialN, Low)
    .game_acmd("game_specialairn", game_cloud_SpecialAirN, Low)
    .game_acmd("game_specialn_lb", game_cloud_SpecialN_LB, Low)
    .game_acmd("game_specialairn_lb", game_cloud_SpecialAirN_LB, Low)
    .game_acmd("game_specials1", game_cloud_SpecialS1, Low)
    .game_acmd("game_specialairs1", game_cloud_SpecialAirS1, Low)
    .game_acmd("game_specials1_lb", game_cloud_SpecialS1_LB, Low)
    .game_acmd("game_specialairs1_lb", game_cloud_SpecialAirS1_LB, Low)
    .game_acmd("game_specials2", game_cloud_SpecialS2, Low)
    .game_acmd("game_specialairs2", game_cloud_SpecialAirS2, Low)
    .game_acmd("game_specials2_lb", game_cloud_SpecialS2_LB, Low)
    .game_acmd("game_specialairs2_lb", game_cloud_SpecialAirS2_LB, Low)
    .game_acmd("game_specials3", game_cloud_SpecialS3, Low)
    .game_acmd("game_specialairs3", game_cloud_SpecialAirS3, Low)
    .game_acmd("game_specials3_lb", game_cloud_SpecialS3_LB, Low)
    .game_acmd("game_specialairs3_lb", game_cloud_SpecialAirS3_LB, Low)
    .game_acmd("game_specialhi", game_cloud_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_cloud_SpecialAirHi, Low)
    .game_acmd("game_specialhi_lb", game_cloud_SpecialHi_LB, Low)
    .game_acmd("game_specialairhi_lb", game_cloud_SpecialAirHi_LB, Low)
    .game_acmd("game_specialhi2", game_cloud_SpecialHi2, Low)
    .game_acmd("game_specialhi2landing", game_cloud_SpecialHi2Landing, Low)
    .game_acmd("game_speciallwloop", game_cloud_SpecialLwLoop, Low)
    .game_acmd("game_specialairlwloop", game_cloud_SpecialAirLwLoop, Low)
    .game_acmd("game_speciallw", game_cloud_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_cloud_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_cloud_AppealSR, Low)
    .game_acmd("game_appealsl", game_cloud_AppealSL, Low)
    .game_acmd("game_appealhir", game_cloud_AppealHiR, Low)
    .game_acmd("game_appealhil", game_cloud_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_cloud_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_cloud_AppealLwL, Low)
    .game_acmd("game_finalend", game_cloud_FinalEnd, Low)
    .game_acmd("game_final2end", game_cloud_Final2End, Low)
    .install();
}
