...
pub fn install() {
    Agent::new("jack")
    .game_acmd("game_attack11", game_jack_Attack11)
    .game_acmd("game_attack12", game_jack_Attack12)
    .game_acmd("game_attack13", game_jack_Attack13)
    .game_acmd("game_attackdash", game_jack_AttackDash)
    .game_acmd("game_attacks3hi", game_jack_AttackS3Hi)
    .game_acmd("game_attacks3", game_jack_AttackS3)
    .game_acmd("game_attacks3lw", game_jack_AttackS3Lw)
    .game_acmd("game_attackhi3", game_jack_AttackHi3)
    .game_acmd("game_attacklw3", game_jack_AttackLw3)
    .game_acmd("game_attacks4", game_jack_AttackS4)
    .game_acmd("game_attackhi4", game_jack_AttackHi4)
    .game_acmd("game_attacklw4", game_jack_AttackLw4)
    .game_acmd("game_attackairn", game_jack_AttackAirN)
    .game_acmd("game_attackairf", game_jack_AttackAirF)    
    .game_acmd("game_attackairb", game_jack_AttackAirB)
    .game_acmd("game_attackairhi", game_jack_AttackAirHi)
    .game_acmd("game_attackairlw", game_jack_AttackAirLw)
    .game_acmd("game_catch", game_jack_Catch)
    .game_acmd("game_catchdash", game_jack_CatchDash)
    .game_acmd("game_catchturn", game_jack_CatchTurn)
    .game_acmd("game_catchattack", game_jack_CatchAttack)
    .game_acmd("game_throwf", game_jack_ThrowF)
    .game_acmd("game_throwb", game_jack_ThrowB)
    .game_acmd("game_throwhi", game_jack_ThrowHi)
    .game_acmd("game_throwlw", game_jack_ThrowLw)
    .game_acmd("game_downattackd", game_jack_DownAttackD)
    .game_acmd("game_downattacku", game_jack_DownAttackU)
    .game_acmd("game_cliffattack", game_jack_CliffAttack)
    .game_acmd("game_slipattack", game_jack_SlipAttack)
    .game_acmd("game_specialn1", game_jack_SpecialN1)
    .game_acmd("game_specialn2", game_jack_SpecialN2)
    .game_acmd("game_specialn3", game_jack_SpecialN3)
    .game_acmd("game_specialn1_ex", game_jack_SpecialN1_Ex)
    .game_acmd("game_specialn2_ex", game_jack_SpecialN2_Ex)
    .game_acmd("game_specialn3_ex", game_jack_SpecialN3_Ex)
    .game_acmd("game_specialnescapeb", game_jack_SpecialNEscapeB)
    .game_acmd("game_specialnescapeb_ex", game_jack_SpecialNEscapeB_Ex)
    .game_acmd("game_specialnescapef", game_jack_SpecialNEscapeF)
    .game_acmd("game_specialnescapef_ex", game_jack_SpecialNEscapeF_Ex)
    .game_acmd("game_specialn3_ex", game_jack_SpecialN3_Ex)
    .game_acmd("game_specialnjump", game_jack_SpecialNJump)
    .game_acmd("game_specialairn1", game_jack_SpecialAirN1)
    .game_acmd("game_specialairn2", game_jack_SpecialAirN2)
    .game_acmd("game_specialairn3", game_jack_SpecialAirN3)
    .game_acmd("game_specialairn1_ex", game_jack_SpecialAirN1_Ex)
    .game_acmd("game_specialairn2_ex", game_jack_SpecialAirN2_Ex)
    .game_acmd("game_specialairn3_ex", game_jack_SpecialAirN3_Ex)
    .game_acmd("game_specialairnescapeb", game_jack_SpecialAirNEscapeB)
    .game_acmd("game_specialairnescapeb_ex", game_jack_SpecialAirNEscapeB_Ex)
    .game_acmd("game_specialairnescapef", game_jack_SpecialAirNEscapeF)
    .game_acmd("game_specialairnescapef_ex", game_jack_SpecialAirNEscapeF_Ex)
    .game_acmd("game_specialairndown", game_jack_SpecialAirNDown)
    .game_acmd("game_specialairndownend", game_jack_SpecialAirNDownEnd)
    .game_acmd("game_specialairnshoot", game_jack_SpecialAirNShoot) 
    .game_acmd("game_specials1", game_jack_SpecialS1)  
    .game_acmd("game_specialairs1", game_jack_SpecialAirS1)  
    .game_acmd("game_specialhi", game_jack_SpecialHi)
    .game_acmd("game_specialhithrow", game_jack_SpecialHiThrow)
    .game_acmd("game_specialairhi", game_jack_SpecialAirHi)
    .game_acmd("game_specialairhif", game_jack_SpecialAirHiF)
    .game_acmd("game_specialairhib", game_jack_SpecialAirHiB)
    .game_acmd("game_speciallwattack", game_jack_SpecialLwAttack)
    .game_acmd("game_speciallwcounter", game_jack_SpecialLwCounter)
    .game_acmd("game_specialairlwattack", game_jack_SpecialAirLwAttack)
    .game_acmd("game_specialairlwcounter", game_jack_SpecialAirLwCounter)
    .game_acmd("game_appealsr", game_jack_AppealSR)
    .game_acmd("game_appealsl", game_jack_AppealSL)
    .game_acmd("game_appealhir", game_jack_AppealHiR)
    .game_acmd("game_appealhil", game_jack_AppealHiL)
    .game_acmd("game_appeallwr", game_jack_AppealLwR)
    .game_acmd("game_appeallwl", game_jack_AppealLwL)
    .game_acmd("game_finalend", game_jack_FinalEnd)
    .game_acmd("game_finalairend", game_jack_FinalAirEnd)
    .install();
}
