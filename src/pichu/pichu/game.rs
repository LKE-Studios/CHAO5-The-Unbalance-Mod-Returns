...
pub fn install() {
    Agent::new("pichu")
    .game_acmd("game_attack11", game_pichu_Attack11, Low)
    .game_acmd("game_attackdash", game_pichu_AttackDash, Low)
    .game_acmd("game_attacks3", game_pichu_AttackS3, Low)
    .game_acmd("game_attackhi3", game_pichu_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_pichu_AttackLw3, Low)
    .game_acmd("game_attacks4", game_pichu_AttackS4, Low)
    .game_acmd("game_attackhi4", game_pichu_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_pichu_AttackLw4, Low)
    .game_acmd("game_attackairn", game_pichu_AttackAirN, Low)
    .game_acmd("game_attackairf", game_pichu_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_pichu_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_pichu_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_pichu_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_pichu_LandingAirLw, Low)
    .game_acmd("game_catch", game_pichu_Catch, Low)
    .game_acmd("game_catchdash", game_pichu_CatchDash, Low)
    .game_acmd("game_catchturn", game_pichu_CatchTurn, Low)
    .game_acmd("game_catchattack", game_pichu_CatchAttack, Low)
    .game_acmd("game_throwf", game_pichu_ThrowF, Low)
    .game_acmd("game_throwb", game_pichu_ThrowB, Low)
    .game_acmd("game_throwhi", game_pichu_ThrowHi, Low)
    .game_acmd("game_throwlw", game_pichu_ThrowLw, Low)
    .game_acmd("game_downattackd", game_pichu_DownAttackD, Low)
    .game_acmd("game_downattacku", game_pichu_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_pichu_CliffAttack, Low)
    .game_acmd("game_slipattack", game_pichu_SlipAttack, Low)
    .game_acmd("game_specialn", game_pichu_SpecialN, Low)
    .game_acmd("game_specialairn", game_pichu_SpecialAirN, Low)
    .game_acmd("game_specialnshoot", game_pichu_SpecialNShoot, Low)
    .game_acmd("game_specials", game_pichu_SpecialS, Low)
    .game_acmd("game_specialhi1", game_pichu_SpecialHi1, Low)
    .game_acmd("game_specialhi2", game_pichu_SpecialHi2, Low)
    .game_acmd("game_specialairhi1", game_pichu_SpecialAirHi1, Low)
    .game_acmd("game_specialairhi2", game_pichu_SpecialAirHi2, Low)
    .game_acmd("game_speciallwhit", game_pichu_SpecialLwHit, Low)
    .game_acmd("game_specialairlwhit", game_pichu_SpecialAirLwHit, Low)
    .game_acmd("game_appealsr", game_pichu_AppealSR, Low)
    .game_acmd("game_appealsl", game_pichu_AppealSL, Low)
    .game_acmd("game_appealhir", game_pichu_AppealHiR, Low)
    .game_acmd("game_appealhil", game_pichu_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_pichu_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_pichu_AppealLwL, Low)
    .game_acmd("game_final", game_pichu_Final, Low)
    .game_acmd("game_finalair", game_pichu_FinalAir, Low)
    .game_acmd("game_final2", game_pichu_Final2, Low)
    .game_acmd("game_finalair2", game_pichu_FinalAir2, Low)
    .game_acmd("game_finalattack2", game_pichu_FinalAttack2, Low)
    .game_acmd("game_finalattackfinish", game_pichu_FinalAttackFinish, Low) 
    .install();
}
