...
unsafe extern "C" fn expression_basyaamo_AttackDash(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE_INTP, *SLOPE_STATUS_LR, 3);
        ControlModule::set_rumble(agent.module_accessor, Hash40::new("rbkind_landm"), 0, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
}
...
unsafe extern "C" fn expression_basyaamo_AttackAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(agent) {
        AttackModule::set_attack_reference_joint_id(agent.module_accessor, Hash40::new("toer"), AttackDirectionAxis(*ATTACK_DIRECTION_X), AttackDirectionAxis(*ATTACK_DIRECTION_Y), AttackDirectionAxis(*ATTACK_DIRECTION_Z));
    }
...
unsafe extern "C" fn expression_basyaamo_ThrowLw(fighter: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 19.0);
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE_INTP, *SLOPE_STATUS_TOP, 9);
    }
...
//SpecialAirNOverheat
unsafe extern "C" fn expression_basyaamo_SpecialAirNOverheat(fighter: &mut L2CAgentBase) {
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_LR);
    }
    frame(agent.lua_state_agent, 9.0);
...
unsafe extern "C" fn expression_basyaamo_SpecialLw(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_L);
        ControlModule::set_rumble(agent.module_accessor, Hash40::new("rbkind_jump"), 5, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
    frame(agent.lua_state_agent, 15.0);
    if is_excute(agent) {
        RUMBLE_HIT(agent, Hash40::new("rbkind_attacks"), 0);
...
unsafe extern "C" fn expression_basyaamo_SpecialLwLoop(fighter: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        ControlModule::set_rumble(agent.module_accessor, Hash40::new("rbkind_flym"), 5, false, *BATTLE_OBJECT_ID_INVALID as u32);
        RUMBLE_HIT(agent, Hash40::new("rbkind_attackm"), 0);
    }
}
...
unsafe extern "C" fn expression_basyaamo_SpecialLwLanding(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_LR);
        ControlModule::set_rumble(agent.module_accessor, Hash40::new("rbkind_walk"), 5, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
}
...
unsafe extern "C" fn expression_basyaamo_AppealSR(fighter: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ControlModule::set_rumble(agent.module_accessor, Hash40::new("rbkind_lands"), 38, true, *BATTLE_OBJECT_ID_INVALID as u32);
    }
...
//EntryR
unsafe extern "C" fn expression_basyaamo_EntryR(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
...
//EntryL
unsafe extern "C" fn expression_basyaamo_EntryL(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        notify_event_msc_cmd!(agent, Hash40::new_raw(0x1f20a9d549), false);
        notify_event_msc_cmd!(agent, Hash40::new_raw(0x24772eddef), false);
        VisibilityModule::set_whole(agent.module_accessor, false);
...
pub fn install() {
    ...
    .expression_acmd("expression_catchattack_basyaamo", expression_basyaamo_CatchAttack, Low)
    ...
    .expression_acmd("expression_specials_basyammo", expression_basyaamo_SpecialS, Low)
    .expression_acmd("expression_specialairs_basyammo", expression_basyaamo_SpecialAirS, Low)
