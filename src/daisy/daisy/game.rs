...
pub fn install() {
    Agent::new("daisy")
    .game_acmd("game_attack11", game_daisy_Attack11)
    .game_acmd("game_attack12", game_daisy_Attack12)
    .game_acmd("game_attackdash", game_daisy_AttackDash)
    .game_acmd("game_attacks3", game_daisy_AttackS3)
    .game_acmd("game_attackhi3", game_daisy_AttackHi3)
    .game_acmd("game_attacklw3", game_daisy_AttackLw3)
    .game_acmd("game_attacks4hi", game_daisy_AttackS4Hi)
    .game_acmd("game_attacks4", game_daisy_AttackS4)
    .game_acmd("game_attacks4lw", game_daisy_AttackS4Lw)
    .game_acmd("game_attackhi4", game_daisy_AttackHi4)
    .game_acmd("game_attacklw4", game_daisy_AttackLw4)
    .game_acmd("game_attackairn", game_daisy_AttackAirN)
    .game_acmd("game_attackairf", game_daisy_AttackAirF)    
    .game_acmd("game_attackairb", game_daisy_AttackAirB)
    .game_acmd("game_attackairhi", game_daisy_AttackAirHi)
    .game_acmd("game_attackairlw", game_daisy_AttackAirLw)
    .game_acmd("game_catch", game_daisy_Catch)
    .game_acmd("game_catchdash", game_daisy_CatchDash)
    .game_acmd("game_catchturn", game_daisy_CatchTurn)
    .game_acmd("game_catchattack", game_daisy_CatchAttack)
    .game_acmd("game_throwf", game_daisy_ThrowF)
    .game_acmd("game_throwb", game_daisy_ThrowB)
    .game_acmd("game_throwhi", game_daisy_ThrowHi)
    .game_acmd("game_throwlw", game_daisy_ThrowLw)
    .game_acmd("game_downattackd", game_daisy_DownAttackD)
    .game_acmd("game_downattacku", game_daisy_DownAttackU)
    .game_acmd("game_cliffattack", game_daisy_CliffAttack)
    .game_acmd("game_slipattack", game_daisy_SlipAttack)
    .game_acmd("game_specialshitend", game_daisy_SpecialSHitEnd)
    .game_acmd("game_specialhiopen", game_daisy_SpecialHiOpen)
    .game_acmd("game_specialhistart", game_daisy_SpecialHiStart)
    .game_acmd("game_specialairhistart", game_daisy_SpecialAirHiStart)
    .game_acmd("game_speciallw", game_daisy_SpecialLw)
    .game_acmd("game_appealsr", game_daisy_AppealSR)
    .game_acmd("game_appealsl", game_daisy_AppealSL)
    .game_acmd("game_appealhir", game_daisy_AppealHiR)
    .game_acmd("game_appealhil", game_daisy_AppealHiL)
