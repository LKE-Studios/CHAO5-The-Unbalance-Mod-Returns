...
unsafe extern "C" fn status_kamek_fireball_Regular_Pre(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn status_kamek_fireball_Regular_Main(weapon: &mut L2CWeaponCommon) -> L2CValue {
    MotionModule::change_motion(weapon.module_accessor, Hash40::new("regular"), 0.0, 1.0, false, 0.0, false, false);
    weapon.fastshift(L2CValue::Ptr(kamek_fireball_Regular_Main_loop as *const () as _))
}

unsafe extern "C" fn kamek_fireball_Regular_Main_loop(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn status_kamek_fireball_Regular_Exec(weapon: &mut L2CWeaponCommon) -> L2CValue {
