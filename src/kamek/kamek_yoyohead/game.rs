...
//AttackHi4Charge
unsafe extern "C" fn game_ninten_yoyohead_AttackHi4Charge(fighter: &mut L2CAgentBase) {
...
//AttackHi4
unsafe extern "C" fn game_ninten_yoyohead_AttackHi4(fighter: &mut L2CAgentBase) {
...
//AttackLw4Charge
unsafe extern "C" fn game_ninten_yoyohead_AttackLw4Charge(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("attach"), /*Damage*/ 3.3, /*Angle*/ 45, /*KBG*/ 100, /*FKB*/ 12, /*BKB*/ 0, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 0.0, /*Z*/ 0.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 0.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 2, /*Trip*/ 0.0, /*Rehit*/ 9, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_OBJECT);
    }
}
...
//AttackLw4
unsafe extern "C" fn game_ninten_yoyohead_AttackLw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 11.0);
    if is_excute(fighter) {
...
pub fn install() {
    ...
    .game_acmd("game_attackhi4charge_ninten", game_ninten_yoyohead_AttackHi4Charge, Low)
    .game_acmd("game_attackhi4_ninten", game_ninten_yoyohead_AttackHi4, Low)
    .game_acmd("game_attacklw4charge_ninten", game_ninten_yoyohead_AttackLw4Charge, Low)
    .game_acmd("game_attacklw4_ninten", game_ninten_yoyohead_AttackLw4, Low)
    .install();
}