...
pub unsafe extern "C" fn status_kamek_finalmagic_Break_Pre(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn status_kamek_finalmagic_Break_Main(weapon: &mut L2CFighterCommon) -> L2CValue {
	...
	weapon.fastshift(L2CValue::Ptr(kamek_finalmagic_Break_Main_loop as *const () as _)) 
}
...
pub unsafe extern "C" fn status_kamek_finalmagic_Break_End(weapon: &mut L2CWeaponCommon) -> L2CValue {
    0.into()
}
