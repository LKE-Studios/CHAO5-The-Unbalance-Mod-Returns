...
pub fn install() {
    Agent::new("ken")
    .game_acmd("game_attack11w", game_ken_Attack11W)
    .game_acmd("game_attack11s", game_ken_Attack11S)
    .game_acmd("game_attack11nears", game_ken_Attack11NearS)
    .game_acmd("game_attack12", game_ken_Attack12)
    .game_acmd("game_attack13", game_ken_Attack13)
    .game_acmd("game_attackdash", game_ken_AttackDash)
    .game_acmd("game_attacks3s", game_ken_AttackS3S)
    .game_acmd("game_attacks3w", game_ken_AttackS3W)
    .game_acmd("game_attacknearw", game_ken_AttackNearW)
    .game_acmd("game_attackcommand1", game_ken_AttackCommand1)
    .game_acmd("game_attackcommand2", game_ken_AttackCommand2)
    .game_acmd("game_attackcommand3", game_ken_AttackCommand3)
    .game_acmd("game_attackhi3w", game_ken_AttackHi3W)
    .game_acmd("game_attackhi3s", game_ken_AttackHi3S)
    .game_acmd("game_attacklw3w", game_ken_AttackLw3W)
    .game_acmd("game_attacklw3s", game_ken_AttackLw3S)
    .game_acmd("game_attacks4", game_ken_AttackS4)
    .game_acmd("game_attackhi4", game_ken_AttackHi4)
    .game_acmd("game_attacklw4", game_ken_AttackLw4)
    .game_acmd("game_attackairn", game_ken_AttackAirN)
    .game_acmd("game_attackairf", game_ken_AttackAirF)    
    .game_acmd("game_attackairb", game_ken_AttackAirB)
    .game_acmd("game_attackairhi", game_ken_AttackAirHi)
    .game_acmd("game_attackairlw", game_ken_AttackAirLw)
    .game_acmd("game_catch", game_ken_Catch)
    .game_acmd("game_catchdash", game_ken_CatchDash)
    .game_acmd("game_catchturn", game_ken_CatchTurn)
    .game_acmd("game_catchattack", game_ken_CatchAttack)
    .game_acmd("game_throwf", game_ken_ThrowF)
    .game_acmd("game_downattackd", game_ken_DownAttackD)
    .game_acmd("game_downattacku", game_ken_DownAttackU)
    .game_acmd("game_cliffattack", game_ken_CliffAttack)
    .game_acmd("game_slipattack", game_ken_SlipAttack)
    .game_acmd("game_specialn", game_ken_SpecialN)
    .game_acmd("game_specialairn", game_ken_SpecialAirN)
    .game_acmd("game_specialsstart", game_ken_SpecialSStart)
    .game_acmd("game_specials", game_ken_SpecialS)
    .game_acmd("game_specialairsstart", game_ken_SpecialAirSStart)
    .game_acmd("game_specialairs", game_ken_SpecialAirS)
    .game_acmd("game_specialhi", game_ken_SpecialHi)
    .game_acmd("game_specialairhi", game_ken_SpecialAirHi)
    .game_acmd("game_specialhicommand", game_ken_SpecialHiCommand)
    .game_acmd("game_specialairhicommand", game_ken_SpecialAirHiCommand)
    .game_acmd("game_speciallw", game_ken_SpecialLw)
    .game_acmd("game_specialairlw", game_ken_SpecialAirLw)
    .game_acmd("game_speciallwturn", game_ken_SpecialLwTurn)
    .game_acmd("game_specialairlwturn", game_ken_SpecialAirLwTurn)
    .game_acmd("game_appealsr", game_ken_AppealSR)
    .game_acmd("game_appealsl", game_ken_AppealSL)
    .game_acmd("game_appealhir", game_ken_AppealHiR)
    .game_acmd("game_appealhil", game_ken_AppealHiL)
    .game_acmd("game_appeallwr", game_ken_AppealLwR)
    .game_acmd("game_appeallwl", game_ken_AppealLwL)
    .game_acmd("game_finalhit", game_ken_FinalHit)
    .game_acmd("game_finalhit_com", game_ken_FinalHit_Com)
    .install();
}
