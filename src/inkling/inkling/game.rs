...
pub fn install() {
    Agent::new("inkling")
    .game_acmd("game_attack11", game_inkling_Attack11)
    .game_acmd("game_attack12", game_inkling_Attack12)
    .game_acmd("game_attack13", game_inkling_Attack13)
    .game_acmd("game_attack100", game_inkling_Attack100)
    .game_acmd("game_attack100sub", game_inkling_Attack100Sub)
    .game_acmd("game_attack100end", game_inkling_Attack100End)
    .game_acmd("game_attackdash", game_inkling_AttackDash)
    .game_acmd("game_attacks3", game_inkling_AttackS3)
    .game_acmd("game_attackhi3", game_inkling_AttackHi3)
    .game_acmd("game_attacklw3", game_inkling_AttackLw3)
    .game_acmd("game_attacks4", game_inkling_AttackS4)
    .game_acmd("game_attackhi4", game_inkling_AttackHi4)
    .game_acmd("game_attacklw4", game_inkling_AttackLw4)
    .game_acmd("game_attackairn", game_inkling_AttackAirN)
    .game_acmd("game_attackairf", game_inkling_AttackAirF)    
    .game_acmd("game_attackairb", game_inkling_AttackAirB)
    .game_acmd("game_attackairhi", game_inkling_AttackAirHi)
    .game_acmd("game_attackairlw", game_inkling_AttackAirLw)
    .game_acmd("game_catch", game_inkling_Catch)
    .game_acmd("game_catchdash", game_inkling_CatchDash)
    .game_acmd("game_catchturn", game_inkling_CatchTurn)
    .game_acmd("game_catchattack", game_inkling_CatchAttack)
    .game_acmd("game_throwf", game_inkling_ThrowF)
    .game_acmd("game_throwb", game_inkling_ThrowB)
    .game_acmd("game_throwhi", game_inkling_ThrowHi)
    .game_acmd("game_throwlw", game_inkling_ThrowLw)
    .game_acmd("game_downattackd", game_inkling_DownAttackD)
    .game_acmd("game_downattacku", game_inkling_DownAttackU)
    .game_acmd("game_cliffattack", game_inkling_CliffAttack)
    .game_acmd("game_slipattack", game_inkling_SlipAttack) 
    .game_acmd("game_specialsdash", game_inkling_SpecialSDash)  
    .game_acmd("game_specialswalk", game_inkling_SpecialSWalk)
    .game_acmd("game_specialsrun", game_inkling_SpecialSRun)
    .game_acmd("game_specialsturn", game_inkling_SpecialSTurn)
    .game_acmd("game_specialsrunturn", game_inkling_SpecialSRunTurn)
    .game_acmd("game_specialairsdash", game_inkling_SpecialAirSDash)  
    .game_acmd("game_specialairswalk", game_inkling_SpecialAirSWalk)
    .game_acmd("game_specialairsrun", game_inkling_SpecialAirSRun)
    .game_acmd("game_specialairsrunturn", game_inkling_SpecialAirSRunTurn)
    .game_acmd("game_specialhistart", game_inkling_SpecialHiStart)
    .game_acmd("game_specialairhistart", game_inkling_SpecialAirHiStart)
    .game_acmd("game_specialhijump", game_inkling_SpecialHiJump)
    .game_acmd("game_specialhilanding", game_inkling_SpecialHiLanding)
    .game_acmd("game_speciallwmax", game_inkling_SpecialLwMax)
    .game_acmd("game_specialairlwmax", game_inkling_SpecialAirLwMax)
    .game_acmd("game_appealsr", game_inkling_AppealSR)
    .game_acmd("game_appealsl", game_inkling_AppealSL)
    .game_acmd("game_appealhir", game_inkling_AppealHiR)
    .game_acmd("game_appealhil", game_inkling_AppealHiL)
    .game_acmd("game_appeallwr", game_inkling_AppealLwR)
    .game_acmd("game_appeallwl", game_inkling_AppealLwL)
    .install();
}