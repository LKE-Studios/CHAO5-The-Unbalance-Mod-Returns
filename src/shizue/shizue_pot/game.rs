...
unsafe extern "C" fn game_shizue_pot_Throwed(fighter: &mut L2CAgentBase) {
    ...
    let shot_kind = WorkModule::get_int(owner_module_accessor, *FIGHTER_SHIZUE_INSTANCE_WORK_ID_INT_SHOT_KIND);
    ModelModule::set_scale(fighter.module_accessor, 1.6);
    if shot_kind == 0 {//Picture
