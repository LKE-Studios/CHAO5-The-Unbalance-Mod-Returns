...
pub fn install() {
    Agent::new("shizue")
    .game_acmd("game_attack11", game_shizue_Attack11, Low)
    .game_acmd("game_attackdash", game_shizue_AttackDash, Low)
    .game_acmd("game_attacks3", game_shizue_AttackS3, Low)
    .game_acmd("game_attackhi3", game_shizue_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_shizue_AttackLw3, Low)
    .game_acmd("game_attacks4", game_shizue_AttackS4, Low)
    .game_acmd("game_attackhi4", game_shizue_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_shizue_AttackLw4, Low)
    .game_acmd("game_attackairn", game_shizue_AttackAirN, Low)
    .game_acmd("game_attackairf", game_shizue_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_shizue_AttackAirB, Low)
    .game_acmd("game_landingairb", game_shizue_LandingAirB, Low)
    .game_acmd("game_attackairhi", game_shizue_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_shizue_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_shizue_LandingAirLw, Low)
    .game_acmd("game_catch", game_shizue_Catch, Low)
    .game_acmd("game_catchturn", game_shizue_CatchTurn, Low)
    .game_acmd("game_catchdash", game_shizue_CatchDash, Low)
    .game_acmd("game_catchattack", game_shizue_CatchAttack, Low)
    .game_acmd("game_throwf", game_shizue_ThrowF, Low)
    .game_acmd("game_throwb", game_shizue_ThrowB, Low)
    .game_acmd("game_throwhi", game_shizue_ThrowHi, Low)
    .game_acmd("game_throwlw", game_shizue_ThrowLw, Low)
    .game_acmd("game_downattackd", game_shizue_DownAttackD, Low)
    .game_acmd("game_downattacku", game_shizue_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_shizue_CliffAttack, Low)
    .game_acmd("game_slipattack", game_shizue_SlipAttack, Low)
    .game_acmd("game_specialn", game_shizue_SpecialN, Low)
    .game_acmd("game_specialairn", game_shizue_SpecialAirN, Low)
    .game_acmd("game_specialsthrowf", game_shizue_SpecialSThrowF, Low)
    .game_acmd("game_specialsthrowb", game_shizue_SpecialSThrowB, Low)
    .game_acmd("game_specialsthrowhi", game_shizue_SpecialSThrowHi, Low)
    .game_acmd("game_specialsthrowlw", game_shizue_SpecialSThrowLw, Low)
    .game_acmd("game_specialairsthrowf", game_shizue_SpecialAirSThrowF, Low)
    .game_acmd("game_specialairsthrowb", game_shizue_SpecialAirSThrowB, Low)
    .game_acmd("game_specialairsthrowhi", game_shizue_SpecialAirSThrowHi, Low)
    .game_acmd("game_specialairsthrowlw", game_shizue_SpecialAirSThrowLw, Low)
    .game_acmd("game_specialhi", game_shizue_SpecialHi, Low)
    .game_acmd("game_specialairhi", game_shizue_SpecialAirHi, Low)
    .game_acmd("game_specialairhiflap1", game_shizue_SpecialAirHiFlap1, Low)
    .game_acmd("game_specialairhiflap2", game_shizue_SpecialAirHiFlap2, Low)
    .game_acmd("game_specialairhiwait1", game_shizue_SpecialAirHiWait1, Low)
    .game_acmd("game_specialairhiwait2", game_shizue_SpecialAirHiWait2, Low)
    .game_acmd("game_appealsr", game_shizue_AppealSR, Low)
    .game_acmd("game_appealsl", game_shizue_AppealSL, Low)
    .game_acmd("game_appealhir", game_shizue_AppealHiR, Low)
    .game_acmd("game_appealhil", game_shizue_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_shizue_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_shizue_AppealLwL, Low)
    .install();
}