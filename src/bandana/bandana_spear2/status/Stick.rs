...
unsafe extern "C" fn status_bandana_spear2_Stick_Init(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn status_bandana_spear2_Stick_Main(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    if !StopModule::is_stop(weapon.module_accessor) {
        bandana_spear2_Stick_SubStatus(weapon, false.into());
    }
...
unsafe extern "C" fn bandana_spear2_Stick_Main_loop(weapon: &mut L2CWeaponCommon) -> L2CValue {
...
unsafe extern "C" fn status_bandana_spear2_Stick_End(weapon: &mut L2CWeaponCommon) -> L2CValue {
    0.into()
}

pub fn install() {
    Agent::new("edge_spear2")
    .status(Pre, *WN_LINK_BOWARROW_STATUS_KIND_STICK, status_bandana_spear2_Stick_Pre)
    .status(Init, *WN_LINK_BOWARROW_STATUS_KIND_STICK, status_bandana_spear2_Stick_Init)
    .status(Main, *WN_LINK_BOWARROW_STATUS_KIND_STICK, status_bandana_spear2_Stick_Main)
    .status(End, *WN_LINK_BOWARROW_STATUS_KIND_STICK, status_bandana_spear2_Stick_End)
    .install();
}