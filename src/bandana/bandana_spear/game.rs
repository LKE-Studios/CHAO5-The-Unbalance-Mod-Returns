...
//Fly
unsafe extern "C" fn game_bandana_spear_Fly(fighter: &mut L2CAgentBase) {
...
//Stick
unsafe extern "C" fn game_bandana_spear_Stick(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    .game_acmd("game_fly", game_bandana_spear_Fly, Low)
    .game_acmd("game_stick", game_bandana_spear_Stick, Low)
    .install();
}