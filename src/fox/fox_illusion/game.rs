...
//MoveGround
unsafe extern "C" fn game_fox_illusion_MoveGround(fighter: &mut L2CAgentBase) {
...
//MoveAir
unsafe extern "C" fn game_fox_illusion_MoveAir(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    ...
    .game_acmd("game_moveground", game_fox_illusion_MoveGround, Low)
    .game_acmd("game_moveair", game_fox_illusion_MoveAir, Low)
    .install();
}