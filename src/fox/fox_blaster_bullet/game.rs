...
pub fn install() {
    ...
    .game_acmd("game_fly", game_fox_blaster_bullet_Fly, Low)
    .game_acmd("game_flythrowb", game_fox_blaster_bullet_FlyThrowB, Low)
    .game_acmd("game_flythrowhi", game_fox_blaster_bullet_FlyThrowHi, Low)
    .install();
}