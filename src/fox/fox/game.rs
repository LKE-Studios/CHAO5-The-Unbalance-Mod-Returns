...
//Attack11 
unsafe extern "C" fn game_fox_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_fox_Attack12(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
...
//Attack100 
unsafe extern "C" fn game_fox_Attack100(fighter: &mut L2CAgentBase) {
    loop {
        frame(fighter.lua_state_agent, 2.0);
        if is_excute(fighter) {
...
//Attack100Sub 
unsafe extern "C" fn game_fox_Attack100Sub(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("kneel"), /*Damage*/ 3.6, /*Angle*/ 361, /*KBG*/ 20, /*FKB*/ 0, /*BKB*/ 7, /*Size*/ 5.8, /*X*/ 5.0, /*Y*/ 0.0, /*Z*/ 0.7, /*X2*/ Some(-2.0), /*Y2*/ Some(0.0), /*Z2*/ Some(0.0), /*Hitlag*/ 0.0, /*SDI*/ 0.6, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_rush"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
        ATTACK(fighter, /*ID*/ 1, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 3.6, /*Angle*/ 361, /*KBG*/ 20, /*FKB*/ 0, /*BKB*/ 7, /*Size*/ 6.8, /*X*/ 0.0, /*Y*/ 8.0, /*Z*/ 14.5, /*X2*/ Some(0.0), /*Y2*/ Some(8.0), /*Z2*/ Some(8.0), /*Hitlag*/ 0.0, /*SDI*/ 0.6, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_rush"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_S, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
        ATK_SET_SHIELD_SETOFF_MUL_arg3(fighter, /*ID1*/ 0, /*ID2*/ 1, /*ShieldstunMul*/ 6.0);
...
//Attack100End 
unsafe extern "C" fn game_fox_Attack100End(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::clear_all(fighter.module_accessor);
    }
...
//AttackDash
unsafe extern "C" fn game_fox_AttackDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackS3Hi
unsafe extern "C" fn game_fox_AttackS3Hi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//AttackS3
unsafe extern "C" fn game_fox_AttackS3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//AttackS3Lw
unsafe extern "C" fn game_fox_AttackS3Lw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 6.0);
    if is_excute(fighter) {
...
//AttackHi3
unsafe extern "C" fn game_fox_AttackHi3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
...
//AttackLw3
unsafe extern "C" fn game_fox_AttackLw3(fighter: &mut L2CAgentBase) {
...
//AttackS4
unsafe extern "C" fn game_fox_AttackS4(fighter: &mut L2CAgentBase) {
...
//AttackHi4
unsafe extern "C" fn game_fox_AttackHi4(fighter: &mut L2CAgentBase) {
...
//AttackLw4
unsafe extern "C" fn game_fox_AttackLw4(fighter: &mut L2CAgentBase) {
...
//AttackAirN
unsafe extern "C" fn game_fox_AttackAirN(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AttackAirF 
unsafe extern "C" fn game_fox_AttackAirF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
    frame(fighter.lua_state_agent, 7.0);
...
//AttackAirB
unsafe extern "C" fn game_fox_AttackAirB(fighter: &mut L2CAgentBase) {
...
//AttackAirHi
unsafe extern "C" fn game_fox_AttackAirHi(fighter: &mut L2CAgentBase) {
...
//AttackAirLw
unsafe extern "C" fn game_fox_AttackAirLw(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//LandingAirLw
unsafe extern "C" fn game_fox_LandingAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//Catch
unsafe extern "C" fn game_fox_Catch(fighter: &mut L2CAgentBase) {
...
//CatchDash
unsafe extern "C" fn game_fox_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.7);
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
...
//CatchTurn
unsafe extern "C" fn game_fox_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.7);
    frame(fighter.lua_state_agent, 11.0);
    if is_excute(fighter) {
...
//CatchAttack
unsafe extern "C" fn game_fox_CatchAttack(fighter: &mut L2CAgentBase) {
...
//ThrowF
unsafe extern "C" fn game_fox_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//CliffAttack
unsafe extern "C" fn game_fox_CliffAttack(fighter: &mut L2CAgentBase) {
...
//SlipAttack
unsafe extern "C" fn game_fox_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_fox_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 16.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_fox_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 16.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 15.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 10.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ -14.0, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(-5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
    }
...
//SpecialNLoop
unsafe extern "C" fn game_fox_SpecialNLoop(fighter: &mut L2CAgentBase) {
...
//SpecialAirNLoop
unsafe extern "C" fn game_fox_SpecialAirNLoop(fighter: &mut L2CAgentBase) {
...
//SpecialSStart
unsafe extern "C" fn game_fox_SpecialSStart(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 0.4);
    }
}
...
//SpecialAirSStart
unsafe extern "C" fn game_fox_SpecialAirSStart(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 0.4);
    }
}
...
//SpecialHi
unsafe extern "C" fn game_fox_SpecialHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//SpecialHiHold
unsafe extern "C" fn game_fox_SpecialHiHold(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialHiHoldAir
unsafe extern "C" fn game_fox_SpecialHiHoldAir(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
        damage!(fighter, MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialLwStart
unsafe extern "C" fn game_fox_SpecialLwStart(fighter: &mut L2CAgentBase) {
...
//SpecialAirLwStart
unsafe extern "C" fn game_fox_SpecialAirLwStart(fighter: &mut L2CAgentBase) {
    WHOLE_HIT(fighter, *HIT_STATUS_INVINCIBLE);
...
//AppealHiR
unsafe extern "C" fn game_fox_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_fox_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_SMARTBOMB), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_fox_AppealSR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_fox_AppealSL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_BEAMSWORD), 0, 0, false, false);
    }
    frame(fighter.lua_state_agent, 2.0);
...
//AppealLwR
unsafe extern "C" fn game_fox_AppealLwR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_fox_AppealLwL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//FinalEnd
unsafe extern "C" fn game_fox_FinalEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_fox_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        CAM_ZOOM_OUT(fighter);
        camera!(fighter, *MA_MSC_CMD_CAMERA_CAM_OFFSET, 0, 0);
        AttackModule::clear_all(fighter.module_accessor);
...
pub fn install() {
    Agent::new("fox")
    .game_acmd("game_attack11", game_fox_Attack11, Low)
    .game_acmd("game_attack12", game_fox_Attack12, Low)
    .game_acmd("game_attack100", game_fox_Attack100, Low)
    .game_acmd("game_attack100sub", game_fox_Attack100Sub, Low)
    .game_acmd("game_attack100end", game_fox_Attack100End, Low)
    .game_acmd("game_attackdash", game_fox_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_fox_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_fox_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_fox_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_fox_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_fox_AttackLw3, Low)
    .game_acmd("game_attacks4", game_fox_AttackS4, Low)
    .game_acmd("game_attackhi4", game_fox_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_fox_AttackLw4, Low)
    .game_acmd("game_attackairn", game_fox_AttackAirN, Low)
    .game_acmd("game_attackairf", game_fox_AttackAirF, Low)    
    .game_acmd("game_attackairb", game_fox_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_fox_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_fox_AttackAirLw, Low)
    .game_acmd("game_landingairf", game_fox_LandingAirF, Low)
    .game_acmd("game_landingairlw", game_fox_LandingAirLw, Low)
    .game_acmd("game_catch", game_fox_Catch, Low)
    .game_acmd("game_catchdash", game_fox_CatchDash, Low)
    .game_acmd("game_catchturn", game_fox_CatchTurn, Low)
    .game_acmd("game_catchattack", game_fox_CatchAttack, Low)
    .game_acmd("game_throwf", game_fox_ThrowF, Low)
    .game_acmd("game_downattackd", game_fox_DownAttackD, Low)
    .game_acmd("game_downattacku", game_fox_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_fox_CliffAttack, Low)
    .game_acmd("game_slipattack", game_fox_SlipAttack, Low)
    .game_acmd("game_specialnloop", game_fox_SpecialNLoop, Low)
    .game_acmd("game_specialairnloop", game_fox_SpecialAirNLoop, Low)
    .game_acmd("game_specialhi", game_fox_SpecialHi, Low)
    .game_acmd("game_specialhihold", game_fox_SpecialHiHold, Low)
    .game_acmd("game_specialhiholdair", game_fox_SpecialHiHoldAir, Low)
    .game_acmd("game_speciallwstart", game_fox_SpecialLwStart, Low)
    .game_acmd("game_specialairlwstart", game_fox_SpecialAirLwStart, Low)
    .game_acmd("game_appealsr", game_fox_AppealSR, Low)
    .game_acmd("game_appealsl", game_fox_AppealSL, Low)
    .game_acmd("game_appealhir", game_fox_AppealHiR, Low)
    .game_acmd("game_appealhil", game_fox_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_fox_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_fox_AppealLwL, Low)
    .game_acmd("game_finalend", game_fox_FinalEnd, Low)
    .game_acmd("game_finalairend", game_fox_FinalAirEnd, Low)
    .install();
}
