...
pub fn install() {
    Agent::new("fox")
    .game_acmd("game_attack11", game_fox_Attack11)
    .game_acmd("game_attack12", game_fox_Attack12)
    .game_acmd("game_attack100", game_fox_Attack100)
    .game_acmd("game_attack100sub", game_fox_Attack100Sub)
    .game_acmd("game_attack100end", game_fox_Attack100End)
    .game_acmd("game_attackdash", game_fox_AttackDash)
    .game_acmd("game_attacks3hi", game_fox_AttackS3Hi)
    .game_acmd("game_attacks3", game_fox_AttackS3)
    .game_acmd("game_attacks3lw", game_fox_AttackS3Lw)
    .game_acmd("game_attackhi3", game_fox_AttackHi3)
    .game_acmd("game_attacklw3", game_fox_AttackLw3)
    .game_acmd("game_attacks4", game_fox_AttackS4)
    .game_acmd("game_attackhi4", game_fox_AttackHi4)
    .game_acmd("game_attacklw4", game_fox_AttackLw4)
    .game_acmd("game_attackairn", game_fox_AttackAirN)
    .game_acmd("game_attackairf", game_fox_AttackAirF)    
    .game_acmd("game_attackairb", game_fox_AttackAirB)
    .game_acmd("game_attackairhi", game_fox_AttackAirHi)
    .game_acmd("game_attackairlw", game_fox_AttackAirLw)
    .game_acmd("game_landingairf", game_fox_LandingAirF)
    .game_acmd("game_landingairlw", game_fox_LandingAirLw)
    .game_acmd("game_catch", game_fox_Catch)
    .game_acmd("game_catchdash", game_fox_CatchDash)
    .game_acmd("game_catchturn", game_fox_CatchTurn)
    .game_acmd("game_catchattack", game_fox_CatchAttack)
    .game_acmd("game_throwf", game_fox_ThrowF)
    .game_acmd("game_downattackd", game_fox_DownAttackD)
    ...
    .game_acmd("game_specialhiholdair", game_fox_SpecialHiHoldAir)
    .game_acmd("game_speciallwstart", game_fox_SpecialLwStart)
    .game_acmd("game_specialairlwstart", game_fox_SpecialAirLwStart)
    .game_acmd("game_appealsr", game_fox_AppealSR)
    .game_acmd("game_appealsl", game_fox_AppealSL)
    .game_acmd("game_appealhir", game_fox_AppealHiR)
    .game_acmd("game_appealhil", game_fox_AppealHiL)
    .game_acmd("game_appeallwr", game_fox_AppealLwR)
    .game_acmd("game_appeallwl", game_fox_AppealLwL)
    .game_acmd("game_finalend", game_fox_FinalEnd)
    .game_acmd("game_finalairend", game_fox_FinalAirEnd)
    .install();
}
