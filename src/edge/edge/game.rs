...
//Attack11
unsafe extern "C" fn game_edge_Attack11(fighter: &mut L2CAgentBase) {
...
//Attack12
unsafe extern "C" fn game_edge_Attack12(fighter: &mut L2CAgentBase) {
...
//Attack13
unsafe extern "C" fn game_edge_Attack13(fighter: &mut L2CAgentBase) {
...
//AttackDash
unsafe extern "C" fn game_edge_AttackDash(fighter: &mut L2CAgentBase) {
...
//AttackS3Hi
unsafe extern "C" fn game_edge_AttackS3Hi(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
...
//AttackS3
unsafe extern "C" fn game_edge_AttackS3(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackS3Lw
unsafe extern "C" fn game_edge_AttackS3Lw(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
    frame(fighter.lua_state_agent, 14.0);
    if is_excute(fighter) {
        FT_MOTION_RATE(fighter, /*FSM*/ 1.0);
...
//AttackHi3
unsafe extern "C" fn game_edge_AttackHi3(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//AttackLw3
unsafe extern "C" fn game_edge_AttackLw3(fighter: &mut L2CAgentBase) {
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 7.0);
    if is_excute(fighter) {
...
//AttackS4
unsafe extern "C" fn game_edge_AttackS4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.8);
...
//AttackHi4
unsafe extern "C" fn game_edge_AttackHi4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_EDGE_INSTANCE_WORK_ID_FLAG_ONE_WINGED_ACTIVATED) == true {
        if is_excute(fighter) {
            damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//AttackLw4
unsafe extern "C" fn game_edge_AttackLw4(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_EDGE_INSTANCE_WORK_ID_FLAG_ONE_WINGED_ACTIVATED) == true {
        if is_excute(fighter) {
            damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//AttackAirN
unsafe extern "C" fn game_edge_AttackAirN(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//AttackAirF
unsafe extern "C" fn game_edge_AttackAirF(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 3.0);
    if is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, /*Flag*/ *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
//AttackAirFWall
unsafe extern "C" fn game_edge_AttackAirFWall(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//AttackAirFWallFailure
unsafe extern "C" fn game_edge_AttackAirFWallFailure(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//AttackAirB
unsafe extern "C" fn game_edge_AttackAirB(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//AttackAirHi
unsafe extern "C" fn game_edge_AttackAirHi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    FT_MOTION_RATE(fighter, /*FSM*/ 0.6);
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AttackAirLw
unsafe extern "C" fn game_edge_AttackAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//LandingAirLw
unsafe extern "C" fn game_edge_LandingAirLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//Catch
unsafe extern "C" fn game_edge_Catch(fighter: &mut L2CAgentBase) {
...
//CatchDash
unsafe extern "C" fn game_edge_CatchDash(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 9.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchTurn
unsafe extern "C" fn game_edge_CatchTurn(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 10.0);
    if is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
//CatchAttack
unsafe extern "C" fn game_edge_CatchAttack(fighter: &mut L2CAgentBase) {
...
//ThrowF
unsafe extern "C" fn game_edge_ThrowF(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
    ...
    if is_excute(fighter) {
        ...
        FighterCutInManager::set_throw_finish_offset(FighterCutInManager(), Vector3f{x:11.0,y:3.5,z:0.0});
    }
    frame(fighter.lua_state_agent, 15.0);
    if is_excute(fighter) {
...
//ThrowB
unsafe extern "C" fn game_edge_ThrowB(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowHi
unsafe extern "C" fn game_edge_ThrowHi(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//ThrowLw
unsafe extern "C" fn game_edge_ThrowLw(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
    ...
    if is_excute(fighter) {
        ...
        FighterCutInManager::set_throw_finish_offset(FighterCutInManager(), Vector3f{x:6.5,y:3.0,z:0.0});
    }    
    frame(fighter.lua_state_agent, 40.0);
    if is_excute(fighter) {
        let target = WorkModule::get_int64(fighter.module_accessor, *FIGHTER_STATUS_THROW_WORK_INT_TARGET_OBJECT);
...
//CliffAttack
unsafe extern "C" fn game_edge_CliffAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 24.0);
    if is_excute(fighter) {
...
//SlipAttack
unsafe extern "C" fn game_edge_SlipAttack(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackD
unsafe extern "C" fn game_edge_DownAttackD(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
...
//DownAttackU
unsafe extern "C" fn game_edge_DownAttackU(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 19.0);
    if is_excute(fighter) {
        ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 16.0, /*Angle*/ 48, /*KBG*/ 78, /*FKB*/ 0, /*BKB*/ 80, /*Size*/ 9.0, /*X*/ 0.0, /*Y*/ 5.0, /*Z*/ -12.5, /*X2*/ Some(0.0), /*Y2*/ Some(5.0), /*Z2*/ Some(-5.0), /*Hitlag*/ 1.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_OFF, /*FacingRestrict*/ *ATTACK_LR_CHECK_POS, /*SetWeight*/ false, /*ShieldDamage*/ 8, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_M, /*SFXType*/ *COLLISION_SOUND_ATTR_KICK, /*Type*/ *ATTACK_REGION_KICK);
    }
...
//SpecialNStart
unsafe extern "C" fn game_edge_SpecialNStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialAirNStart
unsafe extern "C" fn game_edge_SpecialAirNStart(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
    }
...
//SpecialHi1
unsafe extern "C" fn game_edge_SpecialHi1(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialHi2End
unsafe extern "C" fn game_edge_SpecialHi2End(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
        damage!(fighter, *MA_MSC_DAMAGE_DAMAGE_NO_REACTION, /*Type*/ *DAMAGE_NO_REACTION_MODE_ALWAYS, 0);
...
//SpecialHiLanding
unsafe extern "C" fn game_edge_SpecialHiLanding(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if is_excute(fighter) {
...
//SpecialAirHi2End
unsafe extern "C" fn game_edge_SpecialAirHi2End(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        FighterAreaModuleImpl::enable_fix_jostle_area(fighter.module_accessor, 4.0, 3.0);
    }
    frame(fighter.lua_state_agent, 1.0);
...
//AppealHiR
unsafe extern "C" fn game_edge_AppealHiR(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//AppealHiL
unsafe extern "C" fn game_edge_AppealHiL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_KILLSWORD), 0, 0, false, false);
    }
}
...
//AppealSR
unsafe extern "C" fn game_edge_AppealSR(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
...
//AppealSL
unsafe extern "C" fn game_edge_AppealSL(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 5.0);
    if is_excute(fighter) {
        ItemModule::have_item(fighter.module_accessor, ItemKind(*ITEM_KIND_STAFFROULETTE), 0, 0, false, false);
    }
...
//AppealLwR
unsafe extern "C" fn game_edge_AppealLwR(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//AppealLwL
unsafe extern "C" fn game_edge_AppealLwL(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 4.0);
    if is_excute(fighter) {
...
//FinalEnd
unsafe extern "C" fn game_edge_FinalEnd(fighter: &mut L2CAgentBase) { 
    if is_excute(fighter) {
...
//FinalAirEnd
unsafe extern "C" fn game_edge_FinalAirEnd(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
pub fn install() {
    Agent::new("edge")
    .game_acmd("game_attack11", game_edge_Attack11, Low)
    .game_acmd("game_attack12", game_edge_Attack12, Low)
    .game_acmd("game_attack13", game_edge_Attack13, Low)
    .game_acmd("game_attackdash", game_edge_AttackDash, Low)
    .game_acmd("game_attacks3hi", game_edge_AttackS3Hi, Low)
    .game_acmd("game_attacks3", game_edge_AttackS3, Low)
    .game_acmd("game_attacks3lw", game_edge_AttackS3Lw, Low)
    .game_acmd("game_attackhi3", game_edge_AttackHi3, Low)
    .game_acmd("game_attacklw3", game_edge_AttackLw3, Low)
    .game_acmd("game_attacks4", game_edge_AttackS4, Low)
    .game_acmd("game_attackhi4", game_edge_AttackHi4, Low)
    .game_acmd("game_attacklw4", game_edge_AttackLw4, Low)
    .game_acmd("game_attackairn", game_edge_AttackAirN, Low)
    .game_acmd("game_attackairf", game_edge_AttackAirF, Low) 
    .game_acmd("game_attackairfwall", game_edge_AttackAirFWall, Low)    
    .game_acmd("game_attackairfwallfailure", game_edge_AttackAirFWallFailure, Low) 
    .game_acmd("game_attackairb", game_edge_AttackAirB, Low)
    .game_acmd("game_attackairhi", game_edge_AttackAirHi, Low)
    .game_acmd("game_attackairlw", game_edge_AttackAirLw, Low)
    .game_acmd("game_landingairlw", game_edge_LandingAirLw, Low)
    .game_acmd("game_catch", game_edge_Catch, Low)
    .game_acmd("game_catchdash", game_edge_CatchDash, Low)
    .game_acmd("game_catchturn", game_edge_CatchTurn, Low)
    .game_acmd("game_catchattack", game_edge_CatchAttack, Low)
    .game_acmd("game_throwf", game_edge_ThrowF, Low)
    .game_acmd("game_throwb", game_edge_ThrowB, Low)
    .game_acmd("game_throwhi", game_edge_ThrowHi, Low)
    .game_acmd("game_throwlw", game_edge_ThrowLw, Low)
    .game_acmd("game_downattackd", game_edge_DownAttackD, Low)
    .game_acmd("game_downattacku", game_edge_DownAttackU, Low)
    .game_acmd("game_cliffattack", game_edge_CliffAttack, Low)
    .game_acmd("game_slipattack", game_edge_SlipAttack, Low)
    .game_acmd("game_specialnstart", game_edge_SpecialNStart, Low)
    .game_acmd("game_specialairnstart", game_edge_SpecialAirNStart, Low)
    .game_acmd("game_specialhi1", game_edge_SpecialHi1, Low)
    .game_acmd("game_specialhi2end", game_edge_SpecialHi2End, Low)
    .game_acmd("game_specialhilanding", game_edge_SpecialHiLanding, Low)
    .game_acmd("game_specialairhi2end", game_edge_SpecialAirHi2End, Low)
    .game_acmd("game_speciallw", game_edge_SpecialLw, Low)
    .game_acmd("game_specialairlw", game_edge_SpecialAirLw, Low)
    .game_acmd("game_appealsr", game_edge_AppealSR, Low)
    .game_acmd("game_appealsl", game_edge_AppealSL, Low)
    .game_acmd("game_appealhir", game_edge_AppealHiR, Low)
    .game_acmd("game_appealhil", game_edge_AppealHiL, Low)
    .game_acmd("game_appeallwr", game_edge_AppealLwR, Low)
    .game_acmd("game_appeallwl", game_edge_AppealLwL, Low)
    .game_acmd("game_finalend", game_edge_FinalEnd, Low)
    .game_acmd("game_finalairend", game_edge_FinalAirEnd, Low)
    .install();
}
