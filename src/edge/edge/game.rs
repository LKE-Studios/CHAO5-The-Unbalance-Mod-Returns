...
pub fn install() {
    Agent::new("edge")
    .game_acmd("game_attack11", game_edge_Attack11)
    .game_acmd("game_attack12", game_edge_Attack12)
    .game_acmd("game_attack13", game_edge_Attack13)
    .game_acmd("game_attackdash", game_edge_AttackDash)
    .game_acmd("game_attacks3hi", game_edge_AttackS3Hi)
    .game_acmd("game_attacks3", game_edge_AttackS3)
    .game_acmd("game_attacks3lw", game_edge_AttackS3Lw)
    .game_acmd("game_attackhi3", game_edge_AttackHi3)
    .game_acmd("game_attacklw3", game_edge_AttackLw3)
    .game_acmd("game_attacks4", game_edge_AttackS4)
    .game_acmd("game_attackhi4", game_edge_AttackHi4)
    .game_acmd("game_attacklw4", game_edge_AttackLw4)
    .game_acmd("game_attackairn", game_edge_AttackAirN)
    .game_acmd("game_attackairf", game_edge_AttackAirF) 
    .game_acmd("game_attackairfwall", game_edge_AttackAirFWall)    
    .game_acmd("game_attackairfwallfailure", game_edge_AttackAirFWallFailure) 
    .game_acmd("game_attackairb", game_edge_AttackAirB)
    .game_acmd("game_attackairhi", game_edge_AttackAirHi)
    .game_acmd("game_attackairlw", game_edge_AttackAirLw)
    .game_acmd("game_landingairlw", game_edge_LandingAirLw)
    .game_acmd("game_catch", game_edge_Catch)
    .game_acmd("game_catchdash", game_edge_CatchDash)
    .game_acmd("game_catchturn", game_edge_CatchTurn)
    .game_acmd("game_catchattack", game_edge_CatchAttack)
    .game_acmd("game_throwf", game_edge_ThrowF)
    .game_acmd("game_throwb", game_edge_ThrowB)
    .game_acmd("game_throwhi", game_edge_ThrowHi)
    .game_acmd("game_throwlw", game_edge_ThrowLw)
    .game_acmd("game_downattackd", game_edge_DownAttackD)
    .game_acmd("game_downattacku", game_edge_DownAttackU)
    .game_acmd("game_cliffattack", game_edge_CliffAttack)
    .game_acmd("game_slipattack", game_edge_SlipAttack)
    .game_acmd("game_specialnstart", game_edge_SpecialNStart)
    .game_acmd("game_specialairnstart", game_edge_SpecialAirNStart)
    .game_acmd("game_specialhi1", game_edge_SpecialHi1)
    .game_acmd("game_specialhi2end", game_edge_SpecialHi2End)
    .game_acmd("game_specialhilanding", game_edge_SpecialHiLanding)
    .game_acmd("game_specialairhi2end", game_edge_SpecialAirHi2End)
    .game_acmd("game_speciallw", game_edge_SpecialLw)
    .game_acmd("game_specialairlw", game_edge_SpecialAirLw)
    .game_acmd("game_appealsr", game_edge_AppealSR)
    .game_acmd("game_appealsl", game_edge_AppealSL)
    .game_acmd("game_appealhir", game_edge_AppealHiR)
    .game_acmd("game_appealhil", game_edge_AppealHiL)
    .game_acmd("game_appeallwr", game_edge_AppealLwR)
    .game_acmd("game_appeallwl", game_edge_AppealLwL)
    .game_acmd("game_finalend", game_edge_FinalEnd)
    .game_acmd("game_finalairend", game_edge_FinalAirEnd)
    .install();
}
