...
//SpecialN1
unsafe extern "C" fn game_edge_fire_SpecialN1(fighter: &mut L2CAgentBase) {
...
//SpecialN2
unsafe extern "C" fn game_edge_fire_SpecialN2(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::disable_tip(fighter.module_accessor);
...
//SpecialN3
unsafe extern "C" fn game_edge_fire_SpecialN3(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        AttackModule::disable_tip(fighter.module_accessor);
...
//BurstS
unsafe extern "C" fn game_edge_fire_BurstS(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//BurstM
unsafe extern "C" fn game_edge_fire_BurstM(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
...
//BurstL
unsafe extern "C" fn game_edge_fire_BurstL(fighter: &mut L2CAgentBase) {
    if is_excute(fighter) {
        ControlModule::set_rumble(fighter.module_accessor, Hash40::new("rbkind_furafura"), 14, false, 0);
    }
    frame(fighter.lua_state_agent, 6.0);
