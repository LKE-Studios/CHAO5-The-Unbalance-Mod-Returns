...
pub const FIGHTER_INSTANCE_WORK_ID_INT_EFFECT_COUNTER: LuaConst = LuaConst::new(522);
pub const FIGHTER_INSTANCE_WORK_ID_INT_SOUND_COUNTER: LuaConst = LuaConst::new(523);
pub const FIGHTER_INSTANCE_WORK_ID_FLOAT_EFFECT_SCALE_MUL: LuaConst = LuaConst::new(524);
pub const FIGHTER_INSTANCE_WORK_ID_INT_CHARGE: LuaConst = LuaConst::new(525);
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_CHECK_CRITICAL: i32 = 526;
pub const FIGHTER_INSTANCE_WORK_ID_FLOAT_CRITICAL_ON_FRAME: i32 = 527;
pub const FIGHTER_INSTANCE_WORK_ID_INT_FRAME_COUNTER: LuaConst = LuaConst::new(528);
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_OMNI_FLOAT: LuaConst = LuaConst::new(529);
pub const FIGHTER_INSTANCE_WORK_ID_FLOAT_BUTTON_ON_FRAME: LuaConst = LuaConst::new(530);
pub const FIGHTER_INSTANCE_WORK_ID_FLOAT_CSTICK_DIRECTION: LuaConst = LuaConst::new(531);
...
pub const FIGHTER_STATUS_ATTACK_WORK_FLAG_CRITICAL: LuaConst = LuaConst::new(0x100000B);
...
pub const FIGHTER_STATUS_WORK_ID_FLAG_FLOAT_INHERIT_AERIAL: LuaConst = LuaConst::new(0x2100000D);
pub const FIGHTER_STATUS_WORK_ID_FLAG_FLOAT_IS_FLOAT: LuaConst = LuaConst::new(0x2100000E);
pub const FIGHTER_STATUS_FLOAT_WORK_INT_TIME: LuaConst = LuaConst::new(0x1000010);
pub const FIGHTER_STATUS_FLOAT_WORK_INT_ENABLE_UNIQ: LuaConst = LuaConst::new(0x1000011);
pub const FIGHTER_STATUS_FLOAT_WORK_INT_MTRANS: LuaConst = LuaConst::new(0x1000012);
...
//PFUSHIGISOU
pub const FIGHTER_PFUSHIGISOU_STATUS_KIND_SPECIAL_GUARD: LuaConst = LuaConst::new(0x1D3);
pub const FIGHTER_PFUSHIGISOU_STATUS_KIND_SPECIAL_GUARD_CHARGE: LuaConst = LuaConst::new(0x1DA);
pub const FIGHTER_PFUSHIGISOU_STATUS_KIND_SPECIAL_GUARD_SHOOT: LuaConst = LuaConst::new(0x1DB);
pub const FIGHTER_PFUSHIGISOU_STATUS_KIND_SPECIAL_GUARD_END: LuaConst = LuaConst::new(0x1DC);
pub const FIGHTER_PFUSHIGISOU_INSTANCE_WORK_ID_INT_CHARGE: LuaConst = LuaConst::new(0x100000BD);
