...
//DEDEDE
pub const FIGHTER_DEDEDE_STATUS_KIND_APPEAL_SPECIAL: LuaConst = LuaConst::new(0x1FE);
...
//SILVER
pub const FIGHTER_SILVER_STATUS_SPECIAL_N_WORK_FLOAT_ANGLE: LuaConst = LuaConst::new(0x100000C);
