...
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_FLY : LuaConst = LuaConst::new(0x201);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_LANDING : LuaConst = LuaConst::new(0x202);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_END : LuaConst = LuaConst::new(0x203);
