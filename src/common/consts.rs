...
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_HI_C2 : LuaConst = LuaConst::new(0x1D3);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_FLY : LuaConst = LuaConst::new(0x210);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_LANDING : LuaConst = LuaConst::new(0x211);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_S_END : LuaConst = LuaConst::new(0x212);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_LW_MUSIC : LuaConst = LuaConst::new(0x213);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_LW_FLIP : LuaConst = LuaConst::new(0x214);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_LW_JUMP : LuaConst = LuaConst::new(0x215);
pub const FIGHTER_FUNKY_STATUS_KIND_SPECIAL_LW_POSE : LuaConst = LuaConst::new(0x216);
...
pub const FIGHTER_SANS_INSTANCE_WORK_ID_FLAG_GASTER_ANGLE: LuaConst = LuaConst::new(0x200000E9);
pub const FIGHTER_SANS_INSTANCE_WORK_ID_FLAG_GASTER_SIZE: LuaConst = LuaConst::new(0x200000EA);
pub const FIGHTER_SANS_INSTANCE_WORK_ID_FLAG_GASTER_SE: LuaConst = LuaConst::new(0x200000EB);
pub const FIGHTER_SANS_INSTANCE_WORK_ID_FLAG_BONECAGE_EFFECT: LuaConst = LuaConst::new(0x200000EC);
pub const FIGHTER_SANS_INSTANCE_WORK_ID_FLAG_BONECAGE_HIT: LuaConst = LuaConst::new(0x200000ED);
...
pub const FIGHTER_SILVER_STATUS_SPECIAL_N_WORK_ID_FLAG_AIR_STALL: LuaConst = LuaConst::new(0x2100000D);
