...
extern "C" fn new_fighter_params(_ev: Event) {
    ...
    //KAMEK
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("walk_accel_mul"), 0, 0.065));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("walk_accel_add"), 0, 0.12));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("walk_speed_max"), 0, 1.153));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("jump_initial_y"), 0, 16.5));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("mini_jump_y"), 0, 15.0));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("jump_y"), 0, 35.24));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("jump_aerial_y"), 0, 66.0));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("dash_speed"), 0, 4.124));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("run_accel_mul"), 0, 0.115));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("run_accel_add"), 0, 0.073));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("run_speed_max"), 0, 3.96));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("ground_brake"), 0, 0.0694));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("air_accel_x_mul"), 0, 0.082));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("air_accel_x_add"), 0, 0.011));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("air_speed_x_stable"), 0, 1.357));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("air_speed_y_stable"), 0, 1.18));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("air_accel_y"), 0, 0.071));
    param_config::update_float_2(*FIGHTER_KIND_NESS, vec![96,97,98,99,100,101,102,103].clone(),(hash40("dive_speed_y"), 0, 2.43));
